...
{	
	...
	public class ItemValuesDlg : System.Windows.Forms.Form
	{
		...
		private Opc.Hda.SampleClient.ItemValuesCtrl TrendCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.TrendCTRL = new Opc.Hda.SampleClient.ItemValuesCtrl();
		...
		/// </summary>
		public bool ShowDialog(Opc.Hda.Server server, ItemValueCollection values, bool readOnly)
		{			
			...
			if (!readOnly)
			{
				...
				foreach (ItemValue value in TrendCTRL.GetValues())
				{
					values.Add(value);
				}
			}
