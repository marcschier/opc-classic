...
namespace Opc.Hda.SampleClient
{
	...
	public class ReplaceValuesDlg : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.TrendCTRL.RequestType = Opc.Hda.SampleClient.RequestType.ReadRaw;
		...
		/// </summary>
		private ItemValueCollection[] m_values = null;
		...
		private void DoRead()
		{
			...
			// read data.
			ItemValueCollection[] results = m_trend.Read(new Item[] { item });
		...
		private void DoReplace()
		{
			...
			m_values = new ItemValueCollection[] { ValuesCTRL.GetValues() };
			...
			{
				// replace data.
				ResultCollection[] results =  m_server.Replace(m_values);
			...
			else
			{
				...
				// begin replace data.
				IdentifiedResult[] results =  m_server.Replace(
					m_values,
					null,
