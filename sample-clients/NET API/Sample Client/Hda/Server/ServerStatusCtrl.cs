...
namespace Opc.Hda.SampleClient
{
	...
	public class ServerStatusCtrl : System.Windows.Forms.StatusBar
	{
		...
		/// </summary>
		public void Start(Opc.Hda.Server server)
		{
			m_server = server;
		...
		private void UpdateTimer_Tick(object sender, System.EventArgs e)
		{
			try
			{
				GetStatusDelegate callback = new GetStatusDelegate(m_server.GetStatus);
		...
		private void OnGetStatus(IAsyncResult result)
		{
			...
			try
			{
				GetStatusDelegate callback = (GetStatusDelegate)result.AsyncState;
