...
namespace Opc.Da.SampleClient
{
	...
	public class EditComplexValueDlg : System.Windows.Forms.Form
	{
		...
		void ShowComplexValue(ComplexValue complexValue)
		{
			...
			{
				ListViewItem listItem = new ListViewItem(complexValue.Name, Resources.IMAGE_ITEM_PROPERTY);
			...
			for (int ii = 0; ii < fields.Count; ii++)
			{
				...
				{					
					...
					listItem = new ListViewItem(elementValue.Name, Resources.IMAGE_ITEM_PROPERTY);
				...
				{
					listItem = new ListViewItem(String.Format("[{0}]", ii), Resources.IMAGE_ITEM_PROPERTY);
