...
.DESCRIPTION
    ...
    The CMake project at interop/CMakeLists.txt declares an
    x86-only `OpcEnum` target built from
    interop/src/Common/ServerEnumerator/. This helper wraps
    the configure + build step and produces:

      interop/build/x86/Release/OpcEnum.exe
    ...
    vendored under interop/private/ctt/).
...
.EXAMPLE
    .\interop\tools\build-opcenum.ps1
    .\interop\tools\build-opcenum.ps1 -Clean
#>
