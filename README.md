...
| [`external/`](external/) | OPC Foundation conformance assets: `external/inc`, `external/redist`, `external/private/docs`, and native C++ sample servers/test apps in `external/redist/samples`. |
