    ...
    public class _DataSet : DataSet {
        ...
        protected _DataSet(SerializationInfo info, StreamingContext context) {
            ...
            if ((strSchema != null)) {
                ...
                if ((ds.Tables["ItemValue"] != null)) {
                    this.Tables.Add(new ItemValuesDataTable(ds.Tables["ItemValue"]));
                }
        ...
        internal void InitVars() {
            ...
            this.tableItemValues = ((ItemValuesDataTable)(this.Tables["ItemValue"]));
        ...
        public class TestCase : DataRow {
            ...
            public ItemValue[] GetItemValues() {
                return ((ItemValue[])(this.GetChildRows(this.Table.ChildRelations["TestCase_ItemValue"])));
            }
        }
        ...
        public class ItemValuesDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public ItemValue this[int index] {
                get {
                    return ((ItemValue)(this.Rows[index]));
                }
            }
            ...
            public void AddItemValue(ItemValue row) {
                this.Rows.Add(row);
            }
            
            public ItemValue AddItemValue(System.Double Value, int Quality, System.Decimal Timestamp, TestCase parentTestCaseByTestCase_ItemValue) {
                ItemValue rowItemValue = ((ItemValue)(this.NewRow()));
            ...
            public ItemValue NewItemValue() {
                return ((ItemValue)(this.NewRow()));
            }
            
            protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
                return new ItemValue(builder);
            }
            
            protected override System.Type GetRowType() {
                return typeof(ItemValue);
            }
            
            protected override void OnRowChanged(DataRowChangeEventArgs e) {
                base.OnRowChanged(e);
                if ((this.ItemValueChanged != null)) {
                    this.ItemValueChanged(this, new ItemValueChangeEvent(((ItemValue)(e.Row)), e.Action));
                }
            }
            ...
            protected override void OnRowChanging(DataRowChangeEventArgs e) {
                ...
                if ((this.ItemValueChanging != null)) {
                    this.ItemValueChanging(this, new ItemValueChangeEvent(((ItemValue)(e.Row)), e.Action));
                }
            }
            ...
            protected override void OnRowDeleted(DataRowChangeEventArgs e) {
                ...
                if ((this.ItemValueDeleted != null)) {
                    this.ItemValueDeleted(this, new ItemValueChangeEvent(((ItemValue)(e.Row)), e.Action));
                }
            }
            ...
            protected override void OnRowDeleting(DataRowChangeEventArgs e) {
                ...
                if ((this.ItemValueDeleting != null)) {
                    this.ItemValueDeleting(this, new ItemValueChangeEvent(((ItemValue)(e.Row)), e.Action));
                }
            }
            
            public void RemoveItemValue(ItemValue row) {
                this.Rows.Remove(row);
            }
        }
        
        [System.Diagnostics.DebuggerStepThrough()]
        public class ItemValue : DataRow {
            
            private ItemValuesDataTable tableItemValues;
            
            internal ItemValue(DataRowBuilder rb) : 
                    base(rb) {
        ...
        public class ItemValueChangeEvent : EventArgs {
            ...
            private ItemValue eventRow;
            
            private DataRowAction eventAction;
            
            public ItemValueChangeEvent(ItemValue row, DataRowAction action) {
                this.eventRow = row;
                this.eventAction = action;
            }
            
            public ItemValue Row {
                get {
                    return this.eventRow;
                }
            }
