...
- .NET 10 SDK.
- A repository checkout or packages for `Opc.Classic.Core` and `Opc.Classic.Hda`.
...
- OPC HDA 1.20: `IOPCHDA_Server`, `IOPCHDA_SyncRead`, `IOPCHDA_SyncAnnotations`, `IOPCHDA_AsyncRead`.
