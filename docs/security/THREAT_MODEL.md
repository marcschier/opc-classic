...
- Native OPC Foundation sample servers under `interop\samples\` and redistributable inputs under `interop\`; they are conformance references, not portable runtime surface.
