...
- `Opc.Classic.Samples.DaClient` shows the managed DA client shape.
- `Opc.Classic.Samples.LoopbackDemo` validates generated proxy/dispatcher flow without remote networking.
- `Opc.Classic.Samples.AotCanary` validates NativeAOT publish behavior.
