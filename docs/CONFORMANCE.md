...
- Reads the full spec markdown in `external/private/docs/`
...
_Generated by review against `external/private/docs/OPC-AE-1.10.md` and `src/Opc.Classic.Ae/`._
...
- **Root cause (DR33, proven by wire tracing + server-side CCW instrumentation):**
  ...
  `external/inc/opc_ae_p.c`, that stub marks the AE `LPWSTR` params as
...
**Spec file**: `external/private/docs/OPC-COMMON-1.10.md`
...
- **Specification**: `external/private/docs/OPC-XMLDA-1.01.md` (4914 lines)
