//============================================================================
// TITLE: SetEnabledStateDlg.cs
//
// CONTENTS:
// 
// A dialog that specifies the new state for a node or a node hierarchy.
//
...
namespace Opc.Ae.SampleClient
{
	...
	public class SetEnabledStateDlg : System.Windows.Forms.Form
	{
		...
		/// </summary>
		private bool GetEnabledState(BrowseElement element)
		{
			try
			{
				// check for root.
				...
				EnabledStateResult[] results = null;
