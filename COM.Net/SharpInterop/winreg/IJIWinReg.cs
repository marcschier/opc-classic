...
namespace org.jinterop.winreg {
    ...
    public interface IJIWinReg {
        ...
        /// </param>
        /// <exception cref="JIException"> </exception>
        JIPolicyHandle OpenKey(JIPolicyHandle handle, string key,
        ...
        /// </param>
        /// <exception cref="JIException"> </exception>
        JIPolicyHandle CreateKey(JIPolicyHandle handle, string subKey,
        ...
        /// <exception cref="JIException"> </exception>
        void SetValue(JIPolicyHandle handle, string valueName, byte[][] data);
        ...
        /// <param name="data"> </param>
        /// <exception cref="JIException"> </exception>
        void SetValue(JIPolicyHandle handle, string valueName, int data);
