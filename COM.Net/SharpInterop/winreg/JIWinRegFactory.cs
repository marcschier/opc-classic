...
namespace org.jinterop.winreg
{
	...
	using JIWinRegStub = smb.JIWinRegStub;
...
//ORIGINAL LINE: public IJIWinReg getWinreg(org.jinterop.dcom.common.IJIAuthInfo authInfo,String serverName, bool smbTransport) throws java.net.UnknownHostException
		...
		/// <exception cref="UnknownHostException"> </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public IJIWinReg getWinreg(String serverName, bool smbTransport) throws java.net.UnknownHostException
