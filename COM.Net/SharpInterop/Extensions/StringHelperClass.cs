...
public static class StringHelperClass {
    ...
    /// <returns></returns>
    public static string NewString(byte[] bytes, int index, int count) => System.Text.Encoding.UTF8.GetString((byte[])(object)bytes, index, count);
    /// <summary>
    ///
    /// </summary>
    /// <param name="bytes"></param>
    ...
    /// <param name="encoding"></param>
    /// <returns></returns>
    public static string NewString(byte[] bytes, int index, int count, string encoding) => System.Text.Encoding.GetEncoding(encoding).GetString((byte[])(object)bytes, index, count);
    ...
    /// <param name="self"></param>
    /// <returns></returns>
    public static byte[] GetBytes(this string self) => GetSBytesForEncoding(System.Text.Encoding.UTF8, self);
    /// <summary>
    ///
    /// </summary>
    /// <param name="self"></param>
    /// <param name="encoding"></param>
    /// <returns></returns>
    public static byte[] GetBytes(this string self, string encoding) => GetSBytesForEncoding(System.Text.Encoding.GetEncoding(encoding), self);
    /// <summary>
    ///
    /// </summary>
    /// <param name="encoding"></param>
