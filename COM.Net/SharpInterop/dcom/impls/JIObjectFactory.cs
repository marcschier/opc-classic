...
namespace org.jinterop.dcom.impls {
    ...
    public class JIObjectFactory {
        ...
        /// <exception cref="JIException"> </exception>
        public static IComObject BuildObject(JISession session, JILocalCoClass localComponent) =>
        ...
        public static IComObject BuildObject(JISession session, byte[] rawBytes) =>
        ...
        public static IComObject BuildObject(JISession session, byte[] rawBytes, string ipAddress) =>
        ...
        public static IComObject NarrowObject(JISession session, IComObject comObject) =>
