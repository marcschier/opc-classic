...
namespace org.jinterop.winreg {
    ...
    public class JIWinRegFactory {
        ...
        /// </summary>
        public static JIWinRegFactory Instance {
            get {
                if (_factory == null) {
        ...
        public IJIWinReg GetWinreg(IJIAuthInfo authInfo, string serverName,
            bool smbTransport) {
            if (smbTransport) {
        ...
        /// </param>
        /// <exception cref="UnknownHostException"> </exception>
        public IJIWinReg GetWinreg(string serverName, bool smbTransport) {
            if (smbTransport) {
