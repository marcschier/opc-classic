...
namespace org.jinterop.dcom.core {
    ...
    internal sealed class JIMarshalUnMarshalHelper {
        ...
        // TODO This is very important, please note that arrays
        // in C++ have a fixed size and unlike Java have to be
        // declared with there Max index right in the beginning.
        // therefore all arrays (of any type), will already come
        // padded here to there Max size., this has to be ensured
        // by the caller
        // Basically the index on COMs side should match with
        // the array length here...otherwise exception will result.
        // This has to be managed by IDL generator.
        static JIMarshalUnMarshalHelper() => kMapOfSerializers = new Hashtable {
            ...
            [typeof(byte)] = new JIUnsignedByteImpl(),
            [typeof(sbyte)] = new SByteImpl(),
            [typeof(ushort)] = new JIUnsignedShortImpl(),
            [typeof(short)] = new ShortImpl(),
            [typeof(uint)] = new JIUnsignedIntImpl(),
            ...
            [typeof(IComObject)] = new IJIComObjectSerDer(),
        ...
        internal static void Serialize(NdrCodec ndr, Type c, object value,
            ...
            if (c.Equals(typeof(JIArray))) {
                ...
                if ((c != typeof(IComObject) || c != typeof(IJIDispatch)) && value is IComObject) {
                    c = typeof(IComObject);
                }
        ...
        internal static int GetLengthInBytes(Type c, object obj, int flag) {
            ...
            if ((c != typeof(IComObject) || c != typeof(IJIDispatch)) && obj is IComObject) {
                c = typeof(IComObject);
            }
        ...
        private class JIUnsignedIntImpl : ISerializerDeserializer {
            ...
            /// <inheritdoc/>
            public void SerializeData(NdrCodec ndr, object value, List<object> defferedPointers, int flag) =>
                Serialize(ndr, typeof(uint), (uint)value, null, flag);

            /// <inheritdoc/>
            public object DeserializeData(NdrCodec ndr, List<object> defferedPointers,
                IDictionary<object, object> additionalData, int flag) =>
                (uint)Deserialize(ndr, typeof(uint), null, flag, additionalData);
        ...
        private class JIUnsignedByteImpl : ISerializerDeserializer {
            ...
            /// <inheritdoc/>
            public void SerializeData(NdrCodec ndr, object value, List<object> defferedPointers, int flag) =>
                Serialize(ndr, typeof(byte), (byte)value, null, flag);

            /// <inheritdoc/>
            public object DeserializeData(NdrCodec ndr, List<object> defferedPointers,
                IDictionary<object, object> additionalData, int flag) =>
                (byte)Deserialize(ndr, typeof(byte), null, flag, additionalData);
        ...
        private class JIUnsignedShortImpl : ISerializerDeserializer {
            ...
            /// <inheritdoc/>
            public void SerializeData(NdrCodec ndr, object value, List<object> defferedPointers, int flag) =>
                Serialize(ndr, typeof(ushort), (ushort)value, null, flag);

            /// <inheritdoc/>
            public object DeserializeData(NdrCodec ndr, List<object> defferedPointers,
                IDictionary<object, object> additionalData, int flag) =>
                (ushort)Deserialize(ndr, typeof(ushort), null, flag, additionalData);
        ...
        private class IJIComObjectSerDer : ISerializerDeserializer {
            ...
            /// <inheritdoc/>
            public void SerializeData(NdrCodec ndr, object value, List<object> defferedPointers, int flag) {
                var ptr = ((IComObject)value).Internal_getInterfacePointer();
                ...
                if (ptr.IsCustomObjRef) {
                    ...
                    ((IComObject)value).CustomObject.Encode(ndr, defferedPointers, flag);
            ...
            public object DeserializeData(NdrCodec ndr, List<object> defferedPointers,
                ...
                IComObject comObject = new JIComObjectImpl(session, ptr);
                if (ptr != null &&
            ...
            public int GetLengthInBytes(object value, int flag) {
                var interfacePointer = ((IComObject)value).Internal_getInterfacePointer();
