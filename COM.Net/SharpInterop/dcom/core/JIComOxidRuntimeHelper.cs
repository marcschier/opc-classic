...
namespace org.jinterop.dcom.core {
    ...
    internal sealed class JIComOxidRuntimeHelper : Stub {
        ...
        protected override string Syntax =>
        ...
        internal object[] startRemUnknown(string baseIID, string ipidOfRemUnknown, string ipidOfComponent, List<object> listOfSupportedInterfaces) {
        ...
        private class RunnableAnonymousInnerClassHelper2 : Runnable {
            ...
            private List<object> listOfSupportedInterfaces;
            private ServerSocket serverSocket;
            private readonly ThreadGroup remUnknownForThisListener;

            public RunnableAnonymousInnerClassHelper2(JIComOxidRuntimeHelper outerInstance, string baseIID, string ipidOfRemUnknown, string ipidOfComponent, List<object> listOfSupportedInterfaces, ServerSocket serverSocket, ThreadGroup remUnknownForThisListener) {
                this.outerInstance = outerInstance;
    ...
    internal class OxidResolverImpl : NdrOp, IJICOMRuntimeWorker {
        ...
        public virtual IList<object> QIedIIDs => null;
    ...
    internal class RemUnknownObject : NdrOp, IJICOMRuntimeWorker {
        ...
        private List<object> listOfIIDsQIed = new List<object>();
        ...
        public virtual List<object> QIedIIDs => listOfIIDsQIed;
            ...
            if (selfIPID.Equals(ipid, StringComparison.CurrentCultureIgnoreCase)) {
                switch (opnum) {
                    ...
                    case 4: //addref
                        ...
                        var array = (JIArray)JIMarshalUnMarshalHelper.Deserialize(ndr, remInterfaceRefArray, new List<object>(), JIFlags.FLAG_REPRESENTATION_ARRAY, new Hashtable());
                ...
                if (component == null) {
                    Log.Logger.Error("JIComOxidRuntimeHelper RemUnknownObject read(): component is null , opnum is " + opnum + " , IPID is " + ipid + " , selfIpid is " + selfIPID);
                }
                byte[] b = null;
                object result = null;
                var ndr2 = new NdrCodec();
