...
namespace org.jinterop.dcom.core {
    ...
    public sealed class JISession {
        ...
        private class Release_References_TimerTask : TimerTask {
            public virtual void run() {
                try {
                    ...
                    lock (_mutex) {
                        listOfSessionsClone = (List<object>)_listOfSessions.clone();
                    }
                    ...
                    while (i < listOfSessionsClone.Count) {
                        ...
                        // Use a clone so we dont hold on to the mutex for longer than required.
                        lock (_mutex) {
                            dereferencedIpids = (List<object>)((List<object>)session._listOfDeferencedIpids).clone();
                        }
        ...
        private static List<object> _listOfSessions = new List<object>();
        private List<object> _listOfDeferencedIpids = new List<object>();
        ...
        private List<object> _links = new List<object>();
