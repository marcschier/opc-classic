...
namespace org.jinterop.dcom.core {
    ...
    /// using <seealso cref="JIObjectFactory.NarrowObject(IComObject)"/>
    ...
    public interface IComObject {
        ...
        /// </code>
        /// </para>
        /// <seealso cref="JIObjectFactory.NarrowObject(IComObject)"></seealso>
        /// </summary>
        ...
        string Internal_setConnectionInfo(IComObject connectionPoint, int? cookie);
