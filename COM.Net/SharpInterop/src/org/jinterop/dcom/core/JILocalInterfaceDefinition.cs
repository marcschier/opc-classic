...
namespace org.jinterop.dcom.core {
	...
	public sealed class JILocalInterfaceDefinition
	{
		...
		{
			var methodDescriptor = (JILocalMethodDescriptor)opnumVsMethodInfo.Remove(opnum);
		...
		{
			var methodDescriptor = (JILocalMethodDescriptor)nameVsMethodInfo.Remove(methodName);
			if (methodDescriptor != null)
			{
