...
//ORIGINAL LINE: public MSInternetExplorer(String address, String[] args) throws org.jinterop.dcom.common.JIException, java.net.UnknownHostException
        public MSInternetExplorer(string address, string[] args) {
            ...
            IeObjectDispatch = (IJIDispatch)JIObjectFactory.NarrowObject((IJIComObject)IeObject.QueryInterface(org.jinterop.dcom.impls.automation.IJIDispatch_Fields.IID));
...
//ORIGINAL LINE: private void attachCallBack() throws org.jinterop.dcom.common.JIException
        ...
        /// 
        /// </summary>
            JILocalCoClass javaComponent = new JILocalCoClass(new JILocalInterfaceDefinition("34A715A0-6587-11D0-924A-0020AFC7AC4D"),typeof(DWebBrowserEvents2));
