...
namespace org.bouncycastle.crypto.digests
{
	...
	public class MD4Digest : GeneralDigest
	{
        ...
        public override int DigestSize => DIGEST_LENGTH;

        protected internal override void processWord(sbyte[] @in, int inOff)
		{
		...
		protected internal override void processLength(long bitLength)
		{
			if (xOff > 14)
			{
				processBlock();
		...
		protected internal override void processBlock()
		{
			var a = H1;
			var b = H2;
			var c = H3;
