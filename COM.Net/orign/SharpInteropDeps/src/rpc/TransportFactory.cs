...
namespace rpc {
	...
	//    private static final List FACTORIES;
		...
		private static Properties DefaultProperties_Renamed;
		...
		public static Properties DefaultProperties {
			get {
				lock (typeof(TransportFactory)) {
					if (DefaultProperties_Renamed == null) {
						Properties properties = new Properties();
						...
						if (defaults != null) {
							...
							try {
								...
								throw new System.ArgumentException("Bad location " + defaults + ": " + ex.Message);
							}
							catch (Exception ex) {
								throw new System.ArgumentException("Unable to load " + " RPC properties from " + url + ": " + ex.Message);
							}
						}
						else {
							try {
						...
						DefaultProperties_Renamed = properties;
					}
				}
				Properties properties = new Properties(DefaultProperties_Renamed);
				try {
