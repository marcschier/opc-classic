...
//ORIGINAL LINE: void doStuff() throws org.jinterop.dcom.common.JIException
        internal void DoStuff()
        {
            ...
            var @namespace = JIObjectFactory.NarrowObject((IComObject)res[0]);
            ...
            var folder = JIObjectFactory.NarrowObject((IComObject)res[0]);
            callObject = new JICallBuilder {
                Opnum = 4
            };
            ...
            var items = JIObjectFactory.NarrowObject((IComObject)res[0]);
            callObject = new JICallBuilder {
                Opnum = 12
            };
            callObject.AddOutParamAsType(typeof(IComObject),JIFlags.FLAG_NULL);
            ...
            while (true)
            {
                ...
                var contactItem = (IJIDispatch)JIObjectFactory.NarrowObject((IComObject)res[0]);
