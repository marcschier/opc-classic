namespace org.jinterop.dcom.test {
    ...
    public class DWebBrowserEvents2 {
        ...
        public virtual void PropertyChange(JIString szProperty) => Console.WriteLine("PropertyChange -> " + szProperty.String);
        ...
        public virtual void StatusTextChange(JIString text) => Console.WriteLine("StatusTextChange -> " + text.String);

        //[id(0x0000006c), helpstring("Fired when download progress is updated.")]
        public virtual void ProgressChange(int Progress, int ProgressMax) => Console.WriteLine("ProgressChange -> " + Progress + ", " + ProgressMax);

        //[id(0x00000069), helpstring("The enabled state of a command changed.")]
        public virtual void CommandStateChange(int Command, bool Enable) => Console.WriteLine("CommandStateChange -> " + Command + ", " + Enable);

        //    [id(0x0000006a), helpstring("Download of a page started.")]
        public virtual void DownloadBegin() => Console.WriteLine("DownloadBegin");

        //    [id(0x00000068), helpstring("Download of page complete.")]
        public virtual void DownloadComplete() => Console.WriteLine("DownloadComplete");

        //[id(0x00000071), helpstring("Document title changed.")]
        public virtual void TitleChange(JIString Text) => Console.WriteLine("TitleChange -> " + Text.String);
        ...
        public virtual void DocumentComplete(IJIComObject pDisp, JIVariant URL) => Console.WriteLine("DocumentComplete -> " + pDisp.InterfaceIdentifier + ", " + URL);

        //[id(0x000000fd), helpstring("Fired when application is quiting.")]
        public virtual void OnQuit() => Console.WriteLine("OnQuit -> ");

        //[id(0x000000fe), helpstring("Fired when the window should be shown/hidden")]
        public virtual void OnVisible(bool Visible) => Console.WriteLine("OnVisible -> " + Visible);

        //[id(0x000000ff), helpstring("Fired when the toolbar  should be shown/hidden")]
        public virtual void OnToolBar(bool ToolBar) => Console.WriteLine("OnToolBar -> " + ToolBar);

        //[id(0x00000100), helpstring("Fired when the menubar should be shown/hidden")]
        public virtual void OnMenuBar(bool MenuBar) => Console.WriteLine("OnMenuBar -> " + MenuBar);

        //[id(0x00000101), helpstring("Fired when the statusbar should be shown/hidden")]
        public virtual void OnStatusBar(bool StatusBar) => Console.WriteLine("OnStatusBar -> " + StatusBar);

        //[id(0x00000102), helpstring("Fired when fullscreen mode should be on/off")]
        public virtual void OnFullScreen(bool FullScreen) => Console.WriteLine("OnFullScreen -> " + FullScreen);

        //[id(0x00000104), helpstring("Fired when theater mode should be on/off")]
        public virtual void OnTheaterMode(bool TheaterMode) => Console.WriteLine("OnTheaterMode -> " + TheaterMode);

        //[id(0x00000106), helpstring("Fired when the host window should allow/disallow resizing")]
        public virtual void WindowSetResizable(bool Resizable) => Console.WriteLine("OnResizable -> " + Resizable);

        //[id(0x00000108), helpstring("Fired when the host window should change its Left coordinate")]
        public virtual void WindowSetLeft(int Left) => Console.WriteLine("WindowSetLeft - > " + Left);

        //[id(0x00000109), helpstring("Fired when the host window should change its Top coordinate")]
        public virtual void WindowSetTop(int Top) => Console.WriteLine("WindowSetTop - > " + Top);

        //[id(0x0000010a), helpstring("Fired when the host window should change its width")]
        public virtual void WindowSetWidth(int Width) => Console.WriteLine("WindowSetWidth - > " + Width);

        //[id(0x0000010b), helpstring("Fired when the host window should change its height")]
        public virtual void WindowSetHeight(int Height) => Console.WriteLine("WindowSetHeight - > " + Height);

        //[id(0x00000107), helpstring("Fired when the WebBrowser is about to be closed by script")]
        //JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
        //ORIGINAL LINE: public org.jinterop.dcom.core.JIVariant WindowClosing(bool IsChildWindow, org.jinterop.dcom.core.JIVariant Cancel) throws org.jinterop.dcom.common.JIException
        ...
        public virtual int?[] ClientToHostWindow(int CX, int CY) {
            ...
            return new int?[] { CX, new int?(CY) };
        }

        //    [id(0x0000010d), helpstring("Fired to indicate the security level of the current web page contents")]
        public virtual void SetSecureLockIcon(int SecureLockIcon) => Console.WriteLine("SetSecureLockIcon - > " + SecureLockIcon);

        //[id(0x0000010e), helpstring("Fired to indicate the File Download dialog is opening")]
        //JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
        //ORIGINAL LINE: public org.jinterop.dcom.core.JIVariant FileDownload(bool noIdeaWhat,org.jinterop.dcom.core.JIVariant Cancel) throws org.jinterop.dcom.common.JIException
        ...
        public virtual void PrintTemplateInstantiation(IJIComObject pDisp) => Console.WriteLine("PrintTemplateInstantiation - > " + pDisp.InterfaceIdentifier);

        //[id(0x000000e2), helpstring("Fired when a print template destroyed.")]
        public virtual void PrintTemplateTeardown(IJIComObject pDisp) => Console.WriteLine("PrintTemplateTeardown - > " + pDisp.InterfaceIdentifier);

        //[id(0x000000e3), helpstring("Fired when a page is spooled. When it is fired can be changed by a custom template.")]
        public virtual void UpdatePageStatus(IJIComObject pDisp, JIVariant nPage, JIVariant fDone) => Console.WriteLine("UpdatePageStatus - > " + pDisp.InterfaceIdentifier);

        //[id(0x00000110), helpstring("Fired when the global privacy impacted state changes")]
        public virtual void PrivacyImpactedStateChange(bool bImpacted) => Console.WriteLine("PrivacyImpactedStateChange - > " + bImpacted);
        ...
        public virtual void SetPhishingFilterStatus(int PhishingFilterStatus) => Console.WriteLine("SetPhishingFilterStatus - > " + PhishingFilterStatus);//return Cancel;

        public virtual void WindowStateChanged(int dwWindowStateFlags, int dwValidFlagsMask) => Console.WriteLine("WindowStateChanged - > " + dwWindowStateFlags + ", " + dwValidFlagsMask);
