namespace org.jinterop.dcom.test {
    ...
    public class DWebBrowserEvents2 {
        ...
        public void PropertyChange(JIString szProperty) => Console.WriteLine("PropertyChange -> " + szProperty.String);
        ...
        public JIVariant BeforeNavigate2(IComObject dispatch, JIVariant URL, JIVariant Flags, JIVariant TargetFrameName, JIVariant PostData, JIVariant Headers, JIVariant Cancel) {
        ...
        public void StatusTextChange(JIString text) => Console.WriteLine("StatusTextChange -> " + text.String);
        ...
        public void TitleChange(JIString Text) => Console.WriteLine("TitleChange -> " + Text.String);

        // [id(0x000000fb), helpstring("A new, hidden, non-navigated WebBrowser window is needed.")]

        public JIVariant NewWindow2(JIVariant ppDisp, JIVariant Cancel) {
        ...
        public void NavigateComplete2(IComObject pDisp, JIVariant URL) {
        ...
        public void DocumentComplete(IComObject pDisp, JIVariant URL) => Console.WriteLine("DocumentComplete -> " + pDisp.InterfaceIdentifier + ", " + URL);
        ...
        public JIVariant WindowClosing(bool IsChildWindow, JIVariant Cancel) {
        ...
        public JIVariant FileDownload(bool noIdeaWhat, JIVariant Cancel) {
        ...
        public JIVariant NavigateError(IComObject pDisp, JIVariant URL, JIVariant Frame, JIVariant StatusCode, JIVariant Cancel) {
        ...
        public void UpdatePageStatus(IComObject pDisp, JIVariant nPage, JIVariant fDone) => Console.WriteLine("UpdatePageStatus - > " + pDisp.InterfaceIdentifier);
        ...
        public JIVariant NewWindow3(JIVariant ppDisp, JIVariant Cancel, int dwFlags, JIString bstrUrlContext, JIString bstrUrl) {
