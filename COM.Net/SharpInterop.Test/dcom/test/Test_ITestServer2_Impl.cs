    ...
    public class Test_ITestServer2_Impl
	{
		...
		public static void Main(string[] args)
		{
			...
			try
			{
				...
				var dispatch1 = (IJIDispatch)JIObjectFactory.NarrowObject(unkTestServer1.QueryInterface(impls.automation.DispatchFlags.IID));
				...
				var dispatch2 = (IJIDispatch)JIObjectFactory.NarrowObject(unkTestServer2.QueryInterface(impls.automation.DispatchFlags.IID));
