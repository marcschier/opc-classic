...
namespace Opc.Ae.SampleClient
{
	...
	public class ConditionsViewDlg : System.Windows.Forms.Form
	{
		...
		private Opc.Ae.SampleClient.ConditionStateCtrl ConditionCTRL;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.ConditionCTRL = new Opc.Ae.SampleClient.ConditionStateCtrl();
		...
		public void ShowDialog(Opc.Ae.Server server)
		{
			...
			try
			{
				...
				// add categories.
				Category[] categories = server.QueryEventCategories((int)EventType.Condition);
		...
		/// </summary>
		private void FetchConditions(TreeNode parent, Opc.Ae.Server server, int categoryID)
		{
		...
		/// </summary>
		private void FetchAttributes(TreeNode parent, Opc.Ae.Server server, int categoryID)
		{
			Attribute[] attributes = server.QueryEventAttributes(categoryID);
			...
			foreach (Attribute attribute in attributes)
			{
				string label = String.Format(
					...
					attribute.ID, 
					attribute.Name, 
					Opc.Convert.ToString(attribute.DataType));
		...
		/// </summary>
		private void FetchSubConditions(TreeNode parent, Opc.Ae.Server server, string conditionName)
		{
