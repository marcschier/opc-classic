...
namespace Opc.Ae.SampleClient
{
	...
	public class ConditionStateDlg : System.Windows.Forms.Form
	{
		...
		/// </summary>
		public void ShowDialog(Opc.Ae.Server server, string source, string condition)
		{
		...
		private void ShowCondition()
		{
			try
			{
				...
				Condition condition = m_server.GetConditionState(m_source, m_condition, attributeIDs);
		...
		private void FindAttributes()
		{
			try
			{
				Category[] categories = m_server.QueryEventCategories((int)EventType.Condition);
