//============================================================================
// TITLE: SubscriptionStateEditCtrl.cs
//
// CONTENTS:
// 
...
namespace Opc.Ae.SampleClient
{
	...
	public class SubscriptionStateEditCtrl : System.Windows.Forms.UserControl, IEditObjectCtrl
	{
		...
		public object Get()
		{
			Opc.Ae.SubscriptionState state = new Opc.Ae.SubscriptionState();
		...
		public void Set(object value)
		{
			...
			Opc.Ae.SubscriptionState state = (Opc.Ae.SubscriptionState)value;
