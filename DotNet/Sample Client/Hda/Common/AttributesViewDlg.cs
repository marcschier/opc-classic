...
namespace Opc.Hda.SampleClient
{
	...
	public class AttributesViewDlg : System.Windows.Forms.Form
	{
		...
		private Opc.Hda.SampleClient.AttributesViewCtrl AttributesCTRL;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.AttributesCTRL = new Opc.Hda.SampleClient.AttributesViewCtrl();
		...
		/// </summary>
		public void ShowDialog(Opc.Hda.Server server)
		{
		...
		/// </summary>
		public void ShowDialog(Opc.Hda.Server server, AttributeValueCollection values)
		{
			if (server == null) throw new ArgumentNullException("server");
