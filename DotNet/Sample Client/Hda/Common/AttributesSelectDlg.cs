...
{	
	...
	public class AttributesSelectDlg : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.AttributesCTRL.AttributePicked += new Opc.Hda.SampleClient.AttributesSelectCtrl.AttributePickedEventHandler(this.AttributesCTRL_AttributePicked);
			// 
			// AttributesSelectDlg
			// 
		...
		/// </summary>
		public Attribute[] ShowDialog(Server server, ArrayList excludeList)
		{
		...
		/// </summary>
		private void AttributesCTRL_AttributePicked(Opc.Hda.Attribute[] attributes)
		{
