...
namespace Opc.Hda.SampleClient
{
	...
	public class InsertValuesDlg : System.Windows.Forms.Form
	{
		...
		/// </summary>
		public bool ShowDialog(Opc.Hda.Server server, bool replace, bool synchronous)
		{
		...
		/// Prompts the user to specify values to insert for an item.
		/// </summary>
		public bool ShowDialog(Opc.Hda.Server server, ItemIdentifier item, bool replace, bool synchronous)
		{
		...
		private void DoInsert()
		{
			...
			{
				// insert data.
				ResultCollection[] results =  m_server.Insert(m_values, m_replace);
			...
			else
			{
				...
				// begin insert data.
				IdentifiedResult[] results =  m_server.Insert(
					m_values,
					m_replace,
					null,
