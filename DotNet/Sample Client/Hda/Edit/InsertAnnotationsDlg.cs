...
namespace Opc.Hda.SampleClient
{
	...
	public class InsertAnnotationsDlg : System.Windows.Forms.Form
	{
		...
		private Opc.Hda.SampleClient.AnnotationValuesCtrl ValuesCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.ValuesCTRL = new Opc.Hda.SampleClient.AnnotationValuesCtrl();
		...
		/// </summary>
		public bool ShowDialog(Opc.Hda.Server server, bool synchronous)
		{
		...
		/// Prompts the user to specify values to insert for an item.
		/// </summary>
		public bool ShowDialog(Opc.Hda.Server server, ItemIdentifier item, bool synchronous)
		{
		...
		/// </summary>
		private AnnotationValueCollection[] m_values = null;
		...
		private void DoInsert()
		{
			...
			m_values = new AnnotationValueCollection[] { ValuesCTRL.GetValues() };
			...
			{
				// insert data.
				ResultCollection[] results = m_server.InsertAnnotations(m_values);
			...
			else
			{
				...
				// begin insert data.
				IdentifiedResult[] results =  m_server.InsertAnnotations(
					m_values,
					null,
					new UpdateCompleteEventHandler(OnUpdateComplete),
					out m_request);
		...
		/// </summary>
		public void OnUpdateComplete(IRequest request, ResultCollection[] results)
		{
			...
			if (InvokeRequired)
			{
				BeginInvoke(new UpdateCompleteEventHandler(OnUpdateComplete), new object[] { request, results });
				return;
			}
