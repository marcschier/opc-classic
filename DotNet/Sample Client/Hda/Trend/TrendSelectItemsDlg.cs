...
{	
	...
	public class TrendSelectItemsDlg : System.Windows.Forms.Form
	{
		...
		private Opc.Hda.SampleClient.TrendItemsCtrl ItemsCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.ItemsCTRL = new Opc.Hda.SampleClient.TrendItemsCtrl();
			...
			this.ItemsCTRL.ItemPicked += new Opc.Hda.SampleClient.TrendItemsCtrl.ItemPickedEventHandler(this.ItemsCTRL_ItemPicked);
			// 
			// TrendSelectItemsDlg
			// 
		...
		/// </summary>
		public Item[] ShowDialog(Trend trend, ArrayList excludeList)
		{
		...
		/// </summary>
		private void ItemsCTRL_ItemPicked(Opc.Hda.Item[] items)
		{
