...
public sealed class SessionTools
{
    ...
    /// <summary>Creates a new OPC Classic session and returns its session identifier.</summary>
    ...
    /// <summary>Closes an OPC Classic session and releases all associated clients and channels.</summary>
    ...
    /// <summary>Lists all active OPC Classic sessions.</summary>
