...
For the full user guide, architecture diagram, authentication notes, and client-specific setup snippets, see [docs/mcp/README.md](https://github.com/marcschier/opc-classic/blob/master/docs/mcp/README.md). For the current tool catalog, see `docs\mcp\tools.md`.
