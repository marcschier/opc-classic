...
/// <summary>
/// Manages long-lived OPC Classic sessions for MCP tools.
/// </summary>
public interface IOpcSessionManager
{
    /// <summary>
    /// Creates a new OPC Classic session.
    /// </summary>
    OpcSession CreateSession(TimeSpan? idleExpiry = null);

    /// <summary>
    /// Gets an active session or throws if the session is missing or expired.
    /// </summary>
