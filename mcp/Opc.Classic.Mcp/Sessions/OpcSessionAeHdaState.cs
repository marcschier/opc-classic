...
/// <summary>
/// Holds OPC AE wire proxies and poll-based subscription queues.
/// </summary>
public sealed class AeClientState : IAsyncDisposable
{
    ...
    /// <summary>
    /// Creates AE client state over an existing call channel.
    /// </summary>
    ...
    /// <summary>
    /// Connected AE server ProgID, if known.
    /// </summary>
    public string? ProgId { get; }

    /// <summary>
    /// Connected AE server CLSID, if known.
    /// </summary>
    public Guid? Clsid { get; }

    /// <summary>
    /// Optional managed AE client used by in-process loopback connections.
    /// </summary>
    public IAeServer? ManagedServer { get; }

    /// <summary>
    /// Top-level AE event server proxy.
    /// </summary>
    public IOPCEventServerClientProxy EventServer { get; }

    /// <summary>
    /// AE 1.10 event server proxy.
    /// </summary>
    public IOPCEventServer2ClientProxy EventServer2 { get; }

    /// <summary>
    /// AE subscription management proxy.
    /// </summary>
    public IOPCEventSubscriptionMgtClientProxy SubscriptionMgt { get; }

    /// <summary>
    /// AE subscription keep-alive proxy.
    /// </summary>
    public IOPCEventSubscriptionMgt2ClientProxy SubscriptionMgt2 { get; }

    /// <summary>
    /// AE area browser proxy.
    /// </summary>
    public IOPCEventAreaBrowserClientProxy AreaBrowser { get; }

    /// <summary>
    /// Known poll-based AE subscriptions by identifier.
    /// </summary>
...
/// <summary>
/// Tracks an AE subscription and its MCP poll queue.
/// </summary>
public sealed class AeSubscriptionContext : IAsyncDisposable
{
    ...
    /// <summary>
    /// Creates an AE subscription context.
    /// </summary>
    ...
    /// <summary>
    /// Subscription identifier returned to MCP callers.
    /// </summary>
    public string SubscriptionId { get; }

    /// <summary>
    /// Client subscription handle supplied to the AE server.
    /// </summary>
    ...
    /// <summary>
    /// Requested buffer time in milliseconds.
    /// </summary>
    public int BufferTimeMs { get; }

    /// <summary>
    /// Requested maximum buffer size.
    /// </summary>
    public int MaxBufferSize { get; }

    /// <summary>
    /// Server-revised buffer time in milliseconds.
    /// </summary>
    public int RevisedBufferTimeMs { get; }

    /// <summary>
    /// Server-revised maximum buffer size.
    /// </summary>
    public int RevisedMaxBufferSize { get; }

    /// <summary>
    /// Managed subscription, when available.
    /// </summary>
    public IAeSubscription? Subscription { get; }

    /// <summary>
    /// Current filter tracked for JSON results.
    /// </summary>
    public SubscriptionFilter Filter { get; set; } = new();

    /// <summary>
    /// Queued notifications for MCP polling.
    /// </summary>
    public Channel<OpcEventNotification> Events { get; } = Channel.CreateUnbounded<OpcEventNotification>();

    /// <summary>
    /// Cancellation source for the background event pump.
    /// </summary>
...
/// <summary>
/// Holds OPC HDA wire proxies and item handles.
/// </summary>
public sealed class HdaClientState : IAsyncDisposable
{
    ...
    /// <summary>
    /// Creates HDA client state over an existing call channel.
    /// </summary>
    ...
    /// <summary>
    /// Connected HDA server ProgID, if known.
    /// </summary>
    public string? ProgId { get; }

    /// <summary>
    /// Connected HDA server CLSID, if known.
    /// </summary>
    public Guid? Clsid { get; }

    /// <summary>
    /// Optional managed HDA client used by in-process loopback connections.
    /// </summary>
    public IHdaServer? ManagedServer { get; }

    /// <summary>
    /// Top-level HDA server proxy.
    /// </summary>
...
/// <summary>
/// Tracks an HDA item handle returned by GetItemHandles.
/// </summary>
