...
docker build --file docker/opc-testclient/Dockerfile --tag opc-classic/testclient .
...
first or use `docker\run-matrix.ps1 -IncludeTestServer`, which orders the two
builds correctly.
