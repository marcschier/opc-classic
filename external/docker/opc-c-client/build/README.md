...
ENTRYPOINT (`external/docker/opc-c-client/client.ps1`) invokes the binary with
...
- `external/docker/opc-c-client/Dockerfile` — current image definition (build wired)
- `external/docker/opc-c-client/client.ps1` — runtime entrypoint
- `external/docker/opc-c-client/build/opc-test.cpp` — MVP client source
- `external/docker/opc-c-client/build/opc-test.vcxproj` — MSBuild project
- `external/docker/opc-c-server/build/README.md` — sister build for the server side
