...
docker build --file external/docker/opc-testclient/Dockerfile --tag opc-classic/testclient .
...
first or use `external\docker\run-matrix.ps1 -IncludeTestServer`, which orders the two
builds correctly.
