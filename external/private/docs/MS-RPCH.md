...
- [1 Introduction](#1-introduction)
  ...
  - [1.3 Overview](#13-overview)
    - [1.3.1 Extensions to HTTP Functionality](#131-extensions-to-http-functionality)
    - [1.3.2 Roles and Dialects](#132-roles-and-dialects)
    - [1.3.3 HTTP Proxy Use](#133-http-proxy-use)
    - [1.3.4 High-Level Overview](#134-high-level-overview)
...
- [2 Messages](#2-messages)
  - [2.1 Transport](#21-transport)
    - [2.1.1 RPC over HTTP v1 Transport](#211-rpc-over-http-v1-transport)
      - [2.1.1.1 Client to Mixed Proxy Traffic](#2111-client-to-mixed-proxy-traffic)
        - [2.1.1.1.1 RPC Connect Request](#21111-rpc-connect-request)
        - [2.1.1.1.2 RPC Connect Response](#21112-rpc-connect-response)
        - [2.1.1.1.3 Inbound PDU Stream](#21113-inbound-pdu-stream)
        - [2.1.1.1.4 Outbound PDU Stream](#21114-outbound-pdu-stream)
      - [2.1.1.2 Mixed Proxy to Server Traffic](#2112-mixed-proxy-to-server-traffic)
        - [2.1.1.2.1 Legacy Server Response](#21121-legacy-server-response)
    - [2.1.2 RPC over HTTP v2 Transport](#212-rpc-over-http-v2-transport)
      - [2.1.2.1 Client to Inbound or Outbound Proxy](#2121-client-to-inbound-or-outbound-proxy)
        - [2.1.2.1.1 IN Channel Request](#21211-in-channel-request)
        - [2.1.2.1.2 OUT Channel Request](#21212-out-channel-request)
        - [2.1.2.1.3 IN Channel Response](#21213-in-channel-response)
        - [2.1.2.1.4 OUT Channel Response](#21214-out-channel-response)
        - [2.1.2.1.5 Echo Request](#21215-echo-request)
        - [2.1.2.1.6 Echo Response](#21216-echo-response)
        - [2.1.2.1.7 Inbound PDU Stream](#21217-inbound-pdu-stream)
        - [2.1.2.1.8 Outbound PDU Stream](#21218-outbound-pdu-stream)
      - [2.1.2.2 Inbound or Outbound Proxy to Server](#2122-inbound-or-outbound-proxy-to-server)
        - [2.1.2.2.1 Legacy Server Response](#21221-legacy-server-response)
  - [2.2 Message Syntax](#22-message-syntax)
    - [2.2.1 Common Conventions](#221-common-conventions)
    - [2.2.2 URI Encoding](#222-uri-encoding)
    - [2.2.3 Common Data Structures](#223-common-data-structures)
      - [2.2.3.1 RTS Cookie](#2231-rts-cookie)
      - [2.2.3.2 Client Address](#2232-client-address)
        - [2.2.3.2.1 Client Address - IPv4](#22321-client-address-ipv4)
        - [2.2.3.2.2 Client Address - IPv6](#22322-client-address-ipv6)
      - [2.2.3.3 Forward Destinations](#2233-forward-destinations)
      - [2.2.3.4 Flow Control Acknowledgment](#2234-flow-control-acknowledgment)
      - [2.2.3.5 RTS Commands](#2235-rts-commands)
      - [2.2.3.6 defines how the commands are ordered in a PDU.](#2236-defines-how-the-commands-are-ordered-in-a-pdu)
        - [2.2.3.6.1 RTS PDU Header](#22361-rts-pdu-header)
        - [2.2.3.6.2 RTS PDU Body](#22362-rts-pdu-body)
    - [2.2.4 RTS PDUs](#224-rts-pdus)
      - [2.2.4.1 RTS PDUs Naming and Document Conventions](#2241-rts-pdus-naming-and-document-conventions)
      - [2.2.4.2 CONN/A1 RTS PDU](#2242-conna1-rts-pdu)
      - [2.2.4.3 CONN/A2 RTS PDU](#2243-conna2-rts-pdu)
      - [2.2.4.4 CONN/A3 RTS PDU](#2244-conna3-rts-pdu)
      - [2.2.4.5 CONN/B1 RTS PDU](#2245-connb1-rts-pdu)
      - [2.2.4.6 CONN/B2 RTS PDU](#2246-connb2-rts-pdu)
      - [2.2.4.7 CONN/B3 RTS PDU](#2247-connb3-rts-pdu)
      - [2.2.4.8 CONN/C1 RTS PDU](#2248-connc1-rts-pdu)
      - [2.2.4.9 CONN/C2 RTS PDU](#2249-connc2-rts-pdu)
      - [2.2.4.10 IN_R1/A1 RTS PDU](#22410-inr1a1-rts-pdu)
      - [2.2.4.11 IN_R1/A2 RTS PDU](#22411-inr1a2-rts-pdu)
      - [2.2.4.12 IN_R1/A3 RTS PDU](#22412-inr1a3-rts-pdu)
      - [2.2.4.13 IN_R1/A4 RTS PDU](#22413-inr1a4-rts-pdu)
      - [2.2.4.14 IN_R1/A5 RTS PDU](#22414-inr1a5-rts-pdu)
      - [2.2.4.15 IN_R1/A6 RTS PDU](#22415-inr1a6-rts-pdu)
      - [2.2.4.16 IN_R1/B1 RTS PDU](#22416-inr1b1-rts-pdu)
      - [2.2.4.17 IN_R1/B2 RTS PDU](#22417-inr1b2-rts-pdu)
      - [2.2.4.18 IN_R2/A1 RTS PDU](#22418-inr2a1-rts-pdu)
      - [2.2.4.19 IN_R2/A2 RTS PDU](#22419-inr2a2-rts-pdu)
      - [2.2.4.20 IN_R2/A3 RTS PDU](#22420-inr2a3-rts-pdu)
      - [2.2.4.21 IN_R2/A4 RTS PDU](#22421-inr2a4-rts-pdu)
      - [2.2.4.22 IN_R2/A5 RTS PDU](#22422-inr2a5-rts-pdu)
      - [2.2.4.23 OUT_R1/A1 RTS PDU](#22423-outr1a1-rts-pdu)
      - [2.2.4.24 OUT_R1/A2 RTS PDU](#22424-outr1a2-rts-pdu)
      - [2.2.4.25 OUT_R1/A3 RTS PDU](#22425-outr1a3-rts-pdu)
      - [2.2.4.26 OUT_R1/A4 RTS PDU](#22426-outr1a4-rts-pdu)
      - [2.2.4.27 OUT_R1/A5 RTS PDU](#22427-outr1a5-rts-pdu)
      - [2.2.4.28 OUT_R1/A6 RTS PDU](#22428-outr1a6-rts-pdu)
      - [2.2.4.29 OUT_R1/A7 RTS PDU](#22429-outr1a7-rts-pdu)
      - [2.2.4.30 OUT_R1/A8 RTS PDU](#22430-outr1a8-rts-pdu)
      - [2.2.4.31 OUT_R1/A9 RTS PDU](#22431-outr1a9-rts-pdu)
      - [2.2.4.32 OUT_R1/A10 RTS PDU](#22432-outr1a10-rts-pdu)
      - [2.2.4.33 OUT_R1/A11 RTS PDU](#22433-outr1a11-rts-pdu)
      - [2.2.4.34 OUT_R2/A1 RTS PDU](#22434-outr2a1-rts-pdu)
      - [2.2.4.35 OUT_R2/A2 RTS PDU](#22435-outr2a2-rts-pdu)
      - [2.2.4.36 OUT_R2/A3 RTS PDU](#22436-outr2a3-rts-pdu)
      - [2.2.4.37 OUT_R2/A4 RTS PDU](#22437-outr2a4-rts-pdu)
      - [2.2.4.38 OUT_R2/A5 RTS PDU](#22438-outr2a5-rts-pdu)
      - [2.2.4.39 OUT_R2/A6 RTS PDU](#22439-outr2a6-rts-pdu)
      - [2.2.4.40 OUT_R2/A7 RTS PDU](#22440-outr2a7-rts-pdu)
      - [2.2.4.41 OUT_R2/A8 RTS PDU](#22441-outr2a8-rts-pdu)
      - [2.2.4.42 OUT_R2/B1 RTS PDU](#22442-outr2b1-rts-pdu)
      - [2.2.4.43 OUT_R2/B2 RTS PDU](#22443-outr2b2-rts-pdu)
      - [2.2.4.44 OUT_R2/B3 RTS PDU](#22444-outr2b3-rts-pdu)
      - [2.2.4.45 OUT_R2/C1 RTS PDU](#22445-outr2c1-rts-pdu)
      - [2.2.4.46 Keep-Alive RTS PDU](#22446-keep-alive-rts-pdu)
      - [2.2.4.47 Ping Traffic Sent Notify RTS PDU](#22447-ping-traffic-sent-notify-rts-pdu)
      - [2.2.4.48 Echo RTS PDU](#22448-echo-rts-pdu)
      - [2.2.4.49 Ping RTS PDU](#22449-ping-rts-pdu)
      - [2.2.4.50 FlowControlAck RTS PDU](#22450-flowcontrolack-rts-pdu)
      - [2.2.4.51 FlowControlAckWithDestination RTS PDU](#22451-flowcontrolackwithdestination-rts-pdu)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 RPC over HTTP v1 Protocol Details](#31-rpc-over-http-v1-protocol-details)
    - [3.1.1 Client Details](#311-client-details)
      - [3.1.1.1 Abstract Data Model](#3111-abstract-data-model)
      - [3.1.1.2 Timers](#3112-timers)
        - [3.1.1.2.1 Connection Setup Timer](#31121-connection-setup-timer)
      - [3.1.1.3 Initialization](#3113-initialization)
      - [3.1.1.4 Higher-Layer Triggered Events](#3114-higher-layer-triggered-events)
        - [3.1.1.4.1 Opening a Connection](#31141-opening-a-connection)
        - [3.1.1.4.2 Sending a PDU](#31142-sending-a-pdu)
        - [3.1.1.4.3 Closing a Connection](#31143-closing-a-connection)
      - [3.1.1.5 Message Processing Events and Sequencing Rules](#3115-message-processing-events-and-sequencing-rules)
        - [3.1.1.5.1 Receiving a PDU](#31151-receiving-a-pdu)
        - [3.1.1.5.2 Encountering a Connection Error](#31152-encountering-a-connection-error)
      - [3.1.1.6 Timer Events](#3116-timer-events)
      - [3.1.1.7 Other Local Events](#3117-other-local-events)
    - [3.1.2 Mixed Proxy Details](#312-mixed-proxy-details)
      ...
      - [3.1.2.5 Message Processing Events and Sequencing Rules](#3125-message-processing-events-and-sequencing-rules)
        - [3.1.2.5.1 RPC Connect Request Received](#31251-rpc-connect-request-received)
        - [3.1.2.5.2 PDU Received](#31252-pdu-received)
        - [3.1.2.5.3 Connection Close or Connection Error Encountered](#31253-connection-close-or-connection-error-encountered)
    ...
    - [3.1.3 Server Details](#313-server-details)
      ...
      - [3.1.3.2 Initialization](#3132-initialization)
      - [3.1.3.3 Higher-Layer Triggered Events](#3133-higher-layer-triggered-events)
        - [3.1.3.3.1 Sending a PDU](#31331-sending-a-pdu)
      - [3.1.3.4 Message Processing Events and Sequencing Rules](#3134-message-processing-events-and-sequencing-rules)
        - [3.1.3.4.1 Establishing a Connection](#31341-establishing-a-connection)
        - [3.1.3.4.2 Receiving a PDU](#31342-receiving-a-pdu)
        - [3.1.3.4.3 Encountering a Connection Error](#31343-encountering-a-connection-error)
      - [3.1.3.5 Timers](#3135-timers)
      - [3.1.3.6 Timer Events](#3136-timer-events)
      - [3.1.3.7 Other Local Events](#3137-other-local-events)
  - [3.2 RPC over HTTP v2 Protocol Details](#32-rpc-over-http-v2-protocol-details)
    - [3.2.1 Common Details](#321-common-details)
      - [3.2.1.1 Abstract Data Model](#3211-abstract-data-model)
        - [3.2.1.1.1 Virtual Connection, Virtual Channel Hierarchy, and Protocol Variables](#32111-virtual-connection-virtual-channel-hierarchy-and-protocol-variables)
        - [3.2.1.1.2 Virtual Connection Cookie Table](#32112-virtual-connection-cookie-table)
        - [3.2.1.1.3 Virtual Connection ADM Elements](#32113-virtual-connection-adm-elements)
        - [3.2.1.1.4 Sending Channel and Receiving Channel](#32114-sending-channel-and-receiving-channel)
        - [3.2.1.1.5 Receiving Channel](#32115-receiving-channel)
          - [3.2.1.1.5.1 ReceiveWindow](#321151-receivewindow)
            - [3.2.1.1.5.1.1 ReceiveWindowSize](#3211511-receivewindowsize)
            - [3.2.1.1.5.1.2 Receiver AvailableWindow](#3211512-receiver-availablewindow)
            - [3.2.1.1.5.1.3 Recipient BytesReceived](#3211513-recipient-bytesreceived)
            - [3.2.1.1.5.1.4 AvailableWindowAdvertised](#3211514-availablewindowadvertised)
        - [3.2.1.1.6 Ping Originator](#32116-ping-originator)
          - [3.2.1.1.6.1 ConnectionTimeout](#321161-connectiontimeout)
          - [3.2.1.1.6.2 LastPacketSentTimestamp](#321162-lastpacketsenttimestamp)
          - [3.2.1.1.6.3 KeepAlive Interval](#321163-keepalive-interval)
      - [3.2.1.2 Timers](#3212-timers)
        - [3.2.1.2.1 PingTimer](#32121-pingtimer)
        - [3.2.1.2.2 Connection Timeout Timer](#32122-connection-timeout-timer)
      - [3.2.1.3 Initialization](#3213-initialization)
        - [3.2.1.3.1 Flow Control and ReceiveWindow Processing](#32131-flow-control-and-receivewindow-processing)
        - [3.2.1.3.2 BytesSent](#32132-bytessent)
      - [3.2.1.4 Higher-Layer Triggered Events](#3214-higher-layer-triggered-events)
        - [3.2.1.4.1 Flow Control and ReceiveWindow Higher-Layer Triggered Events](#32141-flow-control-and-receivewindow-higher-layer-triggered-events)
          - [3.2.1.4.1.1 Consuming RPC PDUs](#321411-consuming-rpc-pdus)
          - [3.2.1.4.1.2 Queuing RPC PDUs](#321412-queuing-rpc-pdus)
          - [3.2.1.4.1.3 Dequeuing RPC PDUs](#321413-dequeuing-rpc-pdus)
      - [3.2.1.5 Message Processing Events and Sequencing Rules](#3215-message-processing-events-and-sequencing-rules)
        - [3.2.1.5.1 Flow Control and ReceiveWindow Processing](#32151-flow-control-and-receivewindow-processing)
          - [3.2.1.5.1.1 Receiving RPC PDUs](#321511-receiving-rpc-pdus)
          - [3.2.1.5.1.2 FlowControlAck RTS PDU](#321512-flowcontrolack-rts-pdu)
          - [3.2.1.5.1.3 ReceiveWindowSize](#321513-receivewindowsize)
        - [3.2.1.5.2 PDU Forwarding](#32152-pdu-forwarding)
        - [3.2.1.5.3 Protocol Sequences](#32153-protocol-sequences)
          - [3.2.1.5.3.1 Connection Establishment](#321531-connection-establishment)
          - [3.2.1.5.3.2 IN Channel Recycling 1](#321532-in-channel-recycling-1)
          - [3.2.1.5.3.3 IN Channel Recycling 2](#321533-in-channel-recycling-2)
          - [3.2.1.5.3.4 OUT Channel Recycling 1](#321534-out-channel-recycling-1)
          - [3.2.1.5.3.5 OUT Channel Recycling 2](#321535-out-channel-recycling-2)
    ...
    - [3.2.2 Client Details](#322-client-details)
      - [3.2.2.1 Abstract Data Model](#3221-abstract-data-model)
        - [3.2.2.1.1 KeepAlive interval](#32211-keepalive-interval)
        - [3.2.2.1.2 proxy use](#32212-proxy-use)
        - [3.2.2.1.3 Channel Lifetime Sent](#32213-channel-lifetime-sent)
        - [3.2.2.1.4 Virtual In Channel State](#32214-virtual-in-channel-state)
        - [3.2.2.1.5 Virtual Out Channel State](#32215-virtual-out-channel-state)
        - [3.2.2.1.6 CurrentKeepAliveTime](#32216-currentkeepalivetime)
        - [3.2.2.1.7 CurrentKeepAliveInterval](#32217-currentkeepaliveinterval)
      - [3.2.2.2 Timers](#3222-timers)
        - [3.2.2.2.1 Connection Time-Out Timer](#32221-connection-time-out-timer)
        - [3.2.2.2.2 Keep-Alive Timer](#32222-keep-alive-timer)
        - [3.2.2.2.3 Proxy Use Determination Timer](#32223-proxy-use-determination-timer)
      - [3.2.2.3 Initialization](#3223-initialization)
      - [3.2.2.4 Higher-Layer Triggered Events](#3224-higher-layer-triggered-events)
        - [3.2.2.4.1 Opening a Connection](#32241-opening-a-connection)
          - [3.2.2.4.1.1 Determining HTTP Proxy Use](#322411-determining-http-proxy-use)
          - [3.2.2.4.1.2 Connection Opening](#322412-connection-opening)
        - [3.2.2.4.2 Sending a PDU](#32242-sending-a-pdu)
        - [3.2.2.4.3 Closing a Connection](#32243-closing-a-connection)
        - [3.2.2.4.4 Setting the KeepAlive interval Protocol Variable](#32244-setting-the-keepalive-interval-protocol-variable)
      - [3.2.2.5 Message Processing Events and Sequencing Rules](#3225-message-processing-events-and-sequencing-rules)
        - [3.2.2.5.1 Echo Response](#32251-echo-response)
        - [3.2.2.5.2 OUT Channel Response](#32252-out-channel-response)
        - [3.2.2.5.3 CONN/A3 RTS PDU](#32253-conna3-rts-pdu)
        - [3.2.2.5.4 CONN/C2 RTS PDU](#32254-connc2-rts-pdu)
        - [3.2.2.5.5 IN_R1/A4 and IN_R2/A4 RTS PDUs](#32255-inr1a4-and-inr2a4-rts-pdus)
        - [3.2.2.5.6 OUT_R1/A2 and OUT_R2/A2 RTS PDUs](#32256-outr1a2-and-outr2a2-rts-pdus)
        - [3.2.2.5.7 OUT_R1/A6 RTS PDU](#32257-outr1a6-rts-pdu)
        - [3.2.2.5.8 OUT_R1/A10 RTS PDU](#32258-outr1a10-rts-pdu)
        - [3.2.2.5.9 OUT_R2/A6 RTS PDU](#32259-outr2a6-rts-pdu)
        - [3.2.2.5.10 OUT_R2/B3 RTS PDU](#322510-outr2b3-rts-pdu)
        - [3.2.2.5.11 Connection Close, Connection Error, and Protocol Error Encountered](#322511-connection-close-connection-error-and-protocol-error-encountered)
        - [3.2.2.5.12 IN Channel Recycling](#322512-in-channel-recycling)
      - [3.2.2.6 Timer Events](#3226-timer-events)
        - [3.2.2.6.1 Connection Time-Out Timer Expiry](#32261-connection-time-out-timer-expiry)
        - [3.2.2.6.2 Keep-Alive Timer Expiry](#32262-keep-alive-timer-expiry)
        - [3.2.2.6.3 Proxy Use Determination Timer Expiry](#32263-proxy-use-determination-timer-expiry)
      - [3.2.2.7 Other Local Events](#3227-other-local-events)
    - [3.2.3 Inbound Proxy Details](#323-inbound-proxy-details)
      - [3.2.3.1 Abstract Data Model](#3231-abstract-data-model)
        - [3.2.3.1.1 ChannelLifetime](#32311-channellifetime)
        - [3.2.3.1.2 CurrentClientKeepAliveInterval](#32312-currentclientkeepaliveinterval)
        - [3.2.3.1.3 ClientAddress](#32313-clientaddress)
        - [3.2.3.1.4 KeepAlive interval](#32314-keepalive-interval)
        - [3.2.3.1.5 Resource Type UUID](#32315-resource-type-uuid)
        - [3.2.3.1.6 Session UUID](#32316-session-uuid)
        - [3.2.3.1.7 Default IN Channel](#32317-default-in-channel)
      - [3.2.3.2 Timers](#3232-timers)
        - [3.2.3.2.1 Keep-Alive Timer](#32321-keep-alive-timer)
      ...
      - [3.2.3.5 Message Processing Events and Sequencing Rules](#3235-message-processing-events-and-sequencing-rules)
        - [3.2.3.5.1 RPC IN Channel Request Received](#32351-rpc-in-channel-request-received)
        - [3.2.3.5.2 RPC PDU Received](#32352-rpc-pdu-received)
        - [3.2.3.5.3 CONN/B1 RTS PDU](#32353-connb1-rts-pdu)
        - [3.2.3.5.4 CONN/B3 RTS PDU](#32354-connb3-rts-pdu)
        - [3.2.3.5.5 IN_R1/A1 and IN_R2/A1 RTS PDUs](#32355-inr1a1-and-inr2a1-rts-pdus)
          - [3.2.3.5.5.1 Virtual Connection Cookie Found](#323551-virtual-connection-cookie-found)
          - [3.2.3.5.5.2 Virtual Connection Cookie Not Found](#323552-virtual-connection-cookie-not-found)
        - [3.2.3.5.6 IN_R1/A5 RTS PDU](#32356-inr1a5-rts-pdu)
        - [3.2.3.5.7 IN_R1/B2 RTS PDU](#32357-inr1b2-rts-pdu)
        - [3.2.3.5.8 IN_R2/A5 RTS PDU](#32358-inr2a5-rts-pdu)
        - [3.2.3.5.9 Echo Request PDU](#32359-echo-request-pdu)
        - [3.2.3.5.10 Connection Close, Connection Error, and Protocol Error Encountered](#323510-connection-close-connection-error-and-protocol-error-encountered)
        - [3.2.3.5.11 Processing Errors](#323511-processing-errors)
        - [3.2.3.5.12 Legacy Server Response](#323512-legacy-server-response)
      - [3.2.3.6 Timer Events](#3236-timer-events)
      - [3.2.3.7 Other Local Events](#3237-other-local-events)
    - [3.2.4 Outbound Proxy Details](#324-outbound-proxy-details)
      - [3.2.4.1 Abstract Data Model](#3241-abstract-data-model)
        - [3.2.4.1.1 Resource Type UUID](#32411-resource-type-uuid)
        - [3.2.4.1.2 Session UUID](#32412-session-uuid)
      - [3.2.4.2 Timers](#3242-timers)
      - [3.2.4.3 Initialization](#3243-initialization)
      - [3.2.4.4 Higher-Layer Triggered Events](#3244-higher-layer-triggered-events)
      - [3.2.4.5 Message Processing Events and Sequencing Rules](#3245-message-processing-events-and-sequencing-rules)
        - [3.2.4.5.1 RPC OUT Channel Request Received](#32451-rpc-out-channel-request-received)
        - [3.2.4.5.2 RPC PDU Received](#32452-rpc-pdu-received)
        - [3.2.4.5.3 CONN/A1 RTS PDU](#32453-conna1-rts-pdu)
        - [3.2.4.5.4 CONN/C1 RTS PDU](#32454-connc1-rts-pdu)
        - [3.2.4.5.5 OUT_R1/A1 or OUT_R2/A1 RTS PDUs](#32455-outr1a1-or-outr2a1-rts-pdus)
        - [3.2.4.5.6 OUT_R1/A3 or OUT_R2/A3 RTS PDUs](#32456-outr1a3-or-outr2a3-rts-pdus)
          - [3.2.4.5.6.1 Virtual Connection Cookie Found](#324561-virtual-connection-cookie-found)
          - [3.2.4.5.6.2 Virtual Connection Cookie Not Found](#324562-virtual-connection-cookie-not-found)
        - [3.2.4.5.7 OUT_R1/A5 RTS PDU](#32457-outr1a5-rts-pdu)
        - [3.2.4.5.8 OUT_R1/A9 RTS PDU](#32458-outr1a9-rts-pdu)
        - [3.2.4.5.9 OUT_R1/A11 RTS PDU](#32459-outr1a11-rts-pdu)
        - [3.2.4.5.10 OUT_R2/B1 RTS PDU](#324510-outr2b1-rts-pdu)
        - [3.2.4.5.11 OUT_R2/C1 RTS PDU](#324511-outr2c1-rts-pdu)
        - [3.2.4.5.12 OUT_R2/B2 RTS PDU](#324512-outr2b2-rts-pdu)
        - [3.2.4.5.13 Echo Request PDU](#324513-echo-request-pdu)
        - [3.2.4.5.14 Connection Close, Connection Error, and Protocol Error Encountered](#324514-connection-close-connection-error-and-protocol-error-encountered)
        - [3.2.4.5.15 Legacy Server Response](#324515-legacy-server-response)
      - [3.2.4.6 Timer Events](#3246-timer-events)
      - [3.2.4.7 Other Local Events](#3247-other-local-events)
    - [3.2.5 Server Details](#325-server-details)
      - [3.2.5.1 Abstract Data Model](#3251-abstract-data-model)
      - [3.2.5.2 Timers](#3252-timers)
        - [3.2.5.2.1 Connection Setup Timer](#32521-connection-setup-timer)
      - [3.2.5.3 Initialization](#3253-initialization)
        - [3.2.5.3.1 Virtual Connection Cookie Table](#32531-virtual-connection-cookie-table)
        - [3.2.5.3.2 Server Virtual Connection](#32532-server-virtual-connection)
      - [3.2.5.4 Higher-Layer Triggered Events](#3254-higher-layer-triggered-events)
        - [3.2.5.4.1 Sending a PDU](#32541-sending-a-pdu)
      - [3.2.5.5 Message Processing Events and Sequencing Rules](#3255-message-processing-events-and-sequencing-rules)
        - [3.2.5.5.1 Establishing a Connection](#32551-establishing-a-connection)
        - [3.2.5.5.2 Receiving an RPC PDU](#32552-receiving-an-rpc-pdu)
        - [3.2.5.5.3 CONN/A2 RTS PDU](#32553-conna2-rts-pdu)
          - [3.2.5.5.3.1 Virtual Connection Not Found](#325531-virtual-connection-not-found)
          - [3.2.5.5.3.2 Virtual Connection Found](#325532-virtual-connection-found)
        - [3.2.5.5.4 CONN/B2 RTS PDU](#32554-connb2-rts-pdu)
          - [3.2.5.5.4.1 Virtual Connection Not Found](#325541-virtual-connection-not-found)
          - [3.2.5.5.4.2 Virtual Connection Found](#325542-virtual-connection-found)
        - [3.2.5.5.5 IN_R1/A2 RTS PDU](#32555-inr1a2-rts-pdu)
        - [3.2.5.5.6 IN_R1/A6 RTS PDU](#32556-inr1a6-rts-pdu)
        - [3.2.5.5.7 IN_R1/B1 RTS PDU](#32557-inr1b1-rts-pdu)
        - [3.2.5.5.8 IN_R2/A2 RTS PDU](#32558-inr2a2-rts-pdu)
        - [3.2.5.5.9 OUT_R1/A4 RTS PDU](#32559-outr1a4-rts-pdu)
        - [3.2.5.5.10 OUT_R1/A8 RTS PDU](#325510-outr1a8-rts-pdu)
        - [3.2.5.5.11 OUT_R2/A4 RTS PDU](#325511-outr2a4-rts-pdu)
        - [3.2.5.5.12 OUT_R2/A8 RTS PDU](#325512-outr2a8-rts-pdu)
        - [3.2.5.5.13 Connection Close, Connection Error, and Protocol Error Encountered](#325513-connection-close-connection-error-and-protocol-error-encountered)
        - [3.2.5.5.14 Ping Traffic Sent Notify RTS PDU on Server](#325514-ping-traffic-sent-notify-rts-pdu-on-server)
        - [3.2.5.5.15 OUT Channel Recycling](#325515-out-channel-recycling)
      - [3.2.5.6 Timer Events](#3256-timer-events)
        - [3.2.5.6.1 Connection Setup Timer Expiry](#32561-connection-setup-timer-expiry)
      - [3.2.5.7 Other Local Events](#3257-other-local-events)
- [4 Protocol Examples](#4-protocol-examples)
  - [4.1 Virtual Connection Open Example](#41-virtual-connection-open-example)
  - [4.2 Flow Control and Receive Windows Example](#42-flow-control-and-receive-windows-example)
