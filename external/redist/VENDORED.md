...
to `src/`, and relocates native test applications under this tree at
...
```powershell
robocopy ..\OPC-Classic-CoreComponents external\redist /MIR /XD build .git .github .vs .vscode WiX
```
