...
//
// Property-based tests (CsCheck) over invariants of OpcClassic.Core types.
// Complements the example-based TUnit tests in tests/OpcClassic.Core.Tests/.
//
...
namespace OpcClassic.PropertyTests;
