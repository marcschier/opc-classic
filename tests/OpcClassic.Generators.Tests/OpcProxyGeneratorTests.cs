...
public sealed class OpcProxyGeneratorTests
{
    ...
    public async Task GeneratedProxy_DeclaresPartialClientProxyClass()
    {
        ...
        await Assert.That(generated).Contains("partial class ITestProxy_ClientProxy : ITestProxy");
    }
    ...
    public async Task GeneratedProxy_DeclaresCallChannelFieldAndConstructor()
    {
        ...
        await Assert.That(generated).Contains("private readonly global::OpcClassic.ICallChannel _channel;");
        await Assert.That(generated).Contains("public ITestProxy_ClientProxy(global::OpcClassic.ICallChannel channel)");
