...
internal sealed class StubDaServer : IOpcDaServer
{
    ...
    public static (IOPCServer_ClientProxy Proxy, InMemoryCallChannel Channel) CreateLoopbackProxy(IOpcDaServer server)
    {
        ...
        return (new IOPCServer_ClientProxy(channel), channel);
    }
