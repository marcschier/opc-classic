...
- `WinRegSambaSmoke` — opt-in Samba WINREG smoke; requires `samba` and `OPC_CLASSIC_INTEGRATION_SAMBA=1`.
...
Folder-specific details live under Native tests, Matrikon tests, and CompatMatrix tests.
