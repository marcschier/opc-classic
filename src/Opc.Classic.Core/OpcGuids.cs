...
// the canonical OPC specs and the native C++ samples preserved under interop/samples/.
...
public static class OpcGuids
{
    ...
    /// <summary>
    /// <c>CATID_OPCDXServer10</c> — registers a DX 1.0 server.
    /// </summary>
    public static readonly Guid CATID_OPCDXServer10 =
        new("A0C85BB8-4161-4FD6-8655-BB584601C9E0");

    /// <summary>
    /// <c>IOPCConfiguration</c> — DX server-to-server configuration.
    /// </summary>
    ...
    /// <summary>
    /// <c>IOPCSecurityNT</c> — Windows-integrated security.
    /// </summary>
    public static readonly Guid IID_IOPCSecurityNT =
        new("7AA83A01-6C77-11D3-84F9-00008630A38B");

    /// <summary>
    /// <c>IOPCSecurityPrivate</c> — server-private credential security.
    /// </summary>
    ...
    /// <summary>
    /// <c>CATID_XMLDAServer10</c> — registers an XML-DA 1.0 server.
    /// </summary>
    ...
    /// <summary>
    /// Category IDs for OPC AE server discovery.
    /// </summary>
    ...
    /// <summary>
    /// Category IDs for OPC HDA server discovery.
    /// </summary>
    ...
    /// <summary>
    /// Category IDs for OPC DX server discovery.
    /// </summary>
    ...
    /// <summary>
    /// Category IDs for OPC Batch server discovery (both Batch 1.0 and 2.0).
    /// </summary>
    ...
    /// <summary>
    /// Category IDs for OPC Commands server discovery.
    /// </summary>
    ...
    /// <summary>
    /// Category IDs for OPC XML-DA server discovery.
    /// </summary>
