...
/// <summary>
/// Base exception for SMB2 protocol errors.
/// </summary>
public class Smb2ProtocolException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Smb2ProtocolException" /> class.
    /// </summary>
...
/// <summary>
/// Thrown when the server returns a non-success NTSTATUS in an SMB2 response.
/// </summary>
public sealed class Smb2StatusException : Smb2ProtocolException
{
    /// <summary>
    /// NTSTATUS code returned by the server.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance with the given NTSTATUS code and message.
    /// </summary>
