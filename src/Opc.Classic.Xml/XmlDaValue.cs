...
{
    /// <summary>
    /// Creates an unknown-type carrier preserving the raw text only.
    /// </summary>
    ...
    /// <summary>
    /// Creates a 32-bit single-precision floating-point value.
    /// </summary>
    ...
    /// <summary>
    /// Creates a 64-bit double-precision floating-point value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML Schema time value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML Schema QName value from lexical text.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML Schema QName value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfByte value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfShort value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfInt value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfLong value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfFloat value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfDouble value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfString value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfBoolean value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML-DA ArrayOfDateTime value.
    /// </summary>
    ...
    /// <summary>
    /// Creates an XML Schema base64Binary value.
    /// </summary>
    ...
    /// <summary>
    /// The xsi:type discriminator that defined this value.
    /// </summary>
    public required XmlDaValueType Type { get; init; }

    /// <summary>
    /// The verbatim wire text inside the <c>&lt;Value&gt;</c> element.
    /// </summary>
    public required string RawText { get; init; }

    /// <summary>
    /// The .NET-typed value (boxed). Null for <see cref="XmlDaValueType.Unknown"/>.
    /// </summary>
    public required object? Boxed { get; init; }

    /// <summary>
    /// Returns the string content if <see cref="Type"/> is <see cref="XmlDaValueType.String"/>, else null.
    /// </summary>
    public string? AsString() => Type == XmlDaValueType.String ? (string?)Boxed : null;

    /// <summary>
    /// Returns the sbyte content if <see cref="Type"/> is <see cref="XmlDaValueType.Int8"/>, else null.
    /// </summary>
    public sbyte? AsInt8() => Type == XmlDaValueType.Int8 ? (sbyte?)Boxed : null;

    /// <summary>
    /// Returns the byte content if <see cref="Type"/> is <see cref="XmlDaValueType.UInt8"/>, else null.
    /// </summary>
    public byte? AsUInt8() => Type == XmlDaValueType.UInt8 ? (byte?)Boxed : null;

    /// <summary>
    /// Returns the short content if <see cref="Type"/> is <see cref="XmlDaValueType.Int16"/>, else null.
    /// </summary>
    public short? AsInt16() => Type == XmlDaValueType.Int16 ? (short?)Boxed : null;

    /// <summary>
    /// Returns the ushort content if <see cref="Type"/> is <see cref="XmlDaValueType.UInt16"/>, else null.
    /// </summary>
    public ushort? AsUInt16() => Type == XmlDaValueType.UInt16 ? (ushort?)Boxed : null;

    /// <summary>
    /// Returns the int content if <see cref="Type"/> is <see cref="XmlDaValueType.Int32"/>, else null.
    /// </summary>
    public int? AsInt32() => Type == XmlDaValueType.Int32 ? (int?)Boxed : null;

    /// <summary>
    /// Returns the uint content if <see cref="Type"/> is <see cref="XmlDaValueType.UInt32"/>, else null.
    /// </summary>
    public uint? AsUInt32() => Type == XmlDaValueType.UInt32 ? (uint?)Boxed : null;

    /// <summary>
    /// Returns the long content if <see cref="Type"/> is <see cref="XmlDaValueType.Int64"/>, else null.
    /// </summary>
    public long? AsInt64() => Type == XmlDaValueType.Int64 ? (long?)Boxed : null;

    /// <summary>
    /// Returns the ulong content if <see cref="Type"/> is <see cref="XmlDaValueType.UInt64"/>, else null.
    /// </summary>
    public ulong? AsUInt64() => Type == XmlDaValueType.UInt64 ? (ulong?)Boxed : null;

    /// <summary>
    /// Returns the float content if <see cref="Type"/> is <see cref="XmlDaValueType.Single"/>, else null.
    /// </summary>
    public float? AsSingle() => Type == XmlDaValueType.Single ? (float?)Boxed : null;

    /// <summary>
    /// Returns the double content if <see cref="Type"/> is <see cref="XmlDaValueType.Double"/>, else null.
    /// </summary>
    public double? AsDouble() => Type == XmlDaValueType.Double ? (double?)Boxed : null;

    /// <summary>
    /// Returns the bool content if <see cref="Type"/> is <see cref="XmlDaValueType.Boolean"/>, else null.
    /// </summary>
    public bool? AsBoolean() => Type == XmlDaValueType.Boolean ? (bool?)Boxed : null;

    /// <summary>
    /// Returns the dateTime content if <see cref="Type"/> is <see cref="XmlDaValueType.DateTime"/>, else null.
    /// </summary>
    public DateTimeOffset? AsDateTime() => Type == XmlDaValueType.DateTime ? (DateTimeOffset?)Boxed : null;

    /// <summary>
    /// Returns the decimal content if <see cref="Type"/> is <see cref="XmlDaValueType.Decimal"/>, else null.
    /// </summary>
    public decimal? AsDecimal() => Type == XmlDaValueType.Decimal ? (decimal?)Boxed : null;

    /// <summary>
    /// Returns the time content if <see cref="Type"/> is <see cref="XmlDaValueType.Time"/>, else null.
    /// </summary>
    public TimeOnly? AsTime() => Type == XmlDaValueType.Time ? (TimeOnly?)Boxed : null;

    /// <summary>
    /// Returns the date content if <see cref="Type"/> is <see cref="XmlDaValueType.Date"/>, else null.
    /// </summary>
    public DateOnly? AsDate() => Type == XmlDaValueType.Date ? (DateOnly?)Boxed : null;

    /// <summary>
    /// Returns the duration content if <see cref="Type"/> is <see cref="XmlDaValueType.Duration"/>, else null.
    /// </summary>
    public TimeSpan? AsDuration() => Type == XmlDaValueType.Duration ? (TimeSpan?)Boxed : null;

    /// <summary>
    /// Returns the QName content if <see cref="Type"/> is <see cref="XmlDaValueType.QName"/>, else null.
    /// </summary>
    public XmlQualifiedName? AsQName() => Type == XmlDaValueType.QName ? (XmlQualifiedName?)Boxed : null;

    /// <summary>
    /// Returns the ArrayOfByte content if the type matches, else null.
    /// </summary>
    public sbyte[]? AsArrayOfByte() => AsArray<sbyte>(XmlDaValueType.ArrayOfByte);

    /// <summary>
    /// Returns the ArrayOfShort content if the type matches, else null.
    /// </summary>
    public short[]? AsArrayOfShort() => AsArray<short>(XmlDaValueType.ArrayOfShort);

    /// <summary>
    /// Returns the ArrayOfInt content if the type matches, else null.
    /// </summary>
    public int[]? AsArrayOfInt() => AsArray<int>(XmlDaValueType.ArrayOfInt);

    /// <summary>
    /// Returns the ArrayOfLong content if the type matches, else null.
    /// </summary>
    public long[]? AsArrayOfLong() => AsArray<long>(XmlDaValueType.ArrayOfLong);

    /// <summary>
    /// Returns the ArrayOfFloat content if the type matches, else null.
    /// </summary>
    public float[]? AsArrayOfFloat() => AsArray<float>(XmlDaValueType.ArrayOfFloat);

    /// <summary>
    /// Returns the ArrayOfDouble content if the type matches, else null.
    /// </summary>
    public double[]? AsArrayOfDouble() => AsArray<double>(XmlDaValueType.ArrayOfDouble);

    /// <summary>
    /// Returns the ArrayOfString content if the type matches, else null.
    /// </summary>
    public string?[]? AsArrayOfString() => AsArray<string?>(XmlDaValueType.ArrayOfString);

    /// <summary>
    /// Returns the ArrayOfBoolean content if the type matches, else null.
    /// </summary>
    ...
    /// <summary>
    /// Returns the ArrayOfDateTime content if the type matches, else null.
    /// </summary>
    public DateTimeOffset[]? AsArrayOfDateTime() => AsArray<DateTimeOffset>(XmlDaValueType.ArrayOfDateTime);

    /// <summary>
    /// Returns the base64Binary content if the type matches, else null.
    /// </summary>
