...
{
    /// <summary>
    /// Creates an empty SOAP fault exception.
    /// </summary>
    ...
    /// <summary>
    /// Creates a SOAP fault exception with a custom message.
    /// </summary>
    ...
    /// <summary>
    /// Creates a SOAP fault exception with a custom message and inner exception.
    /// </summary>
    ...
    /// <summary>
    /// Creates a SOAP fault exception from the decoded SOAP fault fields.
    /// </summary>
    ...
    /// <summary>
    /// The raw SOAP <c>faultcode</c> text.
    /// </summary>
    public string FaultCode { get; } = string.Empty;

    /// <summary>
    /// The raw SOAP <c>faultstring</c> text.
    /// </summary>
    public string FaultString { get; } = string.Empty;

    /// <summary>
    /// The typed XML-DA error code parsed from <see cref="FaultCode"/>.
    /// </summary>
