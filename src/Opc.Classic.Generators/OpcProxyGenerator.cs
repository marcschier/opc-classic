...
";
    ...
    private static MethodModel CreateMethodModel(IMethodSymbol method)
    {
        ...
        foreach (var parameter in method.Parameters)
        {
            ...
            parameters.Add(new ParameterModel(EscapeIdentifier(parameter.Name), ToPascalCase(parameter.Name), parameter.Type.ToDisplayString(TypeDisplayFormat), parameter.Type.ToDisplayString(CodecTypeDisplayFormat), isCancellationToken, parameter.RefKind, IsOpcInterfaceType(parameter.Type)));
        }
    ...
    {
        public ParameterModel(string name, string resultMemberName, string declaredType, string marshallingType, bool isCancellationToken, RefKind refKind, bool isOpcInterface) { Name = name; ResultMemberName = resultMemberName; DeclaredType = declaredType; MarshallingType = marshallingType; IsCancellationToken = isCancellationToken; RefKind = refKind; IsOpcInterface = isOpcInterface; }
