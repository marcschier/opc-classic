...
";
        ...
        string cancellationTokenValue)
    {
        ...
        sb.Append(indent).AppendLine("            {");
        sb.Append(indent).Append("                var ").Append(writerLocal).Append(" = new global::Opc.Classic.Ndr.NdrWriter(new global::System.Span<byte>(")
        ...
        string readerLocal)
    {
        ...
        sb.Append(indent).Append("            var ").Append(readerLocal).Append(" = new global::Opc.Classic.Ndr.NdrReader(")
