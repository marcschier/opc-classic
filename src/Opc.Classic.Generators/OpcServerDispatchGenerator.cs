...
";
    ...
    {
        public ParameterModel(string name, string resultMemberName, string declaredType, string marshallingType, bool isCancellationToken, RefKind refKind, bool isOpcInterface, bool isUniquePointer = false, string? underlyingValueType = null, bool emitArrayCount = false)
        {
            Name = name;
        ...
        /// <summary>True when this parameter is an NDR unique pointer (DCE 1.1 §14.3.10).</summary>
        public bool IsUniquePointer { get; }
        /// <summary>Underlying value type for nullable-value-type unique pointers; null for [OpcUniquePointer] on non-nullable scalars.</summary>
        public string? UnderlyingValueType { get; }
        /// <summary>True when this array parameter has [OpcEmitArrayCount]: a standalone DWORD count is emitted before the array's NDR max_count.</summary>
