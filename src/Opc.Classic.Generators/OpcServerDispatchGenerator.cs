...
";
    ...
    private static void EmitDecodeRequest(StringBuilder sb, string indent, MethodModel method)
    {
        ...
        foreach (var parameter in method.Parameters)
        {
            ...
            {
                EmitCodecReadLocal(sb, indent + "        ", readerLocal, method, parameter.DeclaredType, parameter.MarshallingType, parameter.IsOpcInterface, parameter.Name);
            }
        }
    }
    ...
    private static void EmitEncodeResponseMethod(StringBuilder sb, string indent, MethodModel method)
    {
        ...
        if (method.TaskReturnKind == TaskReturnKind.TaskOfT)
        {
            EmitCodecWrite(sb, indent + "            ", writerLocal, method.TaskResultMarshallingType!, ReturnValueLocal(method), method);
        }
        ...
        foreach (var parameter in method.Parameters)
        {
            ...
            {
                EmitCodecWrite(sb, indent + "            ", writerLocal, parameter.MarshallingType, parameter.Name, method);
            }
        }
    ...
    private static void EmitCodecWrite(StringBuilder sb, string statementIndent, string writerLocal, string marshallingType, string valueExpression, MethodModel method)
    {
    ...
    private static void EmitCodecReadLocal(StringBuilder sb, string statementIndent, string readerLocal, MethodModel method, string declaredType, string marshallingType, bool isOpcInterface, string targetLocal)
    {
        if (isOpcInterface)
        {
    ...
    {
        public ParameterModel(string name, string resultMemberName, string declaredType, string marshallingType, bool isCancellationToken, RefKind refKind, bool isOpcInterface)
        {
            Name = name;
