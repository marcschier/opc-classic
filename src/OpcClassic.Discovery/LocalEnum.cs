...
public sealed class LocalEnum : IOpcDiscovery
{
    ...
    /// <summary>
    /// Initializes a local enumerator from <c>OpcClassic:Servers</c> configuration.
    /// </summary>
    ...
    private static List<OpcServerEntry> ReadConfiguredEntries(IConfiguration configuration)
    {
        ...
        foreach (var section in configuration.GetSection("OpcClassic:Servers").GetChildren())
        {
