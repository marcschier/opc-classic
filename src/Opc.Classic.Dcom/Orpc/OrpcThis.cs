...
public sealed class OrpcThis
{
    ...
    /// <summary>
    /// Gets or initializes the COM version advertised in the call envelope.
    /// </summary>
    public OrpcComVersion Version { get; init; } = OrpcComVersion.Default;

    /// <summary>
    /// Gets or initializes ORPC flags. Zero is the normal value for remote calls.
    /// </summary>
    public uint Flags { get; init; }

    /// <summary>
    /// Gets or initializes the causality identifier for this logical call chain.
    /// </summary>
    ...
    /// <summary>
    /// Reads an ORPC_THIS envelope using NDR encoding.
    /// </summary>
