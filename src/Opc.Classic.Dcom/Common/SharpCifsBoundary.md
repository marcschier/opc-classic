...
This checklist covers the `src/Opc.Classic.Dcom/Common/` compatibility wrappers only. All tracked wrappers are now self-contained and the transitional package reference has been removed.
