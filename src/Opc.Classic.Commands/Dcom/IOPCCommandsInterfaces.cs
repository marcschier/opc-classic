...
public partial interface IOPCCommandInformation
{
    ...
    /// <summary><c>IOPCCommandInformation::QueryComands</c> (opnum 4) projected as command names.</summary>
    [OpcMethod(4)]
    Task<string[]> ListCommandsAsync(CancellationToken cancellationToken = default);

    /// <summary><c>IOPCCommandInformation::BrowseCommandTargets</c> (opnum 5) projected as target identifiers.</summary>
    [OpcMethod(5)]
    ...
    /// <summary><c>IOPCCommandInformation::GetCommandDescription</c> (opnum 6) projected as descriptive text.</summary>
    [OpcMethod(6)]
...
public partial interface IOPCCommandExecution
{
    ...
    /// <summary><c>IOPCCommandExecution::AsyncInvoke</c> (opnum 4) projected as invocation UUID.</summary>
    [OpcMethod(4)]
    ...
    /// <summary><c>IOPCCommandExecution::Connect</c> (opnum 5).</summary>
    [OpcMethod(5)]
    ...
    /// <summary><c>IOPCCommandExecution::Disconnect</c> (opnum 6).</summary>
    [OpcMethod(6)]
    Task DisconnectAsync(string invokeUuid, CancellationToken cancellationToken = default);

    /// <summary><c>IOPCCommandExecution::QueryState</c> (opnum 7) projected as permitted controls.</summary>
    [OpcMethod(7)]
    Task<string[]> QueryStateAsync(string invokeUuid, int waitTime, CancellationToken cancellationToken = default);

    /// <summary><c>IOPCCommandExecution::Control</c> (opnum 8).</summary>
    [OpcMethod(8)]
