...
{
    /// <summary>
    /// Returns item-specific property descriptors in addition to OPC DA standard properties.
    /// </summary>
    IReadOnlyList<OpcStandardProperty> GetAvailableProperties(string itemId);

    /// <summary>
    /// Resolves an indirect item ID for a property, if the property exposes one.
    /// </summary>
