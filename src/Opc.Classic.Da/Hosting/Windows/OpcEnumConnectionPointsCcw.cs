...
public static unsafe class OpcEnumConnectionPointsCcw
{
    ...
    /// <summary>Creates an <c>IEnumConnectionPoints</c> CCW with refcount = 1.</summary>
    internal static IntPtr Create(OpcEnumConnectionPointsEnumerator enumerator)
    {
    ...
    internal static OpcEnumConnectionPointsEnumerator? ResolveEnumerator(IntPtr instance) =>
        s_entries.TryGetValue(instance, out CcwEntry? entry)
            ? entry.EnumeratorHandle.Target as OpcEnumConnectionPointsEnumerator
            : null;
    ...
    private static IntPtr* AllocateVtable()
    {
        ...
        v[3] = (IntPtr)(delegate* unmanaged<IntPtr, uint, IntPtr*, uint*, int>)&OpcEnumConnectionPointsCcwMethods.Next;
        v[4] = (IntPtr)(delegate* unmanaged<IntPtr, uint, int>)&OpcEnumConnectionPointsCcwMethods.Skip;
        v[5] = (IntPtr)(delegate* unmanaged<IntPtr, int>)&OpcEnumConnectionPointsCcwMethods.Reset;
        v[6] = (IntPtr)(delegate* unmanaged<IntPtr, IntPtr*, int>)&OpcEnumConnectionPointsCcwMethods.Clone;
        return v;
    }
