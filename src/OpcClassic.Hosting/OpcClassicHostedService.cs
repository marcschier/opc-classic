...
/// </summary>
public sealed class OpcClassicHostedService : IHostedService
{
    ...
    private readonly ILogger<OpcClassicHostedService> _logger;

    /// <summary>Initializes a new instance of the <see cref="OpcClassicHostedService"/> class.</summary>
    public OpcClassicHostedService(
        IEnumerable<IOpcServerHost> hosts,
        ILogger<OpcClassicHostedService> logger)
    {
