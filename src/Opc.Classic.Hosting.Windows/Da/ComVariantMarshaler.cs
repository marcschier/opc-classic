...
public static unsafe class ComVariantMarshaler
{
    ...
    /// <summary>
    /// The size of a single VARIANT struct in native memory.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Writes an empty VARIANT (vt = VT_EMPTY, value bits zero) at <paramref name="dest"/>.
    /// </summary>
    ...
    /// <summary>
    /// Marshals <paramref name="variant"/> into the VARIANT slot at <paramref name="dest"/>.
    /// </summary>
    ...
    /// <summary>
    /// Reads a managed <see cref="OpcVariant"/> from the VARIANT slot at <paramref name="src"/>.
    /// </summary>
    ...
    /// <summary>
    /// Frees BSTR / SAFEARRAY heap allocations referenced by the VARIANT slot at <paramref name="ptr"/>.
    /// </summary>
    ...
    /// <summary>
    /// Allocates a managed BSTR from <paramref name="value"/>. Returns IntPtr.Zero for null.
    /// </summary>
    public static IntPtr AllocateBstr(string? value) =>
        value is null ? IntPtr.Zero : Marshal.StringToBSTR(value);

    /// <summary>
    /// Reads a BSTR pointer back to a managed string. Returns null for IntPtr.Zero.
    /// </summary>
