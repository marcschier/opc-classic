...
public static unsafe class OpcEnumConnectionsCcw
{
    ...
    internal static OpcEnumConnectionsEnumerator? ResolveEnumerator(IntPtr instance) =>
        s_entries.TryGetValue(instance, out CcwEntry? entry)
            ? entry.EnumeratorHandle.Target as OpcEnumConnectionsEnumerator
            : null;
    ...
    private static IntPtr* AllocateVtable()
    {
        ...
        v[3] = (IntPtr)(delegate* unmanaged<IntPtr, uint, OpcConnectData*, uint*, int>)&OpcEnumConnectionsCcwMethods.Next;
        v[4] = (IntPtr)(delegate* unmanaged<IntPtr, uint, int>)&OpcEnumConnectionsCcwMethods.Skip;
        v[5] = (IntPtr)(delegate* unmanaged<IntPtr, int>)&OpcEnumConnectionsCcwMethods.Reset;
        v[6] = (IntPtr)(delegate* unmanaged<IntPtr, IntPtr*, int>)&OpcEnumConnectionsCcwMethods.Clone;
        return v;
    }
