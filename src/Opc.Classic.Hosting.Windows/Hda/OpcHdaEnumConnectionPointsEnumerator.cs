...
internal sealed unsafe class OpcHdaEnumConnectionPointsEnumerator : IDisposable
{
    ...
    public OpcHdaEnumConnectionPointsEnumerator(IntPtr[] connectionPoints)
        : this(connectionPoints, 0)
    {
    }

    private OpcHdaEnumConnectionPointsEnumerator(IntPtr[] connectionPoints, int position)
    {
    ...
    internal OpcHdaEnumConnectionPointsEnumerator Clone()
    {
        lock (_syncRoot)
        {
            ThrowIfDisposed();
            return new OpcHdaEnumConnectionPointsEnumerator(AddRefSnapshot(_connectionPoints), _position);
        }
    }
