...
/// <summary>
/// In-process registration surface for AE event-sink callbacks.
/// </summary>
public interface IOpcAeEventSinkRegistration
{
    /// <summary>
    /// Registers a client event sink and returns the connection cookie.
    /// </summary>
    Task<int> AdviseEventSinkAsync(IOPCEventSink sink, CancellationToken cancellationToken = default);

    /// <summary>
    /// Unregisters a client event sink by connection cookie.
    /// </summary>
