...
/// <summary>
/// <c>IOPCEventServer</c> — top-level AE server interface (IID_IOPCEventServer).
/// </summary>
...
{
    /// <summary>
    /// <c>IOPCEventServer::GetStatus</c> (opnum 3). Returns the AE server runtime state.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <c>IOPCEventServer::CreateEventSubscription</c> (opnum 4). Creates a subscription object.
    /// </summary>
    [OpcMethod(4)]
    ...
    /// <summary>
    /// <c>IOPCEventServer::QueryAvailableFilters</c> (opnum 5). Returns the supported filter mask.
    /// </summary>
    [OpcMethod(5)]
    Task<int> QueryAvailableFiltersAsync(CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventServer::QueryEventCategories</c> (opnum 6). Returns category IDs and descriptions.
    /// </summary>
    [OpcMethod(6)]
    [OpcGenerateMultiOutRecord]
    ...
    /// <summary>
    /// <c>IOPCEventServer::QueryConditionNames</c> (opnum 7). Returns condition names for an event category.
    /// </summary>
    [OpcMethod(7)]
    Task<string[]> QueryConditionNamesAsync(int eventCategory, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventServer::QuerySubConditionNames</c> (opnum 8). Returns sub-condition names for a condition.
    /// </summary>
    [OpcMethod(8)]
    Task<string[]> QuerySubConditionNamesAsync(string conditionName, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventServer::QuerySourceConditions</c> (opnum 9). Returns condition names for a source.
    /// </summary>
    [OpcMethod(9)]
    Task<string[]> QuerySourceConditionsAsync(string source, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventServer::QueryEventAttributes</c> (opnum 10). Returns attribute IDs, descriptions, and VARTYPEs.
    /// </summary>
    [OpcMethod(10)]
    [OpcGenerateMultiOutRecord]
    ...
    /// <summary>
    /// <c>IOPCEventServer::TranslateToItemIDs</c> (opnum 11). Maps event attributes to DA item IDs.
    /// </summary>
    [OpcMethod(11)]
    [OpcGenerateMultiOutRecord]
    ...
    /// <summary>
    /// <c>IOPCEventServer::GetConditionState</c> (opnum 12). Returns a condition-state snapshot.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <c>IOPCEventServer::EnableConditionByArea</c> (opnum 13). Enables conditions by area.
    /// </summary>
    [OpcMethod(13)]
    ...
    /// <summary>
    /// <c>IOPCEventServer::EnableConditionBySource</c> (opnum 14). Enables conditions by source.
    /// </summary>
    [OpcMethod(14)]
    ...
    /// <summary>
    /// <c>IOPCEventServer::DisableConditionByArea</c> (opnum 15). Disables conditions by area.
    /// </summary>
    [OpcMethod(15)]
    ...
    /// <summary>
    /// <c>IOPCEventServer::DisableConditionBySource</c> (opnum 16). Disables conditions by source.
    /// </summary>
    [OpcMethod(16)]
    ...
    /// <summary>
    /// <c>IOPCEventServer::AckCondition</c> (opnum 17). Acknowledges condition events and returns per-event HRESULTs.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <c>IOPCEventServer::CreateAreaBrowser</c> (opnum 18). Creates an area browser object.
    /// </summary>
    [OpcMethod(18)]
...
/// <summary>
/// <c>IOPCEventServer2</c> — AE 1.10 interface derived from <c>IOPCEventServer</c>; new methods start at opnum 19.
/// </summary>
...
{
    /// <summary>
    /// <c>IOPCEventServer2::EnableConditionByArea2</c> (opnum 19). Enables conditions by area with per-area HRESULTs.
    /// </summary>
    [OpcMethod(19)]
    [return: OpcUniquePointer]
    ...
    /// <summary>
    /// <c>IOPCEventServer2::EnableConditionBySource2</c> (opnum 20). Enables conditions by source with per-source HRESULTs.
    /// </summary>
    [OpcMethod(20)]
    [return: OpcUniquePointer]
    ...
    /// <summary>
    /// <c>IOPCEventServer2::DisableConditionByArea2</c> (opnum 21). Disables conditions by area with per-area HRESULTs.
    /// </summary>
    [OpcMethod(21)]
    [return: OpcUniquePointer]
    ...
    /// <summary>
    /// <c>IOPCEventServer2::DisableConditionBySource2</c> (opnum 22). Disables conditions by source with per-source HRESULTs.
    /// </summary>
    [OpcMethod(22)]
    [return: OpcUniquePointer]
    ...
    /// <summary>
    /// <c>IOPCEventServer2::GetEnableStateByArea</c> (opnum 23). Returns direct and effective enable state per area.
    /// </summary>
    [OpcMethod(23)]
    [OpcGenerateMultiOutRecord]
    ...
    /// <summary>
    /// <c>IOPCEventServer2::GetEnableStateBySource</c> (opnum 24). Returns direct and effective enable state per source.
    /// </summary>
    [OpcMethod(24)]
    [OpcGenerateMultiOutRecord]
...
/// <summary>
/// <c>IOPCEventSubscriptionMgt</c> — AE event subscription management (IID_IOPCEventSubscriptionMgt).
/// </summary>
...
{
    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::SetFilter</c> (opnum 3). Updates the subscription filter.
    /// </summary>
    [OpcMethod(3)]
    Task SetFilterAsync(
        int eventType,
    ...
    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::GetFilter</c> (opnum 4). Returns the current subscription filter.
    /// </summary>
    [OpcMethod(4)]
    [OpcGenerateMultiOutRecord]
    Task GetFilterAsync(
    ...
    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::SelectReturnedAttributes</c> (opnum 5). Selects attributes returned for a category.
    /// </summary>
    [OpcMethod(5)]
    Task SetReturnedAttributesAsync(int eventCategory, int[] attributeIds, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::GetReturnedAttributes</c> (opnum 6). Returns selected attributes for a category.
    /// </summary>
    [OpcMethod(6)]
    Task<int[]> GetReturnedAttributesAsync(int eventCategory, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::Refresh</c> (opnum 7). Starts a condition refresh.
    /// </summary>
    [OpcMethod(7)]
    Task RefreshAsync(int connection, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::CancelRefresh</c> (opnum 8). Cancels a condition refresh.
    /// </summary>
    [OpcMethod(8)]
    Task CancelRefreshAsync(int connection, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::GetState</c> (opnum 9). Returns active state, buffering, and client handle.
    /// </summary>
    [OpcMethod(9)]
    [OpcGenerateMultiOutRecord]
    Task GetStateAsync(
    ...
    /// <summary>
    /// <c>IOPCEventSubscriptionMgt::SetState</c> (opnum 10). Updates state and returns revised buffering.
    /// </summary>
    [OpcMethod(10)]
    [OpcGenerateMultiOutRecord]
    Task SetStateAsync(
...
/// <summary>
/// <c>IOPCEventSubscriptionMgt2</c> — AE 1.10 keep-alive extensions (IID_IOPCEventSubscriptionMgt2).
/// </summary>
...
{
    /// <summary>
    /// <c>IOPCEventSubscriptionMgt2::SetKeepAlive</c> (opnum 11). Sets the keep-alive time and returns the revised value.
    /// </summary>
    [OpcMethod(11)]
    Task<int> SetKeepAliveAsync(int keepAliveTime, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventSubscriptionMgt2::GetKeepAlive</c> (opnum 12). Returns the current keep-alive time.
    /// </summary>
    [OpcMethod(12)]
...
/// <summary>
/// <c>IOPCEventAreaBrowser</c> — AE area-namespace browser (IID_IOPCEventAreaBrowser).
/// </summary>
...
{
    /// <summary>
    /// <c>IOPCEventAreaBrowser::ChangeBrowsePosition</c> (opnum 3). Moves the browser cursor.
    /// </summary>
    [OpcMethod(3)]
    Task ChangeBrowsePositionAsync(int browseDirection, string? position, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventAreaBrowser::BrowseOPCAreas</c> (opnum 4). Returns an <c>IEnumString</c> over areas or sources.
    /// </summary>
    [OpcMethod(4)]
    ...
    /// <summary>
    /// <c>IOPCEventAreaBrowser::GetQualifiedAreaName</c> (opnum 5). Returns a fully-qualified area name.
    /// </summary>
    [OpcMethod(5)]
    Task<string> GetQualifiedAreaNameAsync(string areaName, CancellationToken cancellationToken = default);

    /// <summary>
    /// <c>IOPCEventAreaBrowser::GetQualifiedSourceName</c> (opnum 6). Returns a fully-qualified source name.
    /// </summary>
    [OpcMethod(6)]
...
/// <summary>
/// <c>IOPCEventSink</c> — AE event-delivery callback sink (IID_IOPCEventSink).
/// </summary>
...
{
    /// <summary>
    /// <c>IOPCEventSink::OnEvent</c> (opnum 3). Delivers event notifications to the client callback sink.
    /// </summary>
    [OpcMethod(3)]
    Task OnEventAsync(
        int clientSubscription,
...
/// <summary>
/// <c>IEnumString</c> — COM string enumerator returned by AE browser methods.
/// </summary>
