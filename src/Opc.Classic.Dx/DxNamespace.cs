...
public static class DxNamespace {
    ...
    /// <summary>Builds a source-server path under <c>/DX/SourceServers</c>.</summary>
    public static string SourceServerPath(string sourceServerName) =>
        Join(SourceServersRootSegment, sourceServerName);

    /// <summary>Builds a source-server status path under <c>/DX/SourceServers</c>.</summary>
