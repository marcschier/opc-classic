...
/// <summary>
/// OPC DX <c>OPCError</c> value carried by status records.
/// </summary>
public sealed record DxError(OpcResultId Id, string? Text = null);

/// <summary>
/// OPC DX <c>DXQuality</c> complex type.
/// </summary>
...
/// <summary>
/// OPC DX <c>ServerStatus</c> complex type from §4.2.
/// </summary>
...
/// <summary>
/// OPC DX <c>DXConnectionStatus</c> complex type from §4.3.2.19.
/// </summary>
...
/// <summary>
/// OPC DX <c>DXSourceServerStatus</c> complex type from §4.4.1.6.
/// </summary>
...
/// <summary>
/// Response shape for <c>QueryDXConnections</c>.
/// </summary>
