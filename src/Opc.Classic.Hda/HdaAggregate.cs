...
{
    /// <summary>
    /// No aggregate — return raw values.
    /// </summary>
    None = 0,
    /// <summary>
    /// Interpolated values across the requested time range.
    /// </summary>
    Interpolative = 1,
    /// <summary>
    /// Sum of values (rectangular integration). Engineering-unit-time.
    /// </summary>
    Total = 2,
    /// <summary>
    ...
    StandardDeviation = 6,
    /// <summary>
    /// Minimum actual value over the range.
    /// </summary>
    Minimum = 7,
    /// <summary>
    ...
    MinimumActualTime = 8,
    /// <summary>
    /// Maximum actual value over the range.
    /// </summary>
    Maximum = 9,
    /// <summary>
    ...
    RegDev = 16,
    /// <summary>
    /// Variance over the interval.
    /// </summary>
    Variance = 17,
    /// <summary>
    /// End value minus start value, ignoring quality gaps.
    /// </summary>
    Range = 18,
    /// <summary>
