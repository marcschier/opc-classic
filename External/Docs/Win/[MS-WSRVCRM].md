...
- [2 Messages](#2-messages)
  ...
  - [2.2 Message Syntax](#22-message-syntax)
    - [2.2.1 SequenceAcknowledgement Header Block](#221-sequenceacknowledgement-header-block)
    - [2.2.2 AckRequested Header Block](#222-ackrequested-header-block)
    - [2.2.3 BufferRemaining Element Syntax](#223-bufferremaining-element-syntax)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 RMD Role Details](#31-rmd-role-details)
    - [3.1.1 Abstract Data Model](#311-abstract-data-model)
      - [3.1.1.1 FLOW_CONTROL_STATE](#3111-flowcontrolstate)
    ...
    - [3.1.7 Other Local Events](#317-other-local-events)
      - [3.1.7.1 GET_BUFFER_REMAINING](#3171-getbufferremaining)
      - [3.1.7.2 MESSAGE_PROCESSED](#3172-messageprocessed)
      - [3.1.7.3 MESSAGE_RECEIVED](#3173-messagereceived)
      - [3.1.7.4 SET_BUFFER_REMAINING](#3174-setbufferremaining)
  - [3.2 RMS Role Details](#32-rms-role-details)
    - [3.2.1 Abstract Data Model](#321-abstract-data-model)
      - [3.2.1.1 NOT_POLLING](#3211-notpolling)
      - [3.2.1.2 POLLING](#3212-polling)
    - [3.2.2 Timers](#322-timers)
      - [3.2.2.1 POLLING_TIMER](#3221-pollingtimer)
    - [3.2.3 Initialization](#323-initialization)
    - [3.2.4 Higher-Layer Triggered Events](#324-higher-layer-triggered-events)
    - [3.2.5 Message Processing Events and Sequencing Rules](#325-message-processing-events-and-sequencing-rules)
    - [3.2.6 Timer Events](#326-timer-events)
      - [3.2.6.1 POLLING_TIMER_EXPIRED](#3261-pollingtimerexpired)
    - [3.2.7 Other Local Events](#327-other-local-events)
      - [3.2.7.1 SEQ_ACK_RECEIVED](#3271-seqackreceived)
      - [3.2.7.2 SEQ_TERMINATED](#3272-seqterminated)
- [4 Protocol Examples](#4-protocol-examples)
  - [4.1 Message Examples](#41-message-examples)
    - [4.1.1 Message 1: Sequence(MessageNumber = 1)](#411-message-1-sequencemessagenumber-1)
    - [4.1.2 Message 2: SequenceAcknowledgement(BufferRemaining = 1)](#412-message-2-sequenceacknowledgementbufferremaining-1)
    - [4.1.3 Message 3: Sequence(MessageNumber = 2)](#413-message-3-sequencemessagenumber-2)
    - [4.1.4 Message 4: SequenceAcknowledgement(BufferRemaining = 0)](#414-message-4-sequenceacknowledgementbufferremaining-0)
    - [4.1.5 Message 5: SequenceAcknowledgement(BufferRemaining = 1)](#415-message-5-sequenceacknowledgementbufferremaining-1)
    - [4.1.6 Message 6: Sequence(MessageNumber = 3)](#416-message-6-sequencemessagenumber-3)
    - [4.1.7 Message 7: SequenceAcknowledgement(BufferRemaining = 0)](#417-message-7-sequenceacknowledgementbufferremaining-0)
