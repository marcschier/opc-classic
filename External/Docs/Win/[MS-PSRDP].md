...
- [2 Messages](#2-messages)
  - [2.1 Transport](#21-transport)
    - [2.1.1 Transport of Client Messages](#211-transport-of-client-messages)
    - [2.1.2 Transport of REMOTE_DEBUGGER_STATE Message](#212-transport-of-remotedebuggerstate-message)
    - [2.1.3 Transport of REMOTE_DEBUGGER_BREAKPOINT_UPDATED_EVENT Message](#213-transport-of-remotedebuggerbreakpointupdatedevent-message)
    - [2.1.4 Transport of REMOTE_DEBUGGER_STOP_EVENT Message](#214-transport-of-remotedebuggerstopevent-message)
  - [2.2 Message Syntax](#22-message-syntax)
    - [2.2.1 Namespaces](#221-namespaces)
    - [2.2.2 SET_PSDEBUGMODE Message](#222-setpsdebugmode-message)
    - [2.2.3 SET_PSDEBUGGERACTION Message](#223-setpsdebuggeraction-message)
    - [2.2.4 GET_PSDEBUGGERSTOPARGS Message](#224-getpsdebuggerstopargs-message)
    - [2.2.5 SET_PSDEBUGGERSTEPMODE Message](#225-setpsdebuggerstepmode-message)
    - [2.2.6 SET_PSUNHANDLEDBREAKPOINTMODE Message](#226-setpsunhandledbreakpointmode-message)
    - [2.2.7 REMOTE_DEBUGGER_STATE Message](#227-remotedebuggerstate-message)
    - [2.2.8 REMOTE_DEBUGGER_BREAKPOINT_UPDATED_EVENT Message](#228-remotedebuggerbreakpointupdatedevent-message)
    - [2.2.9 REMOTE_DEBUGGER_STOP_EVENT Message](#229-remotedebuggerstopevent-message)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 Client Details](#31-client-details)
    ...
    - [3.1.4 Message Processing Events and Sequencing Rules](#314-message-processing-events-and-sequencing-rules)
      - [3.1.4.1 SET_PSDEBUGMODE Message](#3141-setpsdebugmode-message)
      - [3.1.4.2 SET_PSDEBUGGERACTION Message](#3142-setpsdebuggeraction-message)
      - [3.1.4.3 GET_PSDEBUGGERSTOPARGS Message](#3143-getpsdebuggerstopargs-message)
      - [3.1.4.4 SET_PSDEBUGGERSTEPMODE Message](#3144-setpsdebuggerstepmode-message)
      - [3.1.4.5 SET_PSUNHANDLEDBREAKPOINTMODE Message](#3145-setpsunhandledbreakpointmode-message)
    - [3.1.5 Other Local Events](#315-other-local-events)
  - [3.2 Server Details](#32-server-details)
    - [3.2.1 Abstract Data Model](#321-abstract-data-model)
    - [3.2.2 Initialization](#322-initialization)
    - [3.2.3 Higher-Layer Triggered Events](#323-higher-layer-triggered-events)
    - [3.2.4 Message Processing Events and Sequencing Rules](#324-message-processing-events-and-sequencing-rules)
      - [3.2.4.1 SET_PSDEBUGMODE Message](#3241-setpsdebugmode-message)
      - [3.2.4.2 SET_PSDEBUGGERACTION Message](#3242-setpsdebuggeraction-message)
      - [3.2.4.3 GET_PSDEBUGGERSTOPARGS Message](#3243-getpsdebuggerstopargs-message)
      - [3.2.4.4 SET_PSDEBUGGERSTEPMODE Message](#3244-setpsdebuggerstepmode-message)
      - [3.2.4.5 SET_PSUNHANDLEDBREAKPOINTMODE Message](#3245-setpsunhandledbreakpointmode-message)
      - [3.2.4.6 REMOTE_DEBUGGER_STATE Message](#3246-remotedebuggerstate-message)
      - [3.2.4.7 REMOTE_DEBUGGER_BREAKPOINT_UPDATED_EVENT Message](#3247-remotedebuggerbreakpointupdatedevent-message)
      - [3.2.4.8 REMOTE_DEBUGGER_STOP_EVENT Message](#3248-remotedebuggerstopevent-message)
    - [3.2.5 Other Local Events](#325-other-local-events)
