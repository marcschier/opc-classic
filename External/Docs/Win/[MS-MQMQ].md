...
- [1 Introduction](#1-introduction)
  ...
  - [1.3 Structure Overview](#13-structure-overview)
...
- [2 Definitions and Structures](#2-definitions-and-structures)
  - [2.1 MSMQ Queue Names](#21-msmq-queue-names)
    - [2.1.1 Path Names](#211-path-names)
    - [2.1.2 Direct Format Names](#212-direct-format-names)
    - [2.1.3 Public Format Names](#213-public-format-names)
    - [2.1.4 Private Format Names](#214-private-format-names)
    - [2.1.5 Distribution List Format Names](#215-distribution-list-format-names)
    - [2.1.6 Machine, Connector, and Multicast Format Names](#216-machine-connector-and-multicast-format-names)
    - [2.1.7 Multiple-Element Format Names](#217-multiple-element-format-names)
  - [2.2 Structures](#22-structures)
    - [2.2.1 MQDSPUBLICKEY](#221-mqdspublickey)
    - [2.2.2 MQDSPUBLICKEYS](#222-mqdspublickeys)
    - [2.2.3 SECURITY_INFORMATION](#223-securityinformation)
    - [2.2.4 TA_ADDRESS](#224-taaddress)
      - [2.2.4.1 IP Address](#2241-ip-address)
      - [2.2.4.2 IPX Address](#2242-ipx-address)
    - [2.2.5 SEQUENCE_INFO](#225-sequenceinfo)
      - [2.2.5.1 SEQUENCE_INFO (Packet)](#2251-sequenceinfo-packet)
    - [2.2.6 QUEUE_FORMAT_TYPE](#226-queueformattype)
    - [2.2.7 QUEUE_FORMAT](#227-queueformat)
    - [2.2.8 OBJECTID](#228-objectid)
    - [2.2.9 DL_ID](#229-dlid)
    - [2.2.10 MULTICAST_ID](#2210-multicastid)
    - [2.2.11 QUEUE_SUFFIX_TYPE](#2211-queuesuffixtype)
    - [2.2.12 PROPVARIANT Type Constants](#2212-propvariant-type-constants)
      - [2.2.12.1 VARTYPE](#22121-vartype)
    - [2.2.13 PROPVARIANT](#2213-propvariant)
      - [2.2.13.1 tag_inner_PROPVARIANT](#22131-taginnerpropvariant)
      - [2.2.13.2 PROPVARIANT](#22132-propvariant)
    - [2.2.14 VARIANT_BOOL](#2214-variantbool)
    - [2.2.15 BLOB](#2215-blob)
    - [2.2.16 COUNTEDARRAY](#2216-countedarray)
      - [2.2.16.1 CAUB](#22161-caub)
      - [2.2.16.2 CAUI](#22162-caui)
      - [2.2.16.3 CAL](#22163-cal)
      - [2.2.16.4 CAUL](#22164-caul)
      - [2.2.16.5 CAUH](#22165-cauh)
      - [2.2.16.6 CACLSID](#22166-caclsid)
      - [2.2.16.7 CALPWSTR](#22167-calpwstr)
      - [2.2.16.8 CAPROPVARIANT](#22168-capropvariant)
    - [2.2.17 ULARGE_INTEGER](#2217-ulargeinteger)
    - [2.2.18 Common Packet Syntax](#2218-common-packet-syntax)
      - [2.2.18.1 Packet Data Types](#22181-packet-data-types)
        - [2.2.18.1.1 GUID](#221811-guid)
        - [2.2.18.1.2 TxSequenceID](#221812-txsequenceid)
        - [2.2.18.1.3 MessageIdentifier](#221813-messageidentifier)
        - [2.2.18.1.4 MQFFormatNameElement](#221814-mqfformatnameelement)
          - [2.2.18.1.4.1 MQFDirectQueueFormatName](#2218141-mqfdirectqueueformatname)
          - [2.2.18.1.4.2 MQFDistributionQueueFormatName](#2218142-mqfdistributionqueueformatname)
        - [2.2.18.1.5 Queue Format Type](#221815-queue-format-type)
          - [2.2.18.1.5.1 PrivateQueueFormatNameId](#2218151-privatequeueformatnameid)
          - [2.2.18.1.5.2 DirectQueueFormatName](#2218152-directqueueformatname)
        - [2.2.18.1.6 Message Class Identifiers](#221816-message-class-identifiers)
        - [2.2.18.1.7 Common Queue Formats](#221817-common-queue-formats)
          - [2.2.18.1.7.1 PublicQueueFormatName](#2218171-publicqueueformatname)
          - [2.2.18.1.7.2 PrivateQueueFormatName](#2218172-privatequeueformatname)
        - [2.2.18.1.8 XACTUOW](#221818-xactuow)
    - [2.2.19 Common Headers](#2219-common-headers)
      - [2.2.19.1 BaseHeader](#22191-baseheader)
      - [2.2.19.2 UserHeader](#22192-userheader)
      - [2.2.19.3 MessagePropertiesHeader](#22193-messagepropertiesheader)
    - [2.2.20 UserMessage Packet](#2220-usermessage-packet)
      - [2.2.20.1 MultiQueueFormatHeader](#22201-multiqueueformatheader)
      - [2.2.20.2 MQFAddressHeader](#22202-mqfaddressheader)
      - [2.2.20.3 MQFSignatureHeader](#22203-mqfsignatureheader)
      - [2.2.20.4 SessionHeader](#22204-sessionheader)
      - [2.2.20.5 TransactionHeader](#22205-transactionheader)
      - [2.2.20.6 SecurityHeader](#22206-securityheader)
      - [2.2.20.7 SoapHeader](#22207-soapheader)
      - [2.2.20.8 DebugHeader](#22208-debugheader)
    - [2.2.21 MQUSERSIGNCERTS](#2221-mqusersigncerts)
    - [2.2.22 MQUSERSIGNCERT](#2222-mqusersigncert)
    - [2.2.23 MQQMACCESSMASK](#2223-mqqmaccessmask)
    - [2.2.24 MQQUEUEACCESSMASK](#2224-mqqueueaccessmask)
    - [2.2.25 MQSITEACCESSMASK](#2225-mqsiteaccessmask)
    - [2.2.26 MQENTACCESSMASK](#2226-mqentaccessmask)
    - [2.2.27 MQCNACCESSMASK](#2227-mqcnaccessmask)
  - [2.3 PROPID](#23-propid)
    - [2.3.1 Queue Property Identifiers](#231-queue-property-identifiers)
      - [2.3.1.1 PROPID_Q_INSTANCE](#2311-propidqinstance)
      - [2.3.1.2 PROPID_Q_TYPE](#2312-propidqtype)
      - [2.3.1.3 PROPID_Q_PATHNAME](#2313-propidqpathname)
      - [2.3.1.4 PROPID_Q_JOURNAL](#2314-propidqjournal)
      - [2.3.1.5 PROPID_Q_QUOTA](#2315-propidqquota)
      - [2.3.1.6 PROPID_Q_BASEPRIORITY](#2316-propidqbasepriority)
      - [2.3.1.7 PROPID_Q_JOURNAL_QUOTA](#2317-propidqjournalquota)
      - [2.3.1.8 PROPID_Q_LABEL](#2318-propidqlabel)
      - [2.3.1.9 PROPID_Q_CREATE_TIME](#2319-propidqcreatetime)
      - [2.3.1.10 PROPID_Q_MODIFY_TIME](#23110-propidqmodifytime)
      - [2.3.1.11 PROPID_Q_AUTHENTICATE](#23111-propidqauthenticate)
      - [2.3.1.12 PROPID_Q_PRIV_LEVEL](#23112-propidqprivlevel)
      - [2.3.1.13 PROPID_Q_TRANSACTION](#23113-propidqtransaction)
      - [2.3.1.14 PROPID_Q_SCOPE](#23114-propidqscope)
      - [2.3.1.15 PROPID_Q_QMID](#23115-propidqqmid)
      - [2.3.1.16 PROPID_Q_PARTITIONID](#23116-propidqpartitionid)
      - [2.3.1.17 PROPID_Q_SEQNUM](#23117-propidqseqnum)
      - [2.3.1.18 PROPID_Q_HASHKEY](#23118-propidqhashkey)
      - [2.3.1.19 PROPID_Q_LABEL_HASHKEY](#23119-propidqlabelhashkey)
      - [2.3.1.20 PROPID_Q_FULL_PATH](#23120-propidqfullpath)
      - [2.3.1.21 PROPID_Q_NAME_SUFFIX](#23121-propidqnamesuffix)
      - [2.3.1.22 PROPID_Q_PATHNAME_DNS](#23122-propidqpathnamedns)
      - [2.3.1.23 PROPID_Q_MULTICAST_ADDRESS](#23123-propidqmulticastaddress)
      - [2.3.1.24 PROPID_Q_ADS_PATH](#23124-propidqadspath)
      - [2.3.1.25 PROPID_Q_SECURITY](#23125-propidqsecurity)
      - [2.3.1.26 PROPID_Q_OBJ_SECURITY](#23126-propidqobjsecurity)
      - [2.3.1.27 PROPID_Q_SECURITY_INFORMATION](#23127-propidqsecurityinformation)
    - [2.3.2 Machine Property Identifiers](#232-machine-property-identifiers)
      - [2.3.2.1 PROPID_QM_SITE_ID](#2321-propidqmsiteid)
      - [2.3.2.2 PROPID_QM_MACHINE_ID](#2322-propidqmmachineid)
      - [2.3.2.3 PROPID_QM_PATHNAME](#2323-propidqmpathname)
      - [2.3.2.4 PROPID_QM_ENCRYPTION_PK](#2324-propidqmencryptionpk)
      - [2.3.2.5 PROPID_QM_ADDRESS](#2325-propidqmaddress)
      - [2.3.2.6 PROPID_QM_CNS](#2326-propidqmcns)
      - [2.3.2.7 PROPID_QM_OUTFRS](#2327-propidqmoutfrs)
      - [2.3.2.8 PROPID_QM_INFRS](#2328-propidqminfrs)
      - [2.3.2.9 PROPID_QM_SERVICE](#2329-propidqmservice)
      - [2.3.2.10 PROPID_QM_QUOTA](#23210-propidqmquota)
      - [2.3.2.11 PROPID_QM_PARTITIONID](#23211-propidqmpartitionid)
      - [2.3.2.12 PROPID_QM_HASHKEY](#23212-propidqmhashkey)
      - [2.3.2.13 PROPID_QM_SEQNUM](#23213-propidqmseqnum)
      - [2.3.2.14 PROPID_QM_JOURNAL_QUOTA](#23214-propidqmjournalquota)
      - [2.3.2.15 PROPID_QM_MACHINE_TYPE](#23215-propidqmmachinetype)
      - [2.3.2.16 PROPID_QM_CREATE_TIME](#23216-propidqmcreatetime)
      - [2.3.2.17 PROPID_QM_MODIFY_TIME](#23217-propidqmmodifytime)
      - [2.3.2.18 PROPID_QM_FOREIGN](#23218-propidqmforeign)
      - [2.3.2.19 PROPID_QM_OS](#23219-propidqmos)
      - [2.3.2.20 PROPID_QM_FULL_PATH](#23220-propidqmfullpath)
      - [2.3.2.21 PROPID_QM_SITE_IDS](#23221-propidqmsiteids)
      - [2.3.2.22 PROPID_QM_OUTFRS_DN](#23222-propidqmoutfrsdn)
      - [2.3.2.23 PROPID_QM_INFRS_DN](#23223-propidqminfrsdn)
      - [2.3.2.24 PROPID_QM_SERVICE_ROUTING](#23224-propidqmservicerouting)
      - [2.3.2.25 PROPID_QM_SERVICE_DSSERVER](#23225-propidqmservicedsserver)
      - [2.3.2.26 PROPID_QM_SERVICE_DEPCLIENTS](#23226-propidqmservicedepclients)
      - [2.3.2.27 PROPID_QM_ENCRYPTION_PK_BASE](#23227-propidqmencryptionpkbase)
      - [2.3.2.28 PROPID_QM_ENCRYPTION_PK_ENHANCED](#23228-propidqmencryptionpkenhanced)
      - [2.3.2.29 PROPID_QM_PATHNAME_DNS](#23229-propidqmpathnamedns)
      - [2.3.2.30 PROPID_QM_OBJ_SECURITY](#23230-propidqmobjsecurity)
      - [2.3.2.31 PROPID_QM_SECURITY_INFORMATION](#23231-propidqmsecurityinformation)
      - [2.3.2.32 PROPID_QM_ENCRYPT_PKS](#23232-propidqmencryptpks)
      - [2.3.2.33 PROPID_QM_SIGN_PKS](#23233-propidqmsignpks)
      - [2.3.2.34 PROPID_QM_OWNER_SID](#23234-propidqmownersid)
      - [2.3.2.35 PROPID_QM_GROUP_IN_CLUSTER](#23235-propidqmgroupincluster)
      - [2.3.2.36 PROPID_QM_SECURITY](#23236-propidqmsecurity)
      - [2.3.2.37 PROPID_QM_SIGN_PK](#23237-propidqmsignpk)
      - [2.3.2.38 PROPID_QM_ENCRYPT_PK](#23238-propidqmencryptpk)
      - [2.3.2.39 PROPID_QM_UPGRADE_DACL](#23239-propidqmupgradedacl)
    - [2.3.3 Site Property Identifiers](#233-site-property-identifiers)
      - [2.3.3.1 PROPID_S_PATHNAME](#2331-propidspathname)
      - [2.3.3.2 PROPID_S_SITEID](#2332-propidssiteid)
      - [2.3.3.3 PROPID_S_GATES](#2333-propidsgates)
      - [2.3.3.4 PROPID_S_PSC](#2334-propidspsc)
      - [2.3.3.5 PROPID_S_INTERVAL1](#2335-propidsinterval1)
      - [2.3.3.6 PROPID_S_INTERVAL2](#2336-propidsinterval2)
      - [2.3.3.7 PROPID_S_PARTITIONID](#2337-propidspartitionid)
      - [2.3.3.8 PROPID_S_SEQNUM](#2338-propidsseqnum)
      - [2.3.3.9 PROPID_S_FULL_NAME](#2339-propidsfullname)
      - [2.3.3.10 PROPID_S_NT4_STUB](#23310-propidsnt4stub)
      - [2.3.3.11 PROPID_S_FOREIGN](#23311-propidsforeign)
      - [2.3.3.12 PROPID_S_DONOTHING](#23312-propidsdonothing)
      - [2.3.3.13 PROPID_S_SECURITY](#23313-propidssecurity)
      - [2.3.3.14 PROPID_S_PSC_SIGNPK](#23314-propidspscsignpk)
      - [2.3.3.15 PROPID_S_SECURITY_INFORMATION](#23315-propidssecurityinformation)
    - [2.3.4 Connected Network Property Identifiers](#234-connected-network-property-identifiers)
      - [2.3.4.1 PROPID_CN_PROTOCOLID](#2341-propidcnprotocolid)
      - [2.3.4.2 PROPID_CN_NAME](#2342-propidcnname)
      - [2.3.4.3 PROPID_CN_GUID](#2343-propidcnguid)
      - [2.3.4.4 PROPID_CN_PARTITIONID](#2344-propidcnpartitionid)
      - [2.3.4.5 PROPID_CN_SEQNUM](#2345-propidcnseqnum)
      - [2.3.4.6 PROPID_CN_SECURITY](#2346-propidcnsecurity)
    - [2.3.5 Enterprise Object Property Identifiers](#235-enterprise-object-property-identifiers)
      - [2.3.5.1 PROPID_E_NAME](#2351-propidename)
      - [2.3.5.2 PROPID_E_NAMESTYLE](#2352-propidenamestyle)
      - [2.3.5.3 PROPID_E_CSP_NAME](#2353-propidecspname)
      - [2.3.5.4 PROPID_E_PECNAME](#2354-propidepecname)
      - [2.3.5.5 PROPID_E_S_INTERVAL1](#2355-propidesinterval1)
      - [2.3.5.6 PROPID_E_S_INTERVAL2](#2356-propidesinterval2)
      - [2.3.5.7 PROPID_E_PARTITIONID](#2357-propidepartitionid)
      - [2.3.5.8 PROPID_E_SEQNUM](#2358-propideseqnum)
      - [2.3.5.9 PROPID_E_ID](#2359-propideid)
      - [2.3.5.10 PROPID_E_CRL](#23510-propidecrl)
      - [2.3.5.11 PROPID_E_CSP_TYPE](#23511-propidecsptype)
      - [2.3.5.12 PROPID_E_ENCRYPT_ALG](#23512-propideencryptalg)
      - [2.3.5.13 PROPID_E_SIGN_ALG](#23513-propidesignalg)
      - [2.3.5.14 PROPID_E_HASH_ALG](#23514-propidehashalg)
      - [2.3.5.15 PROPID_E_LONG_LIVE](#23515-propidelonglive)
      - [2.3.5.16 PROPID_E_VERSION](#23516-propideversion)
      - [2.3.5.17 PROPID_E_SECURITY](#23517-propidesecurity)
      - [2.3.5.18 PROPID_E_CIPHER_MODE](#23518-propideciphermode)
    - [2.3.6 User Object Property Identifiers](#236-user-object-property-identifiers)
      - [2.3.6.1 PROPID_U_SID](#2361-propidusid)
      - [2.3.6.2 PROPID_U_PARTITIONID](#2362-propidupartitionid)
      - [2.3.6.3 PROPID_U_SEQNUM](#2363-propiduseqnum)
      - [2.3.6.4 PROPID_U_SIGN_CERT](#2364-propidusigncert)
      - [2.3.6.5 PROPID_U_DIGEST](#2365-propidudigest)
      - [2.3.6.6 PROPID_U_ID](#2366-propiduid)
    - [2.3.7 Routinglink Property Identifiers](#237-routinglink-property-identifiers)
      - [2.3.7.1 PROPID_L_NEIGHBOR1](#2371-propidlneighbor1)
      - [2.3.7.2 PROPID_L_NEIGHBOR2](#2372-propidlneighbor2)
      - [2.3.7.3 PROPID_L_COST](#2373-propidlcost)
      - [2.3.7.4 PROPID_L_PARTITIONID](#2374-propidlpartitionid)
      - [2.3.7.5 PROPID_L_SEQNUM](#2375-propidlseqnum)
      - [2.3.7.6 PROPID_L_ID](#2376-propidlid)
      - [2.3.7.7 PROPID_L_GATES_DN](#2377-propidlgatesdn)
      - [2.3.7.8 PROPID_L_NEIGHBOR1_DN](#2378-propidlneighbor1dn)
      - [2.3.7.9 PROPID_L_NEIGHBOR2_DN](#2379-propidlneighbor2dn)
      - [2.3.7.10 PROPID_L_DESCRIPTION](#23710-propidldescription)
      - [2.3.7.11 PROPID_L_FULL_PATH](#23711-propidlfullpath)
      - [2.3.7.12 PROPID_L_ACTUAL_COST](#23712-propidlactualcost)
      - [2.3.7.13 PROPID_L_GATES](#23713-propidlgates)
    - [2.3.8 Settings Property Identifiers](#238-settings-property-identifiers)
      - [2.3.8.1 PROPID_SET_NAME](#2381-propidsetname)
      - [2.3.8.2 PROPID_SET_SERVICE](#2382-propidsetservice)
      - [2.3.8.3 PROPID_SET_QM_ID](#2383-propidsetqmid)
      - [2.3.8.4 PROPID_SET_FULL_PATH](#2384-propidsetfullpath)
      - [2.3.8.5 PROPID_SET_NT4](#2385-propidsetnt4)
      - [2.3.8.6 PROPID_SET_PARTITIONID](#2386-propidsetpartitionid)
      - [2.3.8.7 PROPID_SET_SITENAME](#2387-propidsetsitename)
      - [2.3.8.8 PROPID_SET_SERVICE_ROUTING](#2388-propidsetservicerouting)
      - [2.3.8.9 PROPID_SET_SERVICE_DSSERVER](#2389-propidsetservicedsserver)
      - [2.3.8.10 PROPID_SET_SERVICE_DEPCLIENTS](#23810-propidsetservicedepclients)
      - [2.3.8.11 PROPID_SET_OLDSERVICE](#23811-propidsetoldservice)
    - [2.3.9 MQUser Property Identifiers](#239-mquser-property-identifiers)
      - [2.3.9.1 PROPID_MQU_SID](#2391-propidmqusid)
      - [2.3.9.2 PROPID_MQU_SIGN_CERT](#2392-propidmqusigncert)
      - [2.3.9.3 PROPID_MQU_DIGEST](#2393-propidmqudigest)
      - [2.3.9.4 PROPID_MQU_ID](#2394-propidmquid)
      - [2.3.9.5 PROPID_MQU_SECURITY](#2395-propidmqusecurity)
    - [2.3.10 Computer Property Identifiers](#2310-computer-property-identifiers)
      - [2.3.10.1 PROPID_COM_FULL_PATH](#23101-propidcomfullpath)
      - [2.3.10.2 PROPID_COM_SAM_ACCOUNT](#23102-propidcomsamaccount)
      - [2.3.10.3 PROPID_COM_ACCOUNT_CONTROL](#23103-propidcomaccountcontrol)
      - [2.3.10.4 PROPID_COM_DNS_HOSTNAME](#23104-propidcomdnshostname)
      - [2.3.10.5 PROPID_COM_SID](#23105-propidcomsid)
      - [2.3.10.6 PROPID_COM_SIGN_CERT](#23106-propidcomsigncert)
      - [2.3.10.7 PROPID_COM_DIGEST](#23107-propidcomdigest)
      - [2.3.10.8 PROPID_COM_ID](#23108-propidcomid)
    - [2.3.11 Management Machine Property Identifiers](#2311-management-machine-property-identifiers)
      - [2.3.11.1 PROPID_MGMT_MSMQ_ACTIVEQUEUES](#23111-propidmgmtmsmqactivequeues)
      - [2.3.11.2 PROPID_MGMT_MSMQ_PRIVATEQ](#23112-propidmgmtmsmqprivateq)
      - [2.3.11.3 PROPID_MGMT_MSMQ_DSSERVER](#23113-propidmgmtmsmqdsserver)
      - [2.3.11.4 PROPID_MGMT_MSMQ_CONNECTED](#23114-propidmgmtmsmqconnected)
      - [2.3.11.5 PROPID_MGMT_MSMQ_TYPE](#23115-propidmgmtmsmqtype)
      - [2.3.11.6 PROPID_MGMT_MSMQ_BYTES_IN_ALL_QUEUES](#23116-propidmgmtmsmqbytesinallqueues)
    - [2.3.12 Management Queue Property Identifiers](#2312-management-queue-property-identifiers)
      - [2.3.12.1 PROPID_MGMT_QUEUE_PATHNAME](#23121-propidmgmtqueuepathname)
      - [2.3.12.2 PROPID_MGMT_QUEUE_FORMATNAME](#23122-propidmgmtqueueformatname)
      - [2.3.12.3 PROPID_MGMT_QUEUE_TYPE](#23123-propidmgmtqueuetype)
      - [2.3.12.4 PROPID_MGMT_QUEUE_LOCATION](#23124-propidmgmtqueuelocation)
      - [2.3.12.5 PROPID_MGMT_QUEUE_XACT](#23125-propidmgmtqueuexact)
      - [2.3.12.6 PROPID_MGMT_QUEUE_FOREIGN](#23126-propidmgmtqueueforeign)
      - [2.3.12.7 PROPID_MGMT_QUEUE_MESSAGE_COUNT](#23127-propidmgmtqueuemessagecount)
      - [2.3.12.8 PROPID_MGMT_QUEUE_BYTES_IN_QUEUE](#23128-propidmgmtqueuebytesinqueue)
      - [2.3.12.9 PROPID_MGMT_QUEUE_JOURNAL_MESSAGE_COUNT](#23129-propidmgmtqueuejournalmessagecount)
      - [2.3.12.10 PROPID_MGMT_QUEUE_BYTES_IN_JOURNAL](#231210-propidmgmtqueuebytesinjournal)
      - [2.3.12.11 PROPID_MGMT_QUEUE_STATE](#231211-propidmgmtqueuestate)
      - [2.3.12.12 PROPID_MGMT_QUEUE_NEXTHOPS](#231212-propidmgmtqueuenexthops)
      - [2.3.12.13 PROPID_MGMT_QUEUE_EOD_LAST_ACK](#231213-propidmgmtqueueeodlastack)
      - [2.3.12.14 PROPID_MGMT_QUEUE_EOD_LAST_ACK_TIME](#231214-propidmgmtqueueeodlastacktime)
      - [2.3.12.15 PROPID_MGMT_QUEUE_EOD_LAST_ACK_COUNT](#231215-propidmgmtqueueeodlastackcount)
      - [2.3.12.16 PROPID_MGMT_QUEUE_EOD_FIRST_NON_ACK](#231216-propidmgmtqueueeodfirstnonack)
      - [2.3.12.17 PROPID_MGMT_QUEUE_EOD_LAST_NON_ACK](#231217-propidmgmtqueueeodlastnonack)
      - [2.3.12.18 PROPID_MGMT_QUEUE_EOD_NEXT_SEQ](#231218-propidmgmtqueueeodnextseq)
      - [2.3.12.19 PROPID_MGMT_QUEUE_EOD_NO_READ_COUNT](#231219-propidmgmtqueueeodnoreadcount)
      - [2.3.12.20 PROPID_MGMT_QUEUE_EOD_NO_ACK_COUNT](#231220-propidmgmtqueueeodnoackcount)
      - [2.3.12.21 PROPID_MGMT_QUEUE_EOD_RESEND_TIME](#231221-propidmgmtqueueeodresendtime)
      - [2.3.12.22 PROPID_MGMT_QUEUE_EOD_RESEND_INTERVAL](#231222-propidmgmtqueueeodresendinterval)
      - [2.3.12.23 PROPID_MGMT_QUEUE_EOD_RESEND_COUNT](#231223-propidmgmtqueueeodresendcount)
      - [2.3.12.24 PROPID_MGMT_QUEUE_EOD_SOURCE_INFO](#231224-propidmgmtqueueeodsourceinfo)
      - [2.3.12.25 PROPID_MGMT_QUEUE_CONNECTION_HISTORY](#231225-propidmgmtqueueconnectionhistory)
      - [2.3.12.26 PROPID_MGMT_QUEUE_SUBQUEUE_COUNT](#231226-propidmgmtqueuesubqueuecount)
      - [2.3.12.27 PROPID_MGMT_QUEUE_SUBQUEUE_NAMES](#231227-propidmgmtqueuesubqueuenames)
    - [2.3.13 Deletion Notification Property Identifiers](#2313-deletion-notification-property-identifiers)
      - [2.3.13.1 PROPID_D_SEQNUM](#23131-propiddseqnum)
      - [2.3.13.2 PROPID_D_PARTITIONID](#23132-propiddpartitionid)
      - [2.3.13.3 PROPID_D_SCOPE](#23133-propiddscope)
      - [2.3.13.4 PROPID_D_OBJTYPE](#23134-propiddobjtype)
      - [2.3.13.5 PROPID_D_IDENTIFIER](#23135-propiddidentifier)
  - [2.4 Error Codes](#24-error-codes)
  - [2.5 Message Properties for Digital Signatures](#25-message-properties-for-digital-signatures)
    - [2.5.1 MSMQ 1.0 Digital Signature Properties](#251-msmq-10-digital-signature-properties)
    - [2.5.2 MSMQ 2.0 Digital Signature Properties](#252-msmq-20-digital-signature-properties)
    - [2.5.3 MSMQ 3.0 Digital Signature Properties](#253-msmq-30-digital-signature-properties)
