...
- [2 Messages](#2-messages)
  ...
  - [2.2 Message Syntax](#22-message-syntax)
    - [2.2.1 Common Data Types](#221-common-data-types)
      - [2.2.1.1 Data Types](#2211-data-types)
        - [2.2.1.1.1 ULONGLONG](#22111-ulonglong)
        - [2.2.1.1.2 DWORD](#22112-dword)
        - [2.2.1.1.3 VDS_OBJECT_ID](#22113-vdsobjectid)
        - [2.2.1.1.4 VDS_LUN_INFORMATION](#22114-vdsluninformation)
        - [2.2.1.1.5 ACCESS_MASK](#22115-accessmask)
      - [2.2.1.2 Enumerations](#2212-enumerations)
        - [2.2.1.2.1 VDS_HEALTH](#22121-vdshealth)
        - [2.2.1.2.2 VDS_NOTIFICATION_TARGET_TYPE](#22122-vdsnotificationtargettype)
        - [2.2.1.2.3 VDS_RECOVER_ACTION](#22123-vdsrecoveraction)
        - [2.2.1.2.4 VDS_ASYNC_OUTPUT_TYPE](#22124-vdsasyncoutputtype)
        - [2.2.1.2.5 VDS_STORAGE_BUS_TYPE](#22125-vdsstoragebustype)
        - [2.2.1.2.6 VDS_STORAGE_IDENTIFIER_CODE_SET](#22126-vdsstorageidentifiercodeset)
        - [2.2.1.2.7 VDS_STORAGE_IDENTIFIER_TYPE](#22127-vdsstorageidentifiertype)
        - [2.2.1.2.8 VDS_INTERCONNECT_ADDRESS_TYPE](#22128-vdsinterconnectaddresstype)
        - [2.2.1.2.9 VDS_FILE_SYSTEM_TYPE](#22129-vdsfilesystemtype)
        - [2.2.1.2.10 VDS_FILE_SYSTEM_FLAG](#221210-vdsfilesystemflag)
        - [2.2.1.2.11 VDS_FILE_SYSTEM_PROP_FLAG](#221211-vdsfilesystempropflag)
        - [2.2.1.2.12 VDS_FILE_SYSTEM_FORMAT_SUPPORT_FLAG](#221212-vdsfilesystemformatsupportflag)
        - [2.2.1.2.13 VDS_DISK_EXTENT_TYPE](#221213-vdsdiskextenttype)
        - [2.2.1.2.14 VDS_PARTITION_STYLE](#221214-vdspartitionstyle)
        - [2.2.1.2.15 VDS_PARTITION_FLAG](#221215-vdspartitionflag)
        - [2.2.1.2.16 VDS_VOLUME_TYPE](#221216-vdsvolumetype)
        - [2.2.1.2.17 VDS_TRANSITION_STATE](#221217-vdstransitionstate)
        - [2.2.1.2.18 VDS_FORMAT_OPTION_FLAGS](#221218-vdsformatoptionflags)
        - [2.2.1.2.19 VDS_DISK_FLAG](#221219-vdsdiskflag)
        - [2.2.1.2.20 VDS_DISK_STATUS](#221220-vdsdiskstatus)
        - [2.2.1.2.21 VDS_LUN_RESERVE_MODE](#221221-vdslunreservemode)
        - [2.2.1.2.22 VDS_VOLUME_STATUS](#221222-vdsvolumestatus)
        - [2.2.1.2.23 VDS_VOLUME_FLAG](#221223-vdsvolumeflag)
      - [2.2.1.3 Structures](#2213-structures)
        - [2.2.1.3.1 VDS_SERVICE_NOTIFICATION](#22131-vdsservicenotification)
        - [2.2.1.3.2 VDS_PACK_NOTIFICATION](#22132-vdspacknotification)
        - [2.2.1.3.3 VDS_DISK_NOTIFICATION](#22133-vdsdisknotification)
        - [2.2.1.3.4 VDS_VOLUME_NOTIFICATION](#22134-vdsvolumenotification)
        - [2.2.1.3.5 VDS_PARTITION_NOTIFICATION](#22135-vdspartitionnotification)
        - [2.2.1.3.6 VDS_DRIVE_LETTER_NOTIFICATION](#22136-vdsdriveletternotification)
        - [2.2.1.3.7 VDS_FILE_SYSTEM_NOTIFICATION](#22137-vdsfilesystemnotification)
        - [2.2.1.3.8 VDS_MOUNT_POINT_NOTIFICATION](#22138-vdsmountpointnotification)
        - [2.2.1.3.9 VDS_NOTIFICATION](#22139-vdsnotification)
        - [2.2.1.3.10 VDS_ASYNC_OUTPUT](#221310-vdsasyncoutput)
        - [2.2.1.3.11 VDS_PARTITION_INFO_MBR](#221311-vdspartitioninfombr)
        - [2.2.1.3.12 VDS_PARTITION_INFO_GPT](#221312-vdspartitioninfogpt)
        - [2.2.1.3.13 VDS_STORAGE_IDENTIFIER](#221313-vdsstorageidentifier)
        - [2.2.1.3.14 VDS_STORAGE_DEVICE_ID_DESCRIPTOR](#221314-vdsstoragedeviceiddescriptor)
        - [2.2.1.3.15 VDS_INTERCONNECT](#221315-vdsinterconnect)
        - [2.2.1.3.16 VDS_LUN_INFORMATION](#221316-vdsluninformation)
        - [2.2.1.3.17 VDS_FILE_SYSTEM_PROP](#221317-vdsfilesystemprop)
        - [2.2.1.3.18 VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP](#221318-vdsfilesystemformatsupportprop)
        - [2.2.1.3.19 VDS_DISK_EXTENT](#221319-vdsdiskextent)
        - [2.2.1.3.20 VDS_PARTITION_PROP](#221320-vdspartitionprop)
        - [2.2.1.3.21 VDS_INPUT_DISK](#221321-vdsinputdisk)
        - [2.2.1.3.22 CREATE_PARTITION_PARAMETERS](#221322-createpartitionparameters)
        - [2.2.1.3.23 VIRTUAL_STORAGE_TYPE](#221323-virtualstoragetype)
    - [2.2.2 Interface-Specific Data Types](#222-interface-specific-data-types)
      - [2.2.2.1 IVdsService Data Types](#2221-ivdsservice-data-types)
        - [2.2.2.1.1 Data Types](#22211-data-types)
          - [2.2.2.1.1.1 MAX_FS_NAME_SIZE](#222111-maxfsnamesize)
        - [2.2.2.1.2 Enumerations](#22212-enumerations)
          - [2.2.2.1.2.1 VDS_OBJECT_TYPE](#222121-vdsobjecttype)
          - [2.2.2.1.2.2 VDS_SERVICE_FLAG](#222122-vdsserviceflag)
          - [2.2.2.1.2.3 VDS_QUERY_PROVIDER_FLAG](#222123-vdsqueryproviderflag)
          - [2.2.2.1.2.4 VDS_DRIVE_LETTER_FLAG](#222124-vdsdriveletterflag)
        - [2.2.2.1.3 Structures](#22213-structures)
          - [2.2.2.1.3.1 VDS_SERVICE_PROP](#222131-vdsserviceprop)
          - [2.2.2.1.3.2 VDS_DRIVE_LETTER_PROP](#222132-vdsdriveletterprop)
          - [2.2.2.1.3.3 VDS_FILE_SYSTEM_TYPE_PROP](#222133-vdsfilesystemtypeprop)
      - [2.2.2.2 IVdsServiceSAN Data Types](#2222-ivdsservicesan-data-types)
        - [2.2.2.2.1 Enumerations](#22221-enumerations)
          - [2.2.2.2.1.1 VDS_SAN_POLICY](#222211-vdssanpolicy)
      - [2.2.2.3 IVdsServiceIscsi Data Types](#2223-ivdsserviceiscsi-data-types)
        - [2.2.2.3.1 Structures](#22231-structures)
          - [2.2.2.3.1.1 VDS_ISCSI_SHARED_SECRET](#222311-vdsiscsisharedsecret)
      - [2.2.2.4 IVdsHbaPort Data Types](#2224-ivdshbaport-data-types)
        - [2.2.2.4.1 Enumerations](#22241-enumerations)
          - [2.2.2.4.1.1 VDS_HBAPORT_TYPE](#222411-vdshbaporttype)
          - [2.2.2.4.1.2 VDS_HBAPORT_STATUS](#222412-vdshbaportstatus)
          - [2.2.2.4.1.3 VDS_HBAPORT_SPEED_FLAG](#222413-vdshbaportspeedflag)
          - [2.2.2.4.1.4 VDS_PATH_STATUS](#222414-vdspathstatus)
        - [2.2.2.4.2 Structures](#22242-structures)
          - [2.2.2.4.2.1 VDS_WWN](#222421-vdswwn)
          - [2.2.2.4.2.2 VDS_HBAPORT_PROP](#222422-vdshbaportprop)
      - [2.2.2.5 IVdsIscsiInitiatorAdapter Data Types](#2225-ivdsiscsiinitiatoradapter-data-types)
        - [2.2.2.5.1 Structures](#22251-structures)
          - [2.2.2.5.1.1 VDS_ISCSI_INITIATOR_ADAPTER_PROP](#222511-vdsiscsiinitiatoradapterprop)
      - [2.2.2.6 IVdsIscsiInitiatorPortal Data Types](#2226-ivdsiscsiinitiatorportal-data-types)
        - [2.2.2.6.1 Enumerations](#22261-enumerations)
          - [2.2.2.6.1.1 VDS_IPADDRESS_TYPE](#222611-vdsipaddresstype)
        - [2.2.2.6.2 Structures](#22262-structures)
          - [2.2.2.6.2.1 VDS_IPADDRESS](#222621-vdsipaddress)
          - [2.2.2.6.2.2 VDS_ISCSI_INITIATOR_PORTAL_PROP](#222622-vdsiscsiinitiatorportalprop)
      - [2.2.2.7 IVdsProvider Data Types](#2227-ivdsprovider-data-types)
        - [2.2.2.7.1 Enumerations](#22271-enumerations)
          - [2.2.2.7.1.1 VDS_PROVIDER_TYPE](#222711-vdsprovidertype)
          - [2.2.2.7.1.2 VDS_PROVIDER_FLAG](#222712-vdsproviderflag)
        - [2.2.2.7.2 Structures](#22272-structures)
          - [2.2.2.7.2.1 VDS_PROVIDER_PROP](#222721-vdsproviderprop)
      - [2.2.2.8 IVdsPack Data Types](#2228-ivdspack-data-types)
        - [2.2.2.8.1 Enumerations](#22281-enumerations)
          - [2.2.2.8.1.1 VDS_PACK_STATUS](#222811-vdspackstatus)
          - [2.2.2.8.1.2 VDS_PACK_FLAG](#222812-vdspackflag)
        - [2.2.2.8.2 Structures](#22282-structures)
          - [2.2.2.8.2.1 VDS_PACK_PROP](#222821-vdspackprop)
      - [2.2.2.9 IVdsDisk Data Types](#2229-ivdsdisk-data-types)
        - [2.2.2.9.1 Structures](#22291-structures)
          - [2.2.2.9.1.1 VDS_DISK_PROP](#222911-vdsdiskprop)
      - [2.2.2.10 IVdsDisk3 Data Types](#22210-ivdsdisk3-data-types)
        - [2.2.2.10.1 Enumerations](#222101-enumerations)
          - [2.2.2.10.1.1 VDS_DISK_OFFLINE_REASON](#2221011-vdsdiskofflinereason)
        - [2.2.2.10.2 Structures](#222102-structures)
          - [2.2.2.10.2.1 VDS_DISK_PROP2](#2221021-vdsdiskprop2)
          - [2.2.2.10.2.2 VDS_DISK_FREE_EXTENT](#2221022-vdsdiskfreeextent)
      - [2.2.2.11 IVdsAdvancedDisk Data Types](#22211-ivdsadvanceddisk-data-types)
        - [2.2.2.11.1 Structures](#222111-structures)
          - [2.2.2.11.1.1 CHANGE_ATTRIBUTES_PARAMETERS](#2221111-changeattributesparameters)
      - [2.2.2.12 IVdsAdvancedDisk2 Data Types](#22212-ivdsadvanceddisk2-data-types)
        - [2.2.2.12.1 Structures](#222121-structures)
          - [2.2.2.12.1.1 CHANGE_PARTITION_TYPE_PARAMETERS](#2221211-changepartitiontypeparameters)
      - [2.2.2.13 IVdsAdvancedDisk3 Data Types](#22213-ivdsadvanceddisk3-data-types)
        - [2.2.2.13.1 Structures](#222131-structures)
          - [2.2.2.13.1.1 VDS_ADVANCEDDISK_PROP](#2221311-vdsadvanceddiskprop)
      - [2.2.2.14 IVdsVolume Data Types](#22214-ivdsvolume-data-types)
        - [2.2.2.14.1 Structures](#222141-structures)
          - [2.2.2.14.1.1 VDS_VOLUME_PROP](#2221411-vdsvolumeprop)
      - [2.2.2.15 IVdsVolume2 Data Types](#22215-ivdsvolume2-data-types)
        - [2.2.2.15.1 Structures](#222151-structures)
          - [2.2.2.15.1.1 VDS_VOLUME_PROP2](#2221511-vdsvolumeprop2)
      - [2.2.2.16 IVdsVolumeMF Data Types](#22216-ivdsvolumemf-data-types)
        - [2.2.2.16.1 Data Types](#222161-data-types)
          - [2.2.2.16.1.1 MAX_PATH](#2221611-maxpath)
        - [2.2.2.16.2 Structures](#222162-structures)
          - [2.2.2.16.2.1 VDS_REPARSE_POINT_PROP](#2221621-vdsreparsepointprop)
      - [2.2.2.17 IVdsVolumePlex Data Types](#22217-ivdsvolumeplex-data-types)
        - [2.2.2.17.1 Enumeration](#222171-enumeration)
          - [2.2.2.17.1.1 VDS_VOLUME_PLEX_TYPE](#2221711-vdsvolumeplextype)
          - [2.2.2.17.1.2 VDS_VOLUME_PLEX_STATUS](#2221712-vdsvolumeplexstatus)
        - [2.2.2.17.2 Structures](#222172-structures)
          - [2.2.2.17.2.1 VDS_VOLUME_PLEX_PROP](#2221721-vdsvolumeplexprop)
      - [2.2.2.18 IVdsVdProvider Data Types](#22218-ivdsvdprovider-data-types)
        - [2.2.2.18.1 Enumerations](#222181-enumerations)
          - [2.2.2.18.1.1 CREATE_VIRTUAL_DISK_FLAG](#2221811-createvirtualdiskflag)
        - [2.2.2.18.2 Structures](#222182-structures)
          - [2.2.2.18.2.1 VDS_CREATE_VDISK_PARAMETERS](#2221821-vdscreatevdiskparameters)
      - [2.2.2.19 IVdsVDisk Data Types](#22219-ivdsvdisk-data-types)
        - [2.2.2.19.1 Enumerations](#222191-enumerations)
          - [2.2.2.19.1.1 VDS_VDISK_STATE](#2221911-vdsvdiskstate)
          - [2.2.2.19.1.2 OPEN_VIRTUAL_DISK_FLAG](#2221912-openvirtualdiskflag)
          - [2.2.2.19.1.3 DEPENDENT_DISK_FLAG](#2221913-dependentdiskflag)
          - [2.2.2.19.1.4 VIRTUAL_DISK_ACCESS_MASK](#2221914-virtualdiskaccessmask)
        - [2.2.2.19.2 Structures](#222192-structures)
          - [2.2.2.19.2.1 VDS_VDISK_PROPERTIES](#2221921-vdsvdiskproperties)
      - [2.2.2.20 IVdsOpenVDisk Data Types](#22220-ivdsopenvdisk-data-types)
        - [2.2.2.20.1 Enumerations](#222201-enumerations)
          - [2.2.2.20.1.1 ATTACH_VIRTUAL_DISK_FLAG](#2222011-attachvirtualdiskflag)
          - [2.2.2.20.1.2 DETACH_VIRTUAL_DISK_FLAG](#2222012-detachvirtualdiskflag)
          - [2.2.2.20.1.3 COMPACT_VIRTUAL_DISK_FLAG](#2222013-compactvirtualdiskflag)
          - [2.2.2.20.1.4 MERGE_VIRTUAL_DISK_FLAG](#2222014-mergevirtualdiskflag)
          - [2.2.2.20.1.5 EXPAND_VIRTUAL_DISK_FLAG](#2222015-expandvirtualdiskflag)
    - [2.2.3 Error Codes](#223-error-codes)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 Interfaces](#31-interfaces)
    - [3.1.1 Enumeration Object Interfaces](#311-enumeration-object-interfaces)
      - [3.1.1.1 IEnumVdsObject Interface](#3111-ienumvdsobject-interface)
    - [3.1.2 Callback Object Interfaces](#312-callback-object-interfaces)
      - [3.1.2.1 IVdsAdviseSink Interface](#3121-ivdsadvisesink-interface)
    - [3.1.3 Asynchronous Operation Object Interfaces](#313-asynchronous-operation-object-interfaces)
      - [3.1.3.1 IVdsAsync Interface](#3131-ivdsasync-interface)
    - [3.1.4 Service Loader Interfaces](#314-service-loader-interfaces)
      - [3.1.4.1 IVdsServiceLoader Interface](#3141-ivdsserviceloader-interface)
    - [3.1.5 Service Object Interfaces](#315-service-object-interfaces)
      - [3.1.5.1 IVdsService Interface](#3151-ivdsservice-interface)
      - [3.1.5.2 IVdsServiceInitialization Interface](#3152-ivdsserviceinitialization-interface)
      - [3.1.5.3 IVdsServiceUninstallDisk Interface](#3153-ivdsserviceuninstalldisk-interface)
      - [3.1.5.4 IVdsServiceHba Interface](#3154-ivdsservicehba-interface)
      - [3.1.5.5 IVdsServiceIscsi Interface](#3155-ivdsserviceiscsi-interface)
      - [3.1.5.6 IVdsServiceSAN Interface](#3156-ivdsservicesan-interface)
      - [3.1.5.7 IVdsServiceSw Interface](#3157-ivdsservicesw-interface)
    - [3.1.6 HBA Port Object Interfaces](#316-hba-port-object-interfaces)
      - [3.1.6.1 IVdsHbaPort Interface](#3161-ivdshbaport-interface)
    - [3.1.7 Initiator Adapter Object Interfaces](#317-initiator-adapter-object-interfaces)
      - [3.1.7.1 IVdsIscsiInitiatorAdapter Interface](#3171-ivdsiscsiinitiatoradapter-interface)
    - [3.1.8 Initiator Portal Object Interfaces](#318-initiator-portal-object-interfaces)
      - [3.1.8.1 IVdsIscsiInitiatorPortal Interface](#3181-ivdsiscsiinitiatorportal-interface)
    - [3.1.9 Provider Object Interfaces](#319-provider-object-interfaces)
      - [3.1.9.1 IVdsProvider Interface](#3191-ivdsprovider-interface)
      - [3.1.9.2 IVdsSwProvider Interface](#3192-ivdsswprovider-interface)
      - [3.1.9.3 IVdsHwProvider Interface](#3193-ivdshwprovider-interface)
      - [3.1.9.4 IVdsVdProvider Interface](#3194-ivdsvdprovider-interface)
    - [3.1.10 Subsystem Object Interfaces](#3110-subsystem-object-interfaces)
      - [3.1.10.1 IVdsSubSystemImportTarget Interface](#31101-ivdssubsystemimporttarget-interface)
    - [3.1.11 Pack Object Interfaces](#3111-pack-object-interfaces)
      - [3.1.11.1 IVdsPack Interface](#31111-ivdspack-interface)
      - [3.1.11.2 IVdsPack2 Interface](#31112-ivdspack2-interface)
    - [3.1.12 Disk Object Interfaces](#3112-disk-object-interfaces)
      - [3.1.12.1 IVdsDisk Interface](#31121-ivdsdisk-interface)
      - [3.1.12.2 IVdsDisk2 Interface](#31122-ivdsdisk2-interface)
      - [3.1.12.3 IVdsDisk3 Interface](#31123-ivdsdisk3-interface)
      - [3.1.12.4 IVdsAdvancedDisk Interface](#31124-ivdsadvanceddisk-interface)
      - [3.1.12.5 IVdsAdvancedDisk2 Interface](#31125-ivdsadvanceddisk2-interface)
      - [3.1.12.6 IVdsAdvancedDisk3 Interface](#31126-ivdsadvanceddisk3-interface)
      - [3.1.12.7 IVdsCreatePartitionEx Interface](#31127-ivdscreatepartitionex-interface)
      - [3.1.12.8 IVdsDiskOnline Interface](#31128-ivdsdiskonline-interface)
      - [3.1.12.9 IVdsDiskPartitionMF Interface](#31129-ivdsdiskpartitionmf-interface)
      - [3.1.12.10 IVdsDiskPartitionMF2 Interface](#311210-ivdsdiskpartitionmf2-interface)
      - [3.1.12.11 IVdsRemovable Interface](#311211-ivdsremovable-interface)
    - [3.1.13 Volume Object Interfaces](#3113-volume-object-interfaces)
      - [3.1.13.1 IVdsVolume Interface](#31131-ivdsvolume-interface)
      - [3.1.13.2 IVdsVolume2 Interface](#31132-ivdsvolume2-interface)
      - [3.1.13.3 IVdsVolumeMF Interface](#31133-ivdsvolumemf-interface)
      - [3.1.13.4 IVdsVolumeMF2 Interface](#31134-ivdsvolumemf2-interface)
      - [3.1.13.5 IVdsVolumeMF3 Interface](#31135-ivdsvolumemf3-interface)
      - [3.1.13.6 IVdsVolumeShrink Interface](#31136-ivdsvolumeshrink-interface)
      - [3.1.13.7 IVdsVolumeOnline Interface](#31137-ivdsvolumeonline-interface)
    - [3.1.14 Volume Plex Object Interfaces](#3114-volume-plex-object-interfaces)
      - [3.1.14.1 IVdsVolumePlex Interface](#31141-ivdsvolumeplex-interface)
    - [3.1.15 Virtual Disk Object Interfaces](#3115-virtual-disk-object-interfaces)
      - [3.1.15.1 IVdsVDisk Interface](#31151-ivdsvdisk-interface)
      - [3.1.15.2 IVdsOpenVDisk Interface](#31152-ivdsopenvdisk-interface)
  - [3.2 Common Details](#32-common-details)
    - [3.2.1 Abstract Data Model](#321-abstract-data-model)
      - [3.2.1.1 Method Invocation](#3211-method-invocation)
        - [3.2.1.1.1 Method Sequencing Requirements](#32111-method-sequencing-requirements)
        - [3.2.1.1.2 Storage Object Relationships](#32112-storage-object-relationships)
      - [3.2.1.2 Service and Providers](#3212-service-and-providers)
      - [3.2.1.3 Packs](#3213-packs)
      - [3.2.1.4 Disks](#3214-disks)
      - [3.2.1.5 Volumes](#3215-volumes)
      - [3.2.1.6 Virtual Disks](#3216-virtual-disks)
      - [3.2.1.7 File Systems, Drive Letters, and Access Paths](#3217-file-systems-drive-letters-and-access-paths)
  ...
  - [3.3 Client Details](#33-client-details)
    - [3.3.1 Abstract Data Model](#331-abstract-data-model)
      - [3.3.1.1 Notification Callback Objects](#3311-notification-callback-objects)
    - [3.3.2 Timers](#332-timers)
    - [3.3.3 Initialization](#333-initialization)
    - [3.3.4 Message Processing Events and Sequencing Rules](#334-message-processing-events-and-sequencing-rules)
      - [3.3.4.1 Processing Server Replies to Method Calls](#3341-processing-server-replies-to-method-calls)
      - [3.3.4.2 Processing Notifications Sent from the Server to the Client](#3342-processing-notifications-sent-from-the-server-to-the-client)
      - [3.3.4.3 IVdsAdviseSink Methods](#3343-ivdsadvisesink-methods)
        - [3.3.4.3.1 IVdsAdviseSink::OnNotify (Opnum 3)](#33431-ivdsadvisesinkonnotify-opnum-3)
    - [3.3.5 Timer Events](#335-timer-events)
    - [3.3.6 Other Local Events](#336-other-local-events)
  - [3.4 Server Details](#34-server-details)
    - [3.4.1 Abstract Data Model](#341-abstract-data-model)
      - [3.4.1.1 Service Object](#3411-service-object)
      - [3.4.1.2 Storage Management Objects](#3412-storage-management-objects)
      - [3.4.1.3 Enumeration of Objects](#3413-enumeration-of-objects)
      - [3.4.1.4 Notification Callback Objects](#3414-notification-callback-objects)
      - [3.4.1.5 Asynchronous Tasks](#3415-asynchronous-tasks)
    - [3.4.2 Timers](#342-timers)
    - [3.4.3 Initialization](#343-initialization)
      - [3.4.3.1 Storage Management Objects](#3431-storage-management-objects)
      - [3.4.3.2 Notification Callback Objects](#3432-notification-callback-objects)
    ...
    - [3.4.5 Message Processing Events and Sequencing Rules](#345-message-processing-events-and-sequencing-rules)
      - [3.4.5.1 Sequencing Rules](#3451-sequencing-rules)
        - [3.4.5.1.1 Adding Pack Objects for Dynamic Providers](#34511-adding-pack-objects-for-dynamic-providers)
        - [3.4.5.1.2 Removing Pack Objects for Dynamic Providers](#34512-removing-pack-objects-for-dynamic-providers)
        - [3.4.5.1.3 Adding Disk Objects](#34513-adding-disk-objects)
        - [3.4.5.1.4 Removing Disk Objects](#34514-removing-disk-objects)
        - [3.4.5.1.5 Adding Volume Objects](#34515-adding-volume-objects)
        - [3.4.5.1.6 Removing Volume Objects](#34516-removing-volume-objects)
        - [3.4.5.1.7 Adding Virtual Disk Objects](#34517-adding-virtual-disk-objects)
        - [3.4.5.1.8 Removing Virtual Disk Objects](#34518-removing-virtual-disk-objects)
        - [3.4.5.1.9 Handling Asynchronous Tasks](#34519-handling-asynchronous-tasks)
      - [3.4.5.2 Message Processing Details](#3452-message-processing-details)
        - [3.4.5.2.1 IEnumVdsObject Methods](#34521-ienumvdsobject-methods)
          - [3.4.5.2.1.1 IEnumVdsObject::Next (Opnum 3)](#345211-ienumvdsobjectnext-opnum-3)
          - [3.4.5.2.1.2 IEnumVdsObject::Skip (Opnum 4)](#345212-ienumvdsobjectskip-opnum-4)
          - [3.4.5.2.1.3 IEnumVdsObject::Reset (Opnum 5)](#345213-ienumvdsobjectreset-opnum-5)
          - [3.4.5.2.1.4 IEnumVdsObject::Clone (Opnum 6)](#345214-ienumvdsobjectclone-opnum-6)
        - [3.4.5.2.2 IVdsAsync Methods](#34522-ivdsasync-methods)
          - [3.4.5.2.2.1 IVdsAsync::Cancel (Opnum 3)](#345221-ivdsasynccancel-opnum-3)
          - [3.4.5.2.2.2 IVdsAsync::Wait (Opnum 4)](#345222-ivdsasyncwait-opnum-4)
          - [3.4.5.2.2.3 IVdsAsync::QueryStatus (Opnum 5)](#345223-ivdsasyncquerystatus-opnum-5)
        - [3.4.5.2.3 IVdsServiceLoader Methods](#34523-ivdsserviceloader-methods)
          - [3.4.5.2.3.1 IVdsServiceLoader::LoadService (Opnum 3)](#345231-ivdsserviceloaderloadservice-opnum-3)
        - [3.4.5.2.4 IVdsService Methods](#34524-ivdsservice-methods)
          - [3.4.5.2.4.1 IVdsService::IsServiceReady (Opnum 3)](#345241-ivdsserviceisserviceready-opnum-3)
          - [3.4.5.2.4.2 IVdsService::WaitForServiceReady (Opnum 4)](#345242-ivdsservicewaitforserviceready-opnum-4)
          - [3.4.5.2.4.3 IVdsService::GetProperties (Opnum 5)](#345243-ivdsservicegetproperties-opnum-5)
          - [3.4.5.2.4.4 IVdsService::QueryProviders (Opnum 6)](#345244-ivdsservicequeryproviders-opnum-6)
          - [3.4.5.2.4.5 IVdsService::QueryUnallocatedDisks (Opnum 8)](#345245-ivdsservicequeryunallocateddisks-opnum-8)
          - [3.4.5.2.4.6 IVdsService::GetObject (Opnum 9)](#345246-ivdsservicegetobject-opnum-9)
          - [3.4.5.2.4.7 IVdsService::QueryDriveLetters (Opnum 10)](#345247-ivdsservicequerydriveletters-opnum-10)
          - [3.4.5.2.4.8 IVdsService::QueryFileSystemTypes (Opnum 11)](#345248-ivdsservicequeryfilesystemtypes-opnum-11)
          - [3.4.5.2.4.9 IVdsService::Reenumerate (Opnum 12)](#345249-ivdsservicereenumerate-opnum-12)
          - [3.4.5.2.4.10 IVdsService::Refresh (Opnum 13)](#3452410-ivdsservicerefresh-opnum-13)
          - [3.4.5.2.4.11 IVdsService::CleanupObsoleteMountPoints (Opnum 14)](#3452411-ivdsservicecleanupobsoletemountpoints-opnum-14)
          - [3.4.5.2.4.12 IVdsService::Advise (Opnum 15)](#3452412-ivdsserviceadvise-opnum-15)
          - [3.4.5.2.4.13 IVdsService::Unadvise (Opnum 16)](#3452413-ivdsserviceunadvise-opnum-16)
          - [3.4.5.2.4.14 IVdsService::Reboot (Opnum 17)](#3452414-ivdsservicereboot-opnum-17)
          - [3.4.5.2.4.15 IVdsService::SetFlags (Opnum 18)](#3452415-ivdsservicesetflags-opnum-18)
          - [3.4.5.2.4.16 IVdsService::ClearFlags (Opnum 19)](#3452416-ivdsserviceclearflags-opnum-19)
        - [3.4.5.2.5 IVdsServiceInitialization Methods](#34525-ivdsserviceinitialization-methods)
          - [3.4.5.2.5.1 IVdsServiceInitialization::Initialize (Opnum 3)](#345251-ivdsserviceinitializationinitialize-opnum-3)
        - [3.4.5.2.6 IVdsServiceUninstallDisk Methods](#34526-ivdsserviceuninstalldisk-methods)
          - [3.4.5.2.6.1 IVdsServiceUninstallDisk::GetDiskIdFromLunInfo (Opnum 3)](#345261-ivdsserviceuninstalldiskgetdiskidfromluninfo-opnum-3)
          - [3.4.5.2.6.2 IVdsServiceUninstallDisk::UninstallDisks (Opnum 4)](#345262-ivdsserviceuninstalldiskuninstalldisks-opnum-4)
        - [3.4.5.2.7 IVdsServiceHba Methods](#34527-ivdsservicehba-methods)
          - [3.4.5.2.7.1 IVdsServiceHba::QueryHbaPorts (Opnum 3)](#345271-ivdsservicehbaqueryhbaports-opnum-3)
        - [3.4.5.2.8 IVdsServiceIscsi Methods](#34528-ivdsserviceiscsi-methods)
          - [3.4.5.2.8.1 IVdsServiceIscsi::GetInitiatorName (Opnum 3)](#345281-ivdsserviceiscsigetinitiatorname-opnum-3)
          - [3.4.5.2.8.2 IVdsServiceIscsi::QueryInitiatorAdapters (Opnum 4)](#345282-ivdsserviceiscsiqueryinitiatoradapters-opnum-4)
          - [3.4.5.2.8.3 IVdsServiceIscsi::SetInitiatorSharedSecret (Opnum 8)](#345283-ivdsserviceiscsisetinitiatorsharedsecret-opnum-8)
        - [3.4.5.2.9 IVdsServiceSAN Methods](#34529-ivdsservicesan-methods)
          - [3.4.5.2.9.1 IVdsServiceSAN::GetSANPolicy (Opnum 3)](#345291-ivdsservicesangetsanpolicy-opnum-3)
          - [3.4.5.2.9.2 IVdsServiceSAN::SetSANPolicy (Opnum 4)](#345292-ivdsservicesansetsanpolicy-opnum-4)
        - [3.4.5.2.10 IVdsServiceSw Methods](#345210-ivdsservicesw-methods)
          - [3.4.5.2.10.1 IVdsServiceSw::GetDiskObject (Opnum 3)](#3452101-ivdsserviceswgetdiskobject-opnum-3)
        - [3.4.5.2.11 IVdsHbaPort Methods](#345211-ivdshbaport-methods)
          - [3.4.5.2.11.1 IVdsHbaPort::GetProperties (Opnum 3)](#3452111-ivdshbaportgetproperties-opnum-3)
          - [3.4.5.2.11.2 IVdsHbaPort::SetAllPathStatuses (Opnum 4)](#3452112-ivdshbaportsetallpathstatuses-opnum-4)
        - [3.4.5.2.12 IVdsIscsiInitiatorAdapter Methods](#345212-ivdsiscsiinitiatoradapter-methods)
          - [3.4.5.2.12.1 IVdsIscsiInitiatorAdapter::GetProperties (Opnum 3)](#3452121-ivdsiscsiinitiatoradaptergetproperties-opnum-3)
          - [3.4.5.2.12.2 IVdsIscsiInitiatorAdapter::QueryInitiatorPortals (Opnum 4)](#3452122-ivdsiscsiinitiatoradapterqueryinitiatorportals-opnum-4)
        - [3.4.5.2.13 IVdsIscsiInitiatorPortal Methods](#345213-ivdsiscsiinitiatorportal-methods)
          - [3.4.5.2.13.1 IVdsIscsiInitiatorPortal::GetProperties (Opnum 3)](#3452131-ivdsiscsiinitiatorportalgetproperties-opnum-3)
          - [3.4.5.2.13.2 IVdsIscsiInitiatorPortal::GetInitiatorAdapter (Opnum 4)](#3452132-ivdsiscsiinitiatorportalgetinitiatoradapter-opnum-4)
        - [3.4.5.2.14 IVdsProvider Methods](#345214-ivdsprovider-methods)
          - [3.4.5.2.14.1 IVdsProvider::GetProperties (Opnum 3)](#3452141-ivdsprovidergetproperties-opnum-3)
        - [3.4.5.2.15 IVdsSwProvider Methods](#345215-ivdsswprovider-methods)
          - [3.4.5.2.15.1 IVdsSwProvider::QueryPacks (Opnum 3)](#3452151-ivdsswproviderquerypacks-opnum-3)
          - [3.4.5.2.15.2 IVdsSwProvider::CreatePack (Opnum 4)](#3452152-ivdsswprovidercreatepack-opnum-4)
        - [3.4.5.2.16 IVdsHwProvider Methods](#345216-ivdshwprovider-methods)
          - [3.4.5.2.16.1 IVdsHwProvider::QuerySubSystems (Opnum 3)](#3452161-ivdshwproviderquerysubsystems-opnum-3)
        - [3.4.5.2.17 IVdsVdProvider Methods](#345217-ivdsvdprovider-methods)
          - [3.4.5.2.17.1 IVdsVdProvider::QueryVDisks (Opnum 3)](#3452171-ivdsvdproviderqueryvdisks-opnum-3)
          - [3.4.5.2.17.2 IVdsVdProvider::CreateVDisk (Opnum 4)](#3452172-ivdsvdprovidercreatevdisk-opnum-4)
          - [3.4.5.2.17.3 IVdsVdProvider::AddVDisk (Opnum 5)](#3452173-ivdsvdprovideraddvdisk-opnum-5)
          - [3.4.5.2.17.4 IVdsVdProvider::GetDiskFromVDisk (Opnum 6)](#3452174-ivdsvdprovidergetdiskfromvdisk-opnum-6)
          - [3.4.5.2.17.5 IVdsVdProvider::GetVDiskFromDisk (Opnum 7)](#3452175-ivdsvdprovidergetvdiskfromdisk-opnum-7)
        - [3.4.5.2.18 IVdsSubSystemImportTarget Methods](#345218-ivdssubsystemimporttarget-methods)
          - [3.4.5.2.18.1 IVdsSubSystemImportTarget::GetImportTarget (Opnum 3)](#3452181-ivdssubsystemimporttargetgetimporttarget-opnum-3)
          - [3.4.5.2.18.2 IVdsSubSystemImportTarget::SetImportTarget (Opnum 4)](#3452182-ivdssubsystemimporttargetsetimporttarget-opnum-4)
        - [3.4.5.2.19 IVdsPack Methods](#345219-ivdspack-methods)
          - [3.4.5.2.19.1 IVdsPack::GetProperties (Opnum 3)](#3452191-ivdspackgetproperties-opnum-3)
          - [3.4.5.2.19.2 IVdsPack::GetProvider (Opnum 4)](#3452192-ivdspackgetprovider-opnum-4)
          - [3.4.5.2.19.3 IVdsPack::QueryVolumes (Opnum 5)](#3452193-ivdspackqueryvolumes-opnum-5)
          - [3.4.5.2.19.4 IVdsPack::QueryDisks (Opnum 6)](#3452194-ivdspackquerydisks-opnum-6)
          - [3.4.5.2.19.5 IVdsPack::CreateVolume (Opnum 7)](#3452195-ivdspackcreatevolume-opnum-7)
          - [3.4.5.2.19.6 IVdsPack::AddDisk (Opnum 8)](#3452196-ivdspackadddisk-opnum-8)
          - [3.4.5.2.19.7 IVdsPack::MigrateDisks (Opnum 9)](#3452197-ivdspackmigratedisks-opnum-9)
          - [3.4.5.2.19.8 IVdsPack::RemoveMissingDisk (Opnum 11)](#3452198-ivdspackremovemissingdisk-opnum-11)
          - [3.4.5.2.19.9 IVdsPack::Recover (Opnum 12)](#3452199-ivdspackrecover-opnum-12)
        - [3.4.5.2.20 IVdsPack2 Methods](#345220-ivdspack2-methods)
          - [3.4.5.2.20.1 IVdsPack2::CreateVolume2 (Opnum 3)](#3452201-ivdspack2createvolume2-opnum-3)
        - [3.4.5.2.21 IVdsDisk Methods](#345221-ivdsdisk-methods)
          - [3.4.5.2.21.1 IVdsDisk::GetProperties (Opnum 3)](#3452211-ivdsdiskgetproperties-opnum-3)
          - [3.4.5.2.21.2 IVdsDisk::GetPack (Opnum 4)](#3452212-ivdsdiskgetpack-opnum-4)
          - [3.4.5.2.21.3 IVdsDisk::GetIdentificationData (Opnum 5)](#3452213-ivdsdiskgetidentificationdata-opnum-5)
          - [3.4.5.2.21.4 IVdsDisk::QueryExtents (Opnum 6)](#3452214-ivdsdiskqueryextents-opnum-6)
          - [3.4.5.2.21.5 IVdsDisk::ConvertStyle (Opnum 7)](#3452215-ivdsdiskconvertstyle-opnum-7)
          - [3.4.5.2.21.6 IVdsDisk::SetFlags (Opnum 8)](#3452216-ivdsdisksetflags-opnum-8)
          - [3.4.5.2.21.7 IVdsDisk::ClearFlags (Opnum 9)](#3452217-ivdsdiskclearflags-opnum-9)
        - [3.4.5.2.22 IVdsDisk2 Methods](#345222-ivdsdisk2-methods)
          - [3.4.5.2.22.1 IVdsDisk2::SetSANMode (Opnum 3)](#3452221-ivdsdisk2setsanmode-opnum-3)
        - [3.4.5.2.23 IVdsDisk3 Methods](#345223-ivdsdisk3-methods)
          - [3.4.5.2.23.1 IVdsDisk3::GetProperties2 (Opnum 3)](#3452231-ivdsdisk3getproperties2-opnum-3)
          - [3.4.5.2.23.2 IVdsDisk3::QueryFreeExtents (Opnum 6)](#3452232-ivdsdisk3queryfreeextents-opnum-6)
        - [3.4.5.2.24 IVdsAdvancedDisk Methods](#345224-ivdsadvanceddisk-methods)
          - [3.4.5.2.24.1 IVdsAdvancedDisk::GetPartitionProperties (Opnum 3)](#3452241-ivdsadvanceddiskgetpartitionproperties-opnum-3)
          - [3.4.5.2.24.2 IVdsAdvancedDisk::QueryPartitions (Opnum 4)](#3452242-ivdsadvanceddiskquerypartitions-opnum-4)
          - [3.4.5.2.24.3 IVdsAdvancedDisk::CreatePartition (Opnum 5)](#3452243-ivdsadvanceddiskcreatepartition-opnum-5)
          - [3.4.5.2.24.4 IVdsAdvancedDisk::DeletePartition (Opnum 6)](#3452244-ivdsadvanceddiskdeletepartition-opnum-6)
          - [3.4.5.2.24.5 IVdsAdvancedDisk::ChangeAttributes (Opnum 7)](#3452245-ivdsadvanceddiskchangeattributes-opnum-7)
          - [3.4.5.2.24.6 IVdsAdvancedDisk::AssignDriveLetter (Opnum 8)](#3452246-ivdsadvanceddiskassigndriveletter-opnum-8)
          - [3.4.5.2.24.7 IVdsAdvancedDisk::DeleteDriveLetter (Opnum 9)](#3452247-ivdsadvanceddiskdeletedriveletter-opnum-9)
          - [3.4.5.2.24.8 IVdsAdvancedDisk::GetDriveLetter (Opnum 10)](#3452248-ivdsadvanceddiskgetdriveletter-opnum-10)
          - [3.4.5.2.24.9 IVdsAdvancedDisk::FormatPartition (Opnum 11)](#3452249-ivdsadvanceddiskformatpartition-opnum-11)
          - [3.4.5.2.24.10 IVdsAdvancedDisk::Clean (Opnum 12)](#34522410-ivdsadvanceddiskclean-opnum-12)
        - [3.4.5.2.25 IVdsAdvancedDisk2 Methods](#345225-ivdsadvanceddisk2-methods)
          - [3.4.5.2.25.1 IVdsAdvancedDisk2::ChangePartitionType (Opnum 3)](#3452251-ivdsadvanceddisk2changepartitiontype-opnum-3)
        - [3.4.5.2.26 IVdsAdvancedDisk3 Methods](#345226-ivdsadvanceddisk3-methods)
          - [3.4.5.2.26.1 IVdsAdvancedDisk3::GetProperties (Opnum 3)](#3452261-ivdsadvanceddisk3getproperties-opnum-3)
          - [3.4.5.2.26.2 IVdsAdvancedDisk3::GetUniqueId (Opnum 4)](#3452262-ivdsadvanceddisk3getuniqueid-opnum-4)
        - [3.4.5.2.27 IVdsCreatePartitionEx Methods](#345227-ivdscreatepartitionex-methods)
          - [3.4.5.2.27.1 IVdsCreatePartitionEx::CreatePartitionEx (Opnum 3)](#3452271-ivdscreatepartitionexcreatepartitionex-opnum-3)
        - [3.4.5.2.28 IVdsDiskOnline Methods](#345228-ivdsdiskonline-methods)
          - [3.4.5.2.28.1 IVdsDiskOnline::Online (Opnum 3)](#3452281-ivdsdiskonlineonline-opnum-3)
          - [3.4.5.2.28.2 IVdsDiskOnline::Offline (Opnum 4)](#3452282-ivdsdiskonlineoffline-opnum-4)
        - [3.4.5.2.29 IVdsDiskPartitionMF Methods](#345229-ivdsdiskpartitionmf-methods)
          - [3.4.5.2.29.1 IVdsDiskPartitionMF::GetPartitionFileSystemProperties (Opnum 3)](#3452291-ivdsdiskpartitionmfgetpartitionfilesystemproperties-opnum-3)
          - [3.4.5.2.29.2 IVdsDiskPartitionMF::GetPartitionFileSystemTypeName (Opnum 4)](#3452292-ivdsdiskpartitionmfgetpartitionfilesystemtypename-opnum-4)
          - [3.4.5.2.29.3 IVdsDiskPartitionMF::QueryPartitionFileSystemFormatSupport (Opnum](#3452293-ivdsdiskpartitionmfquerypartitionfilesystemformatsupport-opnum)
          - [3.4.5.2.29.4 IVdsDiskPartitionMF::FormatPartitionEx (Opnum 6)](#3452294-ivdsdiskpartitionmfformatpartitionex-opnum-6)
        - [3.4.5.2.30 IVdsDiskPartitionMF2 Methods](#345230-ivdsdiskpartitionmf2-methods)
          - [3.4.5.2.30.1 IVdsDiskPartitionMF2::FormatPartitionEx2 (Opnum 3)](#3452301-ivdsdiskpartitionmf2formatpartitionex2-opnum-3)
        - [3.4.5.2.31 IVdsRemovable Methods](#345231-ivdsremovable-methods)
          - [3.4.5.2.31.1 IVdsRemovable::QueryMedia (Opnum 3)](#3452311-ivdsremovablequerymedia-opnum-3)
          - [3.4.5.2.31.2 IVdsRemovable::Eject (Opnum 4)](#3452312-ivdsremovableeject-opnum-4)
        - [3.4.5.2.32 IVdsVolume Methods](#345232-ivdsvolume-methods)
          - [3.4.5.2.32.1 IVdsVolume::GetProperties (Opnum 3)](#3452321-ivdsvolumegetproperties-opnum-3)
          - [3.4.5.2.32.2 IVdsVolume::GetPack (Opnum 4)](#3452322-ivdsvolumegetpack-opnum-4)
          - [3.4.5.2.32.3 IVdsVolume::QueryPlexes (Opnum 5)](#3452323-ivdsvolumequeryplexes-opnum-5)
          - [3.4.5.2.32.4 IVdsVolume::Extend (Opnum 6)](#3452324-ivdsvolumeextend-opnum-6)
          - [3.4.5.2.32.5 IVdsVolume::Shrink (Opnum 7)](#3452325-ivdsvolumeshrink-opnum-7)
          - [3.4.5.2.32.6 IVdsVolume::AddPlex (Opnum 8)](#3452326-ivdsvolumeaddplex-opnum-8)
          - [3.4.5.2.32.7 IVdsVolume::BreakPlex (Opnum 9)](#3452327-ivdsvolumebreakplex-opnum-9)
          - [3.4.5.2.32.8 IVdsVolume::RemovePlex (Opnum 10)](#3452328-ivdsvolumeremoveplex-opnum-10)
          - [3.4.5.2.32.9 IVdsVolume::Delete (Opnum 11)](#3452329-ivdsvolumedelete-opnum-11)
          - [3.4.5.2.32.10 IVdsVolume::SetFlags (Opnum 12)](#34523210-ivdsvolumesetflags-opnum-12)
          - [3.4.5.2.32.11 IVdsVolume::ClearFlags (Opnum 13)](#34523211-ivdsvolumeclearflags-opnum-13)
        - [3.4.5.2.33 IVdsVolume2 Methods](#345233-ivdsvolume2-methods)
          - [3.4.5.2.33.1 IVdsVolume2::GetProperties2 (Opnum 3)](#3452331-ivdsvolume2getproperties2-opnum-3)
        - [3.4.5.2.34 IVdsVolumeMF Methods](#345234-ivdsvolumemf-methods)
          - [3.4.5.2.34.1 IVdsVolumeMF::GetFileSystemProperties (Opnum 3)](#3452341-ivdsvolumemfgetfilesystemproperties-opnum-3)
          - [3.4.5.2.34.2 IVdsVolumeMF::Format (Opnum 4)](#3452342-ivdsvolumemfformat-opnum-4)
          - [3.4.5.2.34.3 IVdsVolumeMF::AddAccessPath (Opnum 5)](#3452343-ivdsvolumemfaddaccesspath-opnum-5)
          - [3.4.5.2.34.4 IVdsVolumeMF::QueryAccessPaths (Opnum 6)](#3452344-ivdsvolumemfqueryaccesspaths-opnum-6)
          - [3.4.5.2.34.5 IVdsVolumeMF::QueryReparsePoints (Opnum 7)](#3452345-ivdsvolumemfqueryreparsepoints-opnum-7)
          - [3.4.5.2.34.6 IVdsVolumeMF::DeleteAccessPath (Opnum 8)](#3452346-ivdsvolumemfdeleteaccesspath-opnum-8)
          - [3.4.5.2.34.7 IVdsVolumeMF::Mount (Opnum 9)](#3452347-ivdsvolumemfmount-opnum-9)
          - [3.4.5.2.34.8 IVdsVolumeMF::Dismount (Opnum 10)](#3452348-ivdsvolumemfdismount-opnum-10)
          - [3.4.5.2.34.9 IVdsVolumeMF::SetFileSystemFlags (Opnum 11)](#3452349-ivdsvolumemfsetfilesystemflags-opnum-11)
          - [3.4.5.2.34.10 IVdsVolumeMF::ClearFileSystemFlags (Opnum 12)](#34523410-ivdsvolumemfclearfilesystemflags-opnum-12)
        - [3.4.5.2.35 IVdsVolumeMF2 Methods](#345235-ivdsvolumemf2-methods)
          - [3.4.5.2.35.1 IVdsVolumeMF2::GetFileSystemTypeName (Opnum 3)](#3452351-ivdsvolumemf2getfilesystemtypename-opnum-3)
          - [3.4.5.2.35.2 IVdsVolumeMF2::QueryFileSystemFormatSupport (Opnum 4)](#3452352-ivdsvolumemf2queryfilesystemformatsupport-opnum-4)
          - [3.4.5.2.35.3 IVdsVolumeMF2::FormatEx (Opnum 5)](#3452353-ivdsvolumemf2formatex-opnum-5)
        - [3.4.5.2.36 IVdsVolumeMF3 Methods](#345236-ivdsvolumemf3-methods)
          - [3.4.5.2.36.1 IVdsVolumeMF3::QueryVolumeGuidPathnames (Opnum 3)](#3452361-ivdsvolumemf3queryvolumeguidpathnames-opnum-3)
          - [3.4.5.2.36.2 IVdsVolumeMF3::FormatEx2 (Opnum 4)](#3452362-ivdsvolumemf3formatex2-opnum-4)
          - [3.4.5.2.36.3 IVdsVolumeMF3::OfflineVolume (Opnum 5)](#3452363-ivdsvolumemf3offlinevolume-opnum-5)
        - [3.4.5.2.37 IVdsVolumeShrink Methods](#345237-ivdsvolumeshrink-methods)
          - [3.4.5.2.37.1 IVdsVolumeShrink::QueryMaxReclaimableBytes (Opnum 3)](#3452371-ivdsvolumeshrinkquerymaxreclaimablebytes-opnum-3)
          - [3.4.5.2.37.2 IVdsVolumeShrink::Shrink (Opnum 4)](#3452372-ivdsvolumeshrinkshrink-opnum-4)
        - [3.4.5.2.38 IVdsVolumeOnline Methods](#345238-ivdsvolumeonline-methods)
          - [3.4.5.2.38.1 IVdsVolumeOnline::Online (Opnum 3)](#3452381-ivdsvolumeonlineonline-opnum-3)
        - [3.4.5.2.39 IVdsVolumePlex Methods](#345239-ivdsvolumeplex-methods)
          - [3.4.5.2.39.1 IVdsVolumePlex::GetProperties (Opnum 3)](#3452391-ivdsvolumeplexgetproperties-opnum-3)
          - [3.4.5.2.39.2 IVdsVolumePlex::GetVolume (Opnum 4)](#3452392-ivdsvolumeplexgetvolume-opnum-4)
          - [3.4.5.2.39.3 IVdsVolumePlex::QueryExtents (Opnum 5)](#3452393-ivdsvolumeplexqueryextents-opnum-5)
          - [3.4.5.2.39.4 IVdsVolumePlex::Repair (Opnum 6)](#3452394-ivdsvolumeplexrepair-opnum-6)
        - [3.4.5.2.40 IVdsVDisk Methods](#345240-ivdsvdisk-methods)
          - [3.4.5.2.40.1 IVdsVDisk::Open (Opnum 3)](#3452401-ivdsvdiskopen-opnum-3)
          - [3.4.5.2.40.2 IVdsVDisk::GetProperties (Opnum 4)](#3452402-ivdsvdiskgetproperties-opnum-4)
          - [3.4.5.2.40.3 IVdsVDisk::GetHostVolume (Opnum 5)](#3452403-ivdsvdiskgethostvolume-opnum-5)
          - [3.4.5.2.40.4 IVdsVDisk::GetDeviceName (Opnum 6)](#3452404-ivdsvdiskgetdevicename-opnum-6)
        - [3.4.5.2.41 IVdsOpenVDisk Methods](#345241-ivdsopenvdisk-methods)
          - [3.4.5.2.41.1 IVdsOpenVDisk::Attach (Opnum 3)](#3452411-ivdsopenvdiskattach-opnum-3)
          - [3.4.5.2.41.2 IVdsOpenVDisk::Detach (Opnum 4)](#3452412-ivdsopenvdiskdetach-opnum-4)
          - [3.4.5.2.41.3 IVdsOpenVDisk::DetachAndDelete (Opnum 5)](#3452413-ivdsopenvdiskdetachanddelete-opnum-5)
          - [3.4.5.2.41.4 IVdsOpenVDisk::Compact (Opnum 6)](#3452414-ivdsopenvdiskcompact-opnum-6)
          - [3.4.5.2.41.5 IVdsOpenVDisk::Merge (Opnum 7)](#3452415-ivdsopenvdiskmerge-opnum-7)
          - [3.4.5.2.41.6 IVdsOpenVDisk::Expand (Opnum 8)](#3452416-ivdsopenvdiskexpand-opnum-8)
    - [3.4.6 Timer Events](#346-timer-events)
    - [3.4.7 Other Local Events](#347-other-local-events)
      - [3.4.7.1 Disk Pack Arrival (Dynamic Disks)](#3471-disk-pack-arrival-dynamic-disks)
      - [3.4.7.2 Disk Pack Removal (Dynamic Disks)](#3472-disk-pack-removal-dynamic-disks)
      - [3.4.7.3 Pack Modification](#3473-pack-modification)
      - [3.4.7.4 Disk Arrival](#3474-disk-arrival)
      - [3.4.7.5 Disk Removal](#3475-disk-removal)
      - [3.4.7.6 Disk Modification](#3476-disk-modification)
      - [3.4.7.7 Volume Arrival](#3477-volume-arrival)
      - [3.4.7.8 Volume Removal](#3478-volume-removal)
      - [3.4.7.9 Volume Modification](#3479-volume-modification)
      - [3.4.7.10 File System Modification](#34710-file-system-modification)
      - [3.4.7.11 Mount Point Change](#34711-mount-point-change)
      - [3.4.7.12 Drive Letter Assignment](#34712-drive-letter-assignment)
      - [3.4.7.13 Drive Letter Removal](#34713-drive-letter-removal)
      - [3.4.7.14 Media Arrival](#34714-media-arrival)
      - [3.4.7.15 Media Removal](#34715-media-removal)
- [4 Protocol Examples](#4-protocol-examples)
  - [4.1 VDS Sessions](#41-vds-sessions)
    - [4.1.1 Starting Sessions](#411-starting-sessions)
    - [4.1.2 Ending Sessions](#412-ending-sessions)
  - [4.2 VDS Client Notifications](#42-vds-client-notifications)
    - [4.2.1 Registering for Notifications](#421-registering-for-notifications)
    - [4.2.2 Receiving Notifications](#422-receiving-notifications)
    - [4.2.3 Unregistering for Notifications](#423-unregistering-for-notifications)
  - [4.3 Querying Enumerations of VDS Objects](#43-querying-enumerations-of-vds-objects)
  - [4.4 Retrieving the Properties and IDs of VDS Objects](#44-retrieving-the-properties-and-ids-of-vds-objects)
  - [4.5 Performing Asynchronous Tasks](#45-performing-asynchronous-tasks)
  - [4.6 Sample IVdsAdviseSink::OnNotify Implementation](#46-sample-ivdsadvisesinkonnotify-implementation)
