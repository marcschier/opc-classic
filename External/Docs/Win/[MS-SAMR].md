...
- [1 Introduction](#1-introduction)
  ...
  - [1.3 Overview](#13-overview)
    - [1.3.1 Object-Based Perspective](#131-object-based-perspective)
    - [1.3.2 Method-Based Perspective](#132-method-based-perspective)
  - [1.4 Relationship to Other Protocols](#14-relationship-to-other-protocols)
  - [1.5 Prerequisites/Preconditions](#15-prerequisitespreconditions)
  - [1.6 Applicability Statement](#16-applicability-statement)
  - [1.7 Versioning and Capability Negotiation](#17-versioning-and-capability-negotiation)
    - [1.7.1 Method Introduction](#171-method-introduction)
    - [1.7.2 Method Versioning](#172-method-versioning)
    - [1.7.3 Introduction to Information Levels](#173-introduction-to-information-levels)
...
- [2 Messages](#2-messages)
  ...
  - [2.2 Common Data Types](#22-common-data-types)
    - [2.2.1 Constant Value Definitions](#221-constant-value-definitions)
      - [2.2.1.1 Common ACCESS_MASK Values](#2211-common-accessmask-values)
      - [2.2.1.2 Generic ACCESS_MASK Values](#2212-generic-accessmask-values)
      - [2.2.1.3 Server ACCESS_MASK Values](#2213-server-accessmask-values)
      - [2.2.1.4 Domain ACCESS_MASK Values](#2214-domain-accessmask-values)
      - [2.2.1.5 Group ACCESS_MASK Values](#2215-group-accessmask-values)
      - [2.2.1.6 Alias ACCESS_MASK Values](#2216-alias-accessmask-values)
      - [2.2.1.7 User ACCESS_MASK Values](#2217-user-accessmask-values)
      - [2.2.1.8 USER_ALL Values](#2218-userall-values)
      - [2.2.1.9 ACCOUNT_TYPE Values](#2219-accounttype-values)
      - [2.2.1.10 SE_GROUP Attributes](#22110-segroup-attributes)
      - [2.2.1.11 GROUP_TYPE Codes](#22111-grouptype-codes)
      - [2.2.1.12 USER_ACCOUNT Codes](#22112-useraccount-codes)
      - [2.2.1.13 UF_FLAG Codes](#22113-ufflag-codes)
      - [2.2.1.14 Predefined RIDs](#22114-predefined-rids)
      - [2.2.1.15 STATUS_ Codes](#22115-status-codes)
      - [2.2.1.16 Transport Error Code](#22116-transport-error-code)
      - [2.2.1.17 AD ACCESS_MASK](#22117-ad-accessmask)
      - [2.2.1.18 AEAD-AES-256-CBC-HMAC-SHA512 Constants](#22118-aead-aes-256-cbc-hmac-sha512-constants)
    - [2.2.2 Basic Data Types](#222-basic-data-types)
      - [2.2.2.1 RPC_STRING, PRPC_STRING](#2221-rpcstring-prpcstring)
      - [2.2.2.2 OLD_LARGE_INTEGER](#2222-oldlargeinteger)
      - [2.2.2.3 SID_NAME_USE](#2223-sidnameuse)
      - [2.2.2.4 RPC_SHORT_BLOB](#2224-rpcshortblob)
    - [2.2.3 Domain Query/Set Data Types](#223-domain-queryset-data-types)
      - [2.2.3.1 Domain Fields](#2231-domain-fields)
      - [2.2.3.2 DOMAIN_SERVER_ENABLE_STATE](#2232-domainserverenablestate)
      - [2.2.3.3 DOMAIN_STATE_INFORMATION](#2233-domainstateinformation)
      - [2.2.3.4 DOMAIN_SERVER_ROLE](#2234-domainserverrole)
      - [2.2.3.5 DOMAIN_PASSWORD_INFORMATION](#2235-domainpasswordinformation)
      - [2.2.3.6 DOMAIN_LOGOFF_INFORMATION](#2236-domainlogoffinformation)
      - [2.2.3.7 DOMAIN_SERVER_ROLE_INFORMATION](#2237-domainserverroleinformation)
      - [2.2.3.8 DOMAIN_MODIFIED_INFORMATION](#2238-domainmodifiedinformation)
      - [2.2.3.9 DOMAIN_MODIFIED_INFORMATION2](#2239-domainmodifiedinformation2)
      - [2.2.3.10 SAMPR_DOMAIN_GENERAL_INFORMATION](#22310-samprdomaingeneralinformation)
      - [2.2.3.11 SAMPR_DOMAIN_GENERAL_INFORMATION2](#22311-samprdomaingeneralinformation2)
      - [2.2.3.12 SAMPR_DOMAIN_OEM_INFORMATION](#22312-samprdomainoeminformation)
      - [2.2.3.13 SAMPR_DOMAIN_NAME_INFORMATION](#22313-samprdomainnameinformation)
      - [2.2.3.14 SAMPR_DOMAIN_REPLICATION_INFORMATION](#22314-samprdomainreplicationinformation)
      - [2.2.3.15 SAMPR_DOMAIN_LOCKOUT_INFORMATION](#22315-samprdomainlockoutinformation)
      - [2.2.3.16 DOMAIN_INFORMATION_CLASS](#22316-domaininformationclass)
      - [2.2.3.17 SAMPR_DOMAIN_INFO_BUFFER](#22317-samprdomaininfobuffer)
    - [2.2.4 Group Query/Set Data Types](#224-group-queryset-data-types)
      - [2.2.4.1 Common Group Fields](#2241-common-group-fields)
      - [2.2.4.2 GROUP_ATTRIBUTE_INFORMATION](#2242-groupattributeinformation)
      - [2.2.4.3 SAMPR_GROUP_GENERAL_INFORMATION](#2243-samprgroupgeneralinformation)
      - [2.2.4.4 SAMPR_GROUP_NAME_INFORMATION](#2244-samprgroupnameinformation)
      - [2.2.4.5 SAMPR_GROUP_ADM_COMMENT_INFORMATION](#2245-samprgroupadmcommentinformation)
      - [2.2.4.6 GROUP_INFORMATION_CLASS](#2246-groupinformationclass)
      - [2.2.4.7 SAMPR_GROUP_INFO_BUFFER](#2247-samprgroupinfobuffer)
    - [2.2.5 Alias Query/Set Data Types](#225-alias-queryset-data-types)
      - [2.2.5.1 Common Alias Fields](#2251-common-alias-fields)
      - [2.2.5.2 SAMPR_ALIAS_GENERAL_INFORMATION](#2252-sampraliasgeneralinformation)
      - [2.2.5.3 SAMPR_ALIAS_NAME_INFORMATION](#2253-sampraliasnameinformation)
      - [2.2.5.4 SAMPR_ALIAS_ADM_COMMENT_INFORMATION](#2254-sampraliasadmcommentinformation)
      - [2.2.5.5 ALIAS_INFORMATION_CLASS](#2255-aliasinformationclass)
      - [2.2.5.6 SAMPR_ALIAS_INFO_BUFFER](#2256-sampraliasinfobuffer)
    - [2.2.6 User Query/Set Data Types](#226-user-queryset-data-types)
      - [2.2.6.1 Common User Fields](#2261-common-user-fields)
      - [2.2.6.2 USER_PRIMARY_GROUP_INFORMATION](#2262-userprimarygroupinformation)
      - [2.2.6.3 USER_CONTROL_INFORMATION](#2263-usercontrolinformation)
      - [2.2.6.4 USER_EXPIRES_INFORMATION](#2264-userexpiresinformation)
      - [2.2.6.5 SAMPR_LOGON_HOURS](#2265-samprlogonhours)
      - [2.2.6.6 SAMPR_USER_ALL_INFORMATION](#2266-sampruserallinformation)
      - [2.2.6.7 SAMPR_USER_GENERAL_INFORMATION](#2267-samprusergeneralinformation)
      - [2.2.6.8 SAMPR_USER_PREFERENCES_INFORMATION](#2268-sampruserpreferencesinformation)
      - [2.2.6.9 SAMPR_USER_PARAMETERS_INFORMATION](#2269-sampruserparametersinformation)
      - [2.2.6.10 SAMPR_USER_LOGON_INFORMATION](#22610-sampruserlogoninformation)
      - [2.2.6.11 SAMPR_USER_ACCOUNT_INFORMATION](#22611-sampruseraccountinformation)
      - [2.2.6.12 SAMPR_USER_A_NAME_INFORMATION](#22612-sampruseranameinformation)
      - [2.2.6.13 SAMPR_USER_F_NAME_INFORMATION](#22613-sampruserfnameinformation)
      - [2.2.6.14 SAMPR_USER_NAME_INFORMATION](#22614-samprusernameinformation)
      - [2.2.6.15 SAMPR_USER_HOME_INFORMATION](#22615-sampruserhomeinformation)
      - [2.2.6.16 SAMPR_USER_SCRIPT_INFORMATION](#22616-sampruserscriptinformation)
      - [2.2.6.17 SAMPR_USER_PROFILE_INFORMATION](#22617-sampruserprofileinformation)
      - [2.2.6.18 SAMPR_USER_ADMIN_COMMENT_INFORMATION](#22618-sampruseradmincommentinformation)
      - [2.2.6.19 SAMPR_USER_WORKSTATIONS_INFORMATION](#22619-sampruserworkstationsinformation)
      - [2.2.6.20 SAMPR_USER_LOGON_HOURS_INFORMATION](#22620-sampruserlogonhoursinformation)
      - [2.2.6.21 SAMPR_ENCRYPTED_USER_PASSWORD](#22621-samprencrypteduserpassword)
      - [2.2.6.22 SAMPR_ENCRYPTED_USER_PASSWORD_NEW](#22622-samprencrypteduserpasswordnew)
      - [2.2.6.23 SAMPR_USER_INTERNAL1_INFORMATION](#22623-sampruserinternal1information)
      - [2.2.6.24 SAMPR_USER_INTERNAL4_INFORMATION](#22624-sampruserinternal4information)
      - [2.2.6.25 SAMPR_USER_INTERNAL4_INFORMATION_NEW](#22625-sampruserinternal4informationnew)
      - [2.2.6.26 SAMPR_USER_INTERNAL5_INFORMATION](#22626-sampruserinternal5information)
      - [2.2.6.27 SAMPR_USER_INTERNAL5_INFORMATION_NEW](#22627-sampruserinternal5informationnew)
      - [2.2.6.28 USER_INFORMATION_CLASS](#22628-userinformationclass)
      - [2.2.6.29 SAMPR_USER_INFO_BUFFER](#22629-sampruserinfobuffer)
      - [2.2.6.30 SAMPR_USER_INTERNAL7_INFORMATION](#22630-sampruserinternal7information)
      - [2.2.6.31 SAMPR_USER_INTERNAL8_INFORMATION](#22631-sampruserinternal8information)
      - [2.2.6.32 SAMPR_ENCRYPTED_PASSWORD_AES](#22632-samprencryptedpasswordaes)
    - [2.2.7 Miscellaneous Protocol-Specific Types](#227-miscellaneous-protocol-specific-types)
      - [2.2.7.1 PSAMPR_SERVER_NAME](#2271-psamprservername)
      - [2.2.7.2 SAMPR_HANDLE](#2272-samprhandle)
      - [2.2.7.3 ENCRYPTED_LM_OWF_PASSWORD, ENCRYPTED_NT_OWF_PASSWORD](#2273-encryptedlmowfpassword-encryptedntowfpassword)
      - [2.2.7.4 SAMPR_ULONG_ARRAY](#2274-samprulongarray)
      - [2.2.7.5 SAMPR_PSID_ARRAY](#2275-samprpsidarray)
      - [2.2.7.6 SAMPR_SID_INFORMATION](#2276-samprsidinformation)
      - [2.2.7.7 SAMPR_PSID_ARRAY_OUT](#2277-samprpsidarrayout)
      - [2.2.7.8 SAMPR_RETURNED_USTRING_ARRAY](#2278-samprreturnedustringarray)
      - [2.2.7.9 SAMPR_RID_ENUMERATION](#2279-samprridenumeration)
      - [2.2.7.10 SAMPR_ENUMERATION_BUFFER](#22710-samprenumerationbuffer)
      - [2.2.7.11 SAMPR_SR_SECURITY_DESCRIPTOR](#22711-samprsrsecuritydescriptor)
      - [2.2.7.12 GROUP_MEMBERSHIP](#22712-groupmembership)
      - [2.2.7.13 SAMPR_GET_GROUPS_BUFFER](#22713-samprgetgroupsbuffer)
      - [2.2.7.14 SAMPR_GET_MEMBERS_BUFFER](#22714-samprgetmembersbuffer)
      - [2.2.7.15 SAMPR_REVISION_INFO_V1](#22715-samprrevisioninfov1)
      - [2.2.7.16 SAMPR_REVISION_INFO](#22716-samprrevisioninfo)
      - [2.2.7.17 USER_DOMAIN_PASSWORD_INFORMATION](#22717-userdomainpasswordinformation)
    - [2.2.8 Selective Enumerate Associated Structures](#228-selective-enumerate-associated-structures)
      - [2.2.8.1 Common Selective Enumerate Fields](#2281-common-selective-enumerate-fields)
      - [2.2.8.2 SAMPR_DOMAIN_DISPLAY_USER](#2282-samprdomaindisplayuser)
      - [2.2.8.3 SAMPR_DOMAIN_DISPLAY_MACHINE](#2283-samprdomaindisplaymachine)
      - [2.2.8.4 SAMPR_DOMAIN_DISPLAY_GROUP](#2284-samprdomaindisplaygroup)
      - [2.2.8.5 SAMPR_DOMAIN_DISPLAY_OEM_USER](#2285-samprdomaindisplayoemuser)
      - [2.2.8.6 SAMPR_DOMAIN_DISPLAY_OEM_GROUP](#2286-samprdomaindisplayoemgroup)
      - [2.2.8.7 SAMPR_DOMAIN_DISPLAY_USER_BUFFER](#2287-samprdomaindisplayuserbuffer)
      - [2.2.8.8 SAMPR_DOMAIN_DISPLAY_MACHINE_BUFFER](#2288-samprdomaindisplaymachinebuffer)
      - [2.2.8.9 SAMPR_DOMAIN_DISPLAY_GROUP_BUFFER](#2289-samprdomaindisplaygroupbuffer)
      - [2.2.8.10 SAMPR_DOMAIN_DISPLAY_OEM_USER_BUFFER](#22810-samprdomaindisplayoemuserbuffer)
      - [2.2.8.11 SAMPR_DOMAIN_DISPLAY_OEM_GROUP_BUFFER](#22811-samprdomaindisplayoemgroupbuffer)
      - [2.2.8.12 DOMAIN_DISPLAY_INFORMATION](#22812-domaindisplayinformation)
      - [2.2.8.13 SAMPR_DISPLAY_INFO_BUFFER](#22813-samprdisplayinfobuffer)
    - [2.2.9 SamrValidatePassword Data Types](#229-samrvalidatepassword-data-types)
      - [2.2.9.1 SAM_VALIDATE_PASSWORD_HASH](#2291-samvalidatepasswordhash)
      - [2.2.9.2 SAM_VALIDATE_PERSISTED_FIELDS](#2292-samvalidatepersistedfields)
      - [2.2.9.3 SAM_VALIDATE_VALIDATION_STATUS](#2293-samvalidatevalidationstatus)
      - [2.2.9.4 SAM_VALIDATE_STANDARD_OUTPUT_ARG](#2294-samvalidatestandardoutputarg)
      - [2.2.9.5 SAM_VALIDATE_AUTHENTICATION_INPUT_ARG](#2295-samvalidateauthenticationinputarg)
      - [2.2.9.6 SAM_VALIDATE_PASSWORD_CHANGE_INPUT_ARG](#2296-samvalidatepasswordchangeinputarg)
      - [2.2.9.7 SAM_VALIDATE_PASSWORD_RESET_INPUT_ARG](#2297-samvalidatepasswordresetinputarg)
      - [2.2.9.8 PASSWORD_POLICY_VALIDATION_TYPE](#2298-passwordpolicyvalidationtype)
      - [2.2.9.9 SAM_VALIDATE_INPUT_ARG](#2299-samvalidateinputarg)
      - [2.2.9.10 SAM_VALIDATE_OUTPUT_ARG](#22910-samvalidateoutputarg)
    - [2.2.10 Supplemental Credentials Structures](#2210-supplemental-credentials-structures)
      - [2.2.10.1 USER_PROPERTIES](#22101-userproperties)
      - [2.2.10.2 USER_PROPERTY](#22102-userproperty)
      - [2.2.10.3 Primary:WDigest - WDIGEST_CREDENTIALS](#22103-primarywdigest-wdigestcredentials)
      - [2.2.10.4 Primary:Kerberos - KERB_STORED_CREDENTIAL](#22104-primarykerberos-kerbstoredcredential)
      - [2.2.10.5 KERB_KEY_DATA](#22105-kerbkeydata)
      - [2.2.10.6 Primary:Kerberos-Newer-Keys - KERB_STORED_CREDENTIAL_NEW](#22106-primarykerberos-newer-keys-kerbstoredcredentialnew)
      - [2.2.10.7 KERB_KEY_DATA_NEW](#22107-kerbkeydatanew)
      - [2.2.10.8 Kerberos Encryption Algorithm Identifiers](#22108-kerberos-encryption-algorithm-identifiers)
      - [2.2.10.9 NTLM-Strong-NTOWF](#22109-ntlm-strong-ntowf)
    - [2.2.11 Common Algorithms](#2211-common-algorithms)
      - [2.2.11.1 DES-ECB-LM](#22111-des-ecb-lm)
        - [2.2.11.1.1 Encrypting an NT or LM Hash Value with a Specified Key](#221111-encrypting-an-nt-or-lm-hash-value-with-a-specified-key)
        - [2.2.11.1.2 Encrypting a 64-Bit Block with a 7-Byte Key](#221112-encrypting-a-64-bit-block-with-a-7-byte-key)
        - [2.2.11.1.3 Deriving Key1 and Key2 from a Little-Endian, Unsigned Integer Key](#221113-deriving-key1-and-key2-from-a-little-endian-unsigned-integer-key)
        - [2.2.11.1.4 Deriving Key1 and Key2 from a 16-Byte Key](#221114-deriving-key1-and-key2-from-a-16-byte-key)
  - [2.3 Directory Service Schema Elements](#23-directory-service-schema-elements)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 Server Details](#31-server-details)
    - [3.1.1 Abstract Data Model](#311-abstract-data-model)
      - [3.1.1.3 and section 3.1.1.4 contain a list of the Active Directory attributes and classes relevant to](#3113-and-section-3114-contain-a-list-of-the-active-directory-attributes-and-classes-relevant-to)
      - [3.1.1.4 Object Class List](#3114-object-class-list)
      - [3.1.1.5 Password Settings Attributes for Originating Update Constraints](#3115-password-settings-attributes-for-originating-update-constraints)
      - [3.1.1.6 Attribute Constraints for Originating Updates](#3116-attribute-constraints-for-originating-updates)
      - [3.1.1.7 Additional Update Constraints](#3117-additional-update-constraints)
        - [3.1.1.7.1 General Password Policy](#31171-general-password-policy)
        - [3.1.1.7.2 Cleartext Password Policy](#31172-cleartext-password-policy)
      - [3.1.1.8 Attribute Triggers for Originating Updates](#3118-attribute-triggers-for-originating-updates)
        - [3.1.1.8.1 objectClass](#31181-objectclass)
        - [3.1.1.8.2 primaryGroupID](#31182-primarygroupid)
        - [3.1.1.8.3 lockoutTime](#31183-lockouttime)
        - [3.1.1.8.4 sAMAccountName](#31184-samaccountname)
        - [3.1.1.8.5 clearTextPassword](#31185-cleartextpassword)
        - [3.1.1.8.6 dBCSPwd](#31186-dbcspwd)
        - [3.1.1.8.7 unicodePwd](#31187-unicodepwd)
        - [3.1.1.8.8 pwdLastSet](#31188-pwdlastset)
        - [3.1.1.8.9 member](#31189-member)
        - [3.1.1.8.10 userAccountControl](#311810-useraccountcontrol)
        - [3.1.1.8.11 supplementalCredentials](#311811-supplementalcredentials)
          - [3.1.1.8.11.2 Primary:WDigest](#3118112-primarywdigest)
          - [3.1.1.8.11.3 Primary:Kerberos](#3118113-primarykerberos)
          - [3.1.1.8.11.4 Primary:CLEARTEXT](#3118114-primarycleartext)
          - [3.1.1.8.11.5 Primary:CLEARTEXT Property](#3118115-primarycleartext-property)
          - [3.1.1.8.11.6 Primary:Kerberos-Newer-Keys Property](#3118116-primarykerberos-newer-keys-property)
          - [3.1.1.8.11.7 Primary:NTLM-Strong-NTOWF Property](#3118117-primaryntlm-strong-ntowf-property)
      - [3.1.1.9 Additional Update Triggers](#3119-additional-update-triggers)
        - [3.1.1.9.1 Password History Update](#31191-password-history-update)
        - [3.1.1.9.2 objectSid Value Generation](#31192-objectsid-value-generation)
          - [3.1.1.9.2.1 DC Configuration](#311921-dc-configuration)
          - [3.1.1.9.2.2 Non-DC Configuration](#311922-non-dc-configuration)
      - [3.1.1.10 SamContextHandle Data Model](#31110-samcontexthandle-data-model)
      - [3.1.1.11 Server Access Control List](#31111-server-access-control-list)
      - [3.1.1.12 ComputerAccountReuseAllowList](#31112-computeraccountreuseallowlist)
    - [3.1.2 Security Model](#312-security-model)
      - [3.1.2.1 Server-wide Access Check](#3121-server-wide-access-check)
      - [3.1.2.2 Standard Handle-Based Access Checks](#3122-standard-handle-based-access-checks)
      - [3.1.2.3 AD Access Checks in DC Configuration](#3123-ad-access-checks-in-dc-configuration)
      - [3.1.2.4 Acquiring an SMB Session Key](#3124-acquiring-an-smb-session-key)
    - [3.1.3 Timers](#313-timers)
    - [3.1.4 Initialization](#314-initialization)
      - [3.1.4.1 Default Access](#3141-default-access)
      - [3.1.4.2 Default Accounts](#3142-default-accounts)
    - [3.1.5 Message Processing Events and Sequencing Rules](#315-message-processing-events-and-sequencing-rules)
      - [3.1.5.1 Open Pattern](#3151-open-pattern)
        - [3.1.5.1.1 SamrConnect5 (Opnum 64)](#31511-samrconnect5-opnum-64)
        - [3.1.5.1.2 SamrConnect4 (Opnum 62)](#31512-samrconnect4-opnum-62)
        - [3.1.5.1.3 SamrConnect2 (Opnum 57)](#31513-samrconnect2-opnum-57)
        - [3.1.5.1.4 SamrConnect (Opnum 0)](#31514-samrconnect-opnum-0)
        - [3.1.5.1.5 SamrOpenDomain (Opnum 7)](#31515-samropendomain-opnum-7)
        - [3.1.5.1.6 Common Processing for Group, Alias, and User](#31516-common-processing-for-group-alias-and-user)
        - [3.1.5.1.7 SamrOpenGroup (Opnum 19)](#31517-samropengroup-opnum-19)
        - [3.1.5.1.8 SamrOpenAlias (Opnum 27)](#31518-samropenalias-opnum-27)
        - [3.1.5.1.9 SamrOpenUser (Opnum 34)](#31519-samropenuser-opnum-34)
      - [3.1.5.2 Enumerate Pattern](#3152-enumerate-pattern)
        - [3.1.5.2.1 SamrEnumerateDomainsInSamServer (Opnum 6)](#31521-samrenumeratedomainsinsamserver-opnum-6)
        - [3.1.5.2.2 Common Processing for Enumeration of Users, Groups, and Aliases](#31522-common-processing-for-enumeration-of-users-groups-and-aliases)
        - [3.1.5.2.3 SamrEnumerateGroupsInDomain (Opnum 11)](#31523-samrenumerategroupsindomain-opnum-11)
        - [3.1.5.2.4 SamrEnumerateAliasesInDomain (Opnum 15)](#31524-samrenumeratealiasesindomain-opnum-15)
        - [3.1.5.2.5 SamrEnumerateUsersInDomain (Opnum 13)](#31525-samrenumerateusersindomain-opnum-13)
      - [3.1.5.3 Selective Enumerate Pattern](#3153-selective-enumerate-pattern)
        - [3.1.5.3.1 SamrQueryDisplayInformation3 (Opnum 51)](#31531-samrquerydisplayinformation3-opnum-51)
        - [3.1.5.3.2 SamrQueryDisplayInformation2 (Opnum 48)](#31532-samrquerydisplayinformation2-opnum-48)
        - [3.1.5.3.3 SamrQueryDisplayInformation (Opnum 40)](#31533-samrquerydisplayinformation-opnum-40)
        - [3.1.5.3.4 SamrGetDisplayEnumerationIndex2 (Opnum 49)](#31534-samrgetdisplayenumerationindex2-opnum-49)
        - [3.1.5.3.5 SamrGetDisplayEnumerationIndex (Opnum 41)](#31535-samrgetdisplayenumerationindex-opnum-41)
      - [3.1.5.4 Create Pattern](#3154-create-pattern)
        - [3.1.5.4.1 Common Processing for Group and Alias Creation](#31541-common-processing-for-group-and-alias-creation)
        - [3.1.5.4.2 SamrCreateGroupInDomain (Opnum 10)](#31542-samrcreategroupindomain-opnum-10)
        - [3.1.5.4.3 SamrCreateAliasInDomain (Opnum 14)](#31543-samrcreatealiasindomain-opnum-14)
        - [3.1.5.4.4 SamrCreateUser2InDomain (Opnum 50)](#31544-samrcreateuser2indomain-opnum-50)
        - [3.1.5.4.5 SamrCreateUserInDomain (Opnum 12)](#31545-samrcreateuserindomain-opnum-12)
      - [3.1.5.5 Query Pattern](#3155-query-pattern)
        - [3.1.5.5.1 SamrQueryInformationDomain2 (Opnum 46)](#31551-samrqueryinformationdomain2-opnum-46)
          - [3.1.5.5.1.1 DomainGeneralInformation](#315511-domaingeneralinformation)
          - [3.1.5.5.1.2 DomainServerRoleInformation](#315512-domainserverroleinformation)
          - [3.1.5.5.1.3 DomainStateInformation](#315513-domainstateinformation)
          - [3.1.5.5.1.4 DomainGeneralInformation2](#315514-domaingeneralinformation2)
        - [3.1.5.5.2 SamrQueryInformationDomain (Opnum 8)](#31552-samrqueryinformationdomain-opnum-8)
        - [3.1.5.5.3 SamrQueryInformationGroup (Opnum 20)](#31553-samrqueryinformationgroup-opnum-20)
          - [3.1.5.5.3.1 GroupReplicationInformation](#315531-groupreplicationinformation)
        - [3.1.5.5.4 SamrQueryInformationAlias (Opnum 28)](#31554-samrqueryinformationalias-opnum-28)
        - [3.1.5.5.5 SamrQueryInformationUser2 (Opnum 47)](#31555-samrqueryinformationuser2-opnum-47)
          - [3.1.5.5.5.1 Common Processing](#315551-common-processing)
          - [3.1.5.5.5.2 UserAllInformation](#315552-userallinformation)
        - [3.1.5.5.6 SamrQueryInformationUser (Opnum 36)](#31556-samrqueryinformationuser-opnum-36)
      - [3.1.5.6 Set Pattern](#3156-set-pattern)
        - [3.1.5.6.1 SamrSetInformationDomain (Opnum 9)](#31561-samrsetinformationdomain-opnum-9)
          - [3.1.5.6.1.1 DomainServerRoleInformation](#315611-domainserverroleinformation)
          - [3.1.5.6.1.2 DomainStateInformation](#315612-domainstateinformation)
          - [3.1.5.6.1.3 DomainPasswordInformation](#315613-domainpasswordinformation)
        - [3.1.5.6.2 SamrSetInformationGroup (Opnum 21)](#31562-samrsetinformationgroup-opnum-21)
        - [3.1.5.6.3 SamrSetInformationAlias (Opnum 29)](#31563-samrsetinformationalias-opnum-29)
        - [3.1.5.6.4 SamrSetInformationUser2 (Opnum 58)](#31564-samrsetinformationuser2-opnum-58)
          - [3.1.5.6.4.3 UserInternal4Information](#315643-userinternal4information)
          - [3.1.5.6.4.4 UserInternal4InformationNew 3.1.5.6.4.5](#315644-userinternal4informationnew-315645)
          - [3.1.5.6.4.5 UserInternal4InformationNew](#315645-userinternal4informationnew)
          - [3.1.5.6.4.6 UserInternal8Information](#315646-userinternal8information)
        - [3.1.5.6.5 SamrSetInformationUser (Opnum 37)](#31565-samrsetinformationuser-opnum-37)
      - [3.1.5.7 Delete Pattern](#3157-delete-pattern)
        - [3.1.5.7.1 SamrDeleteGroup (Opnum 23)](#31571-samrdeletegroup-opnum-23)
        - [3.1.5.7.2 SamrDeleteAlias (Opnum 30)](#31572-samrdeletealias-opnum-30)
        - [3.1.5.7.3 SamrDeleteUser (Opnum 35)](#31573-samrdeleteuser-opnum-35)
      - [3.1.5.8 Membership Pattern](#3158-membership-pattern)
        - [3.1.5.8.1 SamrAddMemberToGroup (Opnum 22)](#31581-samraddmembertogroup-opnum-22)
        - [3.1.5.8.2 SamrRemoveMemberFromGroup (Opnum 24)](#31582-samrremovememberfromgroup-opnum-24)
        - [3.1.5.8.3 SamrGetMembersInGroup (Opnum 25)](#31583-samrgetmembersingroup-opnum-25)
        - [3.1.5.8.4 SamrAddMemberToAlias (Opnum 31)](#31584-samraddmembertoalias-opnum-31)
        - [3.1.5.8.5 SamrRemoveMemberFromAlias (Opnum 32)](#31585-samrremovememberfromalias-opnum-32)
        - [3.1.5.8.6 SamrGetMembersInAlias (Opnum 33)](#31586-samrgetmembersinalias-opnum-33)
        - [3.1.5.8.7 SamrRemoveMemberFromForeignDomain (Opnum 45)](#31587-samrremovememberfromforeigndomain-opnum-45)
        - [3.1.5.8.8 SamrAddMultipleMembersToAlias (Opnum 52)](#31588-samraddmultiplememberstoalias-opnum-52)
        - [3.1.5.8.9 SamrRemoveMultipleMembersFromAlias (Opnum 53)](#31589-samrremovemultiplemembersfromalias-opnum-53)
      - [3.1.5.9 Membership-Of Pattern](#3159-membership-of-pattern)
        - [3.1.5.9.1 SamrGetGroupsForUser (Opnum 39)](#31591-samrgetgroupsforuser-opnum-39)
        - [3.1.5.9.2 SamrGetAliasMembership (Opnum 16)](#31592-samrgetaliasmembership-opnum-16)
      - [3.1.5.10 Change Password Pattern](#31510-change-password-pattern)
        - [3.1.5.10.1 SamrChangePasswordUser (Opnum 38)](#315101-samrchangepassworduser-opnum-38)
        - [3.1.5.10.2 SamrOemChangePasswordUser2 (Opnum 54)](#315102-samroemchangepassworduser2-opnum-54)
        - [3.1.5.10.3 SamrUnicodeChangePasswordUser2 (Opnum 55)](#315103-samrunicodechangepassworduser2-opnum-55)
        - [3.1.5.10.4 SamrUnicodeChangePasswordUser4 (Opnum 73)](#315104-samrunicodechangepassworduser4-opnum-73)
      - [3.1.5.11 Lookup Pattern](#31511-lookup-pattern)
        - [3.1.5.11.1 SamrLookupDomainInSamServer (Opnum 5)](#315111-samrlookupdomaininsamserver-opnum-5)
        - [3.1.5.11.2 SamrLookupNamesInDomain (Opnum 17)](#315112-samrlookupnamesindomain-opnum-17)
        - [3.1.5.11.3 SamrLookupIdsInDomain (Opnum 18)](#315113-samrlookupidsindomain-opnum-18)
      - [3.1.5.12 Security Pattern](#31512-security-pattern)
        - [3.1.5.12.1 SamrSetSecurityObject (Opnum 2)](#315121-samrsetsecurityobject-opnum-2)
          - [3.1.5.12.1.1 SamrSetSecurityObject (DC Configuration)](#3151211-samrsetsecurityobject-dc-configuration)
          - [3.1.5.12.1.2 SamrSetSecurityObject (Non-DC Configuration)](#3151212-samrsetsecurityobject-non-dc-configuration)
        - [3.1.5.12.2 SamrQuerySecurityObject (Opnum 3)](#315122-samrquerysecurityobject-opnum-3)
          - [3.1.5.12.2.1 SamrQuerySecurityObject (DC Configuration)](#3151221-samrquerysecurityobject-dc-configuration)
          - [3.1.5.12.2.2 SamrQuerySecurityObject (Non-DC Configuration)](#3151222-samrquerysecurityobject-non-dc-configuration)
      - [3.1.5.13 Miscellaneous](#31513-miscellaneous)
        - [3.1.5.13.1 SamrCloseHandle (Opnum 1)](#315131-samrclosehandle-opnum-1)
        - [3.1.5.13.2 SamrSetMemberAttributesOfGroup (Opnum 26)](#315132-samrsetmemberattributesofgroup-opnum-26)
        - [3.1.5.13.3 SamrGetUserDomainPasswordInformation (Opnum 44)](#315133-samrgetuserdomainpasswordinformation-opnum-44)
        - [3.1.5.13.4 SamrGetDomainPasswordInformation (Opnum 56)](#315134-samrgetdomainpasswordinformation-opnum-56)
        - [3.1.5.13.5 SamrRidToSid (Opnum 65)](#315135-samrridtosid-opnum-65)
        - [3.1.5.13.6 SamrSetDSRMPassword (Opnum 66)](#315136-samrsetdsrmpassword-opnum-66)
        - [3.1.5.13.7 SamrValidatePassword (Opnum 67)](#315137-samrvalidatepassword-opnum-67)
          - [3.1.5.13.7.1 SamValidatePasswordChange 3.1.5.13.7.2](#3151371-samvalidatepasswordchange-3151372)
          - [3.1.5.13.7.2 SamValidatePasswordChange](#3151372-samvalidatepasswordchange)
          - [3.1.5.13.7.3 SamValidatePasswordReset](#3151373-samvalidatepasswordreset)
        - [3.1.5.13.8 SamrValidateComputerAccountReuseAttempt (Opnum 74)](#315138-samrvalidatecomputeraccountreuseattempt-opnum-74)
        - [3.1.5.13.9 SamrAccountIsDelegatedManagedServiceAccount (Opnum 77)](#315139-samraccountisdelegatedmanagedserviceaccount-opnum-77)
      - [3.1.5.14 Supplemental Message Processing](#31514-supplemental-message-processing)
        - [3.1.5.14.1 distinguishedName Generation](#315141-distinguishedname-generation)
        - [3.1.5.14.2 userAccountControl Mapping Table](#315142-useraccountcontrol-mapping-table)
        - [3.1.5.14.3 PasswordCanChange Generation](#315143-passwordcanchange-generation)
        - [3.1.5.14.4 PasswordMustChange Generation](#315144-passwordmustchange-generation)
        - [3.1.5.14.5 Account Lockout Enforcement and Reset](#315145-account-lockout-enforcement-and-reset)
        - [3.1.5.14.6 Account Lockout State Maintenance](#315146-account-lockout-state-maintenance)
        - [3.1.5.14.7 Attributes Field Handling](#315147-attributes-field-handling)
        - [3.1.5.14.8 Domain Field to Attribute Name Mapping](#315148-domain-field-to-attribute-name-mapping)
        - [3.1.5.14.9 Group Field to Attribute Name Mapping](#315149-group-field-to-attribute-name-mapping)
        - [3.1.5.14.10 Alias Field to Attribute Name Mapping](#3151410-alias-field-to-attribute-name-mapping)
        - [3.1.5.14.11 User Field to Attribute Name Mapping](#3151411-user-field-to-attribute-name-mapping)
    - [3.1.6 Timer Events](#316-timer-events)
    - [3.1.7 Other Local Events](#317-other-local-events)
      - [3.1.7.1 Domain Join Processing](#3171-domain-join-processing)
      - [3.1.7.2 Domain Unjoin Processing](#3172-domain-unjoin-processing)
  - [3.2 Client Details](#32-client-details)
    - [3.2.1 Abstract Data Model](#321-abstract-data-model)
    - [3.2.2 Security Model](#322-security-model)
      - [3.2.2.1 RC4 Cipher Usage](#3221-rc4-cipher-usage)
      - [3.2.2.2 MD5 Usage](#3222-md5-usage)
      - [3.2.2.3 Acquiring an SMB Session Key](#3223-acquiring-an-smb-session-key)
      - [3.2.2.4 AES Cipher Usage](#3224-aes-cipher-usage)
      - [3.2.2.5 Deriving an Encryption Key from a Plaintext Password](#3225-deriving-an-encryption-key-from-a-plaintext-password)
    - [3.2.3 Timers](#323-timers)
    - [3.2.4 Initialization](#324-initialization)
    - [3.2.5 Message Processing Events and Sequencing Rules](#325-message-processing-events-and-sequencing-rules)
    - [3.2.6 Timer Events](#326-timer-events)
    - [3.2.7 Other Local Events](#327-other-local-events)
- [4 Protocol Examples](#4-protocol-examples)
  - [4.1 Creating a User Account](#41-creating-a-user-account)
  - [4.2 Enabling a User Account](#42-enabling-a-user-account)
  - [4.3 Encrypting an NT or LM Hash](#43-encrypting-an-nt-or-lm-hash)
...
###### 3.1.1.8.11.4 Primary:CLEARTEXT
...
###### 3.1.5.6.4.3 UserInternal4Information



###### 3.1.5.6.4.4 UserInternal4InformationNew 3.1.5.6.4.5
...
###### 3.1.5.13.7.1 SamValidatePasswordChange 3.1.5.13.7.2
