...
- [1 Introduction](#1-introduction)
  ...
  - [1.3 Overview](#13-overview)
    - [1.3.1 Scenarios](#131-scenarios)
      - [1.3.1.1 OleTx Resource Managers Enlisting with XA Transaction Managers](#1311-oletx-resource-managers-enlisting-with-xa-transaction-managers)
        - [1.3.1.1.1 Transaction Enlistment and Completion](#13111-transaction-enlistment-and-completion)
        - [1.3.1.1.2 Transaction Recovery](#13112-transaction-recovery)
      - [1.3.1.2 XA Resource Managers Enlisting with Transaction Managers](#1312-xa-resource-managers-enlisting-with-transaction-managers)
        - [1.3.1.2.1 Transaction Recovery](#13121-transaction-recovery)
        - [1.3.1.2.2 Two-Pipe Model](#13122-two-pipe-model)
          - [1.3.1.2.2.1 XA Resource Manager Registration and Unregistration](#131221-xa-resource-manager-registration-and-unregistration)
          - [1.3.1.2.2.2 Transaction Enlistment and Completion](#131222-transaction-enlistment-and-completion)
        - [1.3.1.2.3 One-Pipe Model](#13123-one-pipe-model)
          - [1.3.1.2.3.1 XA Resource Manager Registration and Unregistration](#131231-xa-resource-manager-registration-and-unregistration)
          - [1.3.1.2.3.2 Transaction Enlistment and Completion](#131232-transaction-enlistment-and-completion)
    - [1.3.2 Roles](#132-roles)
      - [1.3.2.1 XA Resource Manager Bridge Role](#1321-xa-resource-manager-bridge-role)
      - [1.3.2.2 XA Superior Transaction Manager Role](#1322-xa-superior-transaction-manager-role)
      - [1.3.2.3 Transaction Manager Role](#1323-transaction-manager-role)
        - [1.3.2.3.1 XA Resource Manager Bridge Facet](#13231-xa-resource-manager-bridge-facet)
        - [1.3.2.3.2 XA Subordinate Transaction Manager Facet](#13232-xa-subordinate-transaction-manager-facet)
...
- [2 Messages](#2-messages)
  ...
  - [2.2 Message Syntax](#22-message-syntax)
    - [2.2.1 Common Structures](#221-common-structures)
      ...
      - [2.2.1.2 XA_BQUAL_1](#2212-xabqual1)
      - [2.2.1.3 XA_XID](#2213-xaxid)
      - [2.2.1.4 XA_UOW](#2214-xauow)
    - [2.2.2 Enumeration](#222-enumeration)
      - [2.2.2.1 Connection Types](#2221-connection-types)
    - [2.2.3 Connection Types Relevant to XA Resource Manager Bridges and XA Resource](#223-connection-types-relevant-to-xa-resource-manager-bridges-and-xa-resource)
      - [2.2.3.1 Versioning](#2231-versioning)
      - [2.2.3.2 CONNTYPE_XATM_OPEN](#2232-conntypexatmopen)
        - [2.2.3.2.1 XATMUSER_MTAG_E_RMNONEXISTENT](#22321-xatmusermtagermnonexistent)
        - [2.2.3.2.2 XATMUSER_MTAG_E_RMNOTAVAILABLE](#22322-xatmusermtagermnotavailable)
        - [2.2.3.2.3 XATMUSER_MTAG_E_RMOPENFAILED](#22323-xatmusermtagermopenfailed)
        - [2.2.3.2.4 XATMUSER_MTAG_E_RMPROTOCOL](#22324-xatmusermtagermprotocol)
        - [2.2.3.2.5 XATMUSER_MTAG_RMOPEN](#22325-xatmusermtagrmopen)
        - [2.2.3.2.6 XATMUSER_MTAG_RMOPENOK](#22326-xatmusermtagrmopenok)
      - [2.2.3.3 CONNTYPE_XATM_OPENONEPIPE](#2233-conntypexatmopenonepipe)
        - [2.2.3.3.1 XATMUSER_MTAG_E_CONFIGLOGWRITEFAILED](#22331-xatmusermtageconfiglogwritefailed)
        - [2.2.3.3.2 XATMUSER_MTAG_E_RMCLOSEFAILED](#22332-xatmusermtagermclosefailed)
        - [2.2.3.3.3 XATMUSER_MTAG_E_RMCLOSERMNOTAVAILABLE](#22333-xatmusermtagermclosermnotavailable)
        - [2.2.3.3.4 XATMUSER_MTAG_E_RMCLOSETMERROR](#22334-xatmusermtagermclosetmerror)
        - [2.2.3.3.5 XATMUSER_MTAG_E_RMCLOSETMNOTAVAILABLE](#22335-xatmusermtagermclosetmnotavailable)
        - [2.2.3.3.6 XATMUSER_MTAG_E_RMCLOSEUNEXPECTED](#22336-xatmusermtagermcloseunexpected)
        - [2.2.3.3.7 XATMUSER_MTAG_RMCLOSE](#22337-xatmusermtagrmclose)
        - [2.2.3.3.8 XATMUSER_MTAG_RMCLOSEOK](#22338-xatmusermtagrmcloseok)
      - [2.2.3.4 CONNTYPE_XATM_ENLIST](#2234-conntypexatmenlist)
        - [2.2.3.4.1 XATMUSER_MTAG_E_ENLISTMENTDUPLICATE](#22341-xatmusermtageenlistmentduplicate)
        - [2.2.3.4.2 XATMUSER_MTAG_E_ENLISTMENTFAILED](#22342-xatmusermtageenlistmentfailed)
        - [2.2.3.4.3 XATMUSER_MTAG_E_ENLISTMENTIMPFAILED](#22343-xatmusermtageenlistmentimpfailed)
        - [2.2.3.4.4 XATMUSER_MTAG_E_ENLISTMENTNOMEMORY](#22344-xatmusermtageenlistmentnomemory)
        - [2.2.3.4.5 XATMUSER_MTAG_E_ENLISTMENTRMNOTFOUND](#22345-xatmusermtageenlistmentrmnotfound)
        - [2.2.3.4.6 XATMUSER_MTAG_E_ENLISTMENTRMRECOVERING](#22346-xatmusermtageenlistmentrmrecovering)
        - [2.2.3.4.7 XATMUSER_MTAG_E_ENLISTMENTRMUNAVAILABLE](#22347-xatmusermtageenlistmentrmunavailable)
        - [2.2.3.4.8 XATMUSER_MTAG_E_ENLISTMENTTOOLATE](#22348-xatmusermtageenlistmenttoolate)
        - [2.2.3.4.9 XATMUSER_MTAG_ENLIST](#22349-xatmusermtagenlist)
        - [2.2.3.4.10 XATMUSER_MTAG_ENLISTMENTOK](#223410-xatmusermtagenlistmentok)
    - [2.2.4 Connection Types Relevant to XA Superior Transaction Managers and XA](#224-connection-types-relevant-to-xa-superior-transaction-managers-and-xa)
      - [2.2.4.1 Versioning](#2241-versioning)
      - [2.2.4.2 CONNTYPE_XAUSER_CONTROL](#2242-conntypexausercontrol)
        - [2.2.4.2.1 XAUSER_CONTROL_MTAG_CREATE](#22421-xausercontrolmtagcreate)
        - [2.2.4.2.2 XAUSER_CONTROL_MTAG_CREATE_NO_MEM](#22422-xausercontrolmtagcreatenomem)
        - [2.2.4.2.3 XAUSER_CONTROL_MTAG_CREATED](#22423-xausercontrolmtagcreated)
        - [2.2.4.2.4 XAUSER_CONTROL_MTAG_RECOVER](#22424-xausercontrolmtagrecover)
        - [2.2.4.2.5 XAUSER_CONTROL_MTAG_RECOVER_NO_MEM](#22425-xausercontrolmtagrecovernomem)
        - [2.2.4.2.6 XAUSER_CONTROL_MTAG_RECOVER_REPLY](#22426-xausercontrolmtagrecoverreply)
      - [2.2.4.3 CONNTYPE_XAUSER_XACT_START](#2243-conntypexauserxactstart)
        - [2.2.4.3.1 XAUSER_XACT_MTAG_START](#22431-xauserxactmtagstart)
        - [2.2.4.3.2 XAUSER_XACT_MTAG_START_DUPLICATE](#22432-xauserxactmtagstartduplicate)
        - [2.2.4.3.3 XAUSER_XACT_MTAG_START_LOG_FULL](#22433-xauserxactmtagstartlogfull)
        - [2.2.4.3.4 XAUSER_XACT_MTAG_START_NO_MEM](#22434-xauserxactmtagstartnomem)
        - [2.2.4.3.5 XAUSER_XACT_MTAG_STARTED](#22435-xauserxactmtagstarted)
      - [2.2.4.4 CONNTYPE_XAUSER_XACT_BRANCH_START](#2244-conntypexauserxactbranchstart)
      - [2.2.4.5 CONNTYPE_XAUSER_XACT_OPEN](#2245-conntypexauserxactopen)
        - [2.2.4.5.1 XAUSER_XACT_MTAG_ABORT](#22451-xauserxactmtagabort)
        - [2.2.4.5.2 XAUSER_XACT_MTAG_COMMIT](#22452-xauserxactmtagcommit)
        - [2.2.4.5.3 XAUSER_XACT_MTAG_OPEN](#22453-xauserxactmtagopen)
        - [2.2.4.5.4 XAUSER_XACT_MTAG_OPEN_NOT_FOUND](#22454-xauserxactmtagopennotfound)
        - [2.2.4.5.5 XAUSER_XACT_MTAG_OPENED](#22455-xauserxactmtagopened)
        - [2.2.4.5.6 XAUSER_XACT_MTAG_PREPARE](#22456-xauserxactmtagprepare)
        - [2.2.4.5.7 XAUSER_XACT_MTAG_PREPARE_ABORT](#22457-xauserxactmtagprepareabort)
        - [2.2.4.5.8 XAUSER_XACT_MTAG_PREPARE_SINGLEPHASE_INDOUBT](#22458-xauserxactmtagpreparesinglephaseindoubt)
        - [2.2.4.5.9 XAUSER_XACT_MTAG_REQUEST_COMPLETED](#22459-xauserxactmtagrequestcompleted)
        - [2.2.4.5.10 XAUSER_XACT_MTAG_REQUEST_FAILED_BAD_PROTOCOL](#224510-xauserxactmtagrequestfailedbadprotocol)
      - [2.2.4.6 CONNTYPE_XAUSER_XACT_BRANCH_OPEN](#2246-conntypexauserxactbranchopen)
        - [2.2.4.6.1 XAUSER_XACT_MTAG_READONLY](#22461-xauserxactmtagreadonly)
      - [2.2.4.7 CONNTYPE_XAUSER_XACT_MIGRATE](#2247-conntypexauserxactmigrate)
        - [2.2.4.7.1 XAUSER_XACT_MTAG_RESUME](#22471-xauserxactmtagresume)
        - [2.2.4.7.2 XAUSER_XACT_MTAG_RESUME_DONE](#22472-xauserxactmtagresumedone)
        - [2.2.4.7.3 XAUSER_XACT_MTAG_SUSPEND_WITH_MIGRATE](#22473-xauserxactmtagsuspendwithmigrate)
        - [2.2.4.7.4 XAUSER_XACT_MTAG_SUSPEND_WITH_MIGRATE_DONE](#22474-xauserxactmtagsuspendwithmigratedone)
        - [2.2.4.7.5 XAUSER_XACT_MTAG_TRANSACTION_NOT_SUSPENDED](#22475-xauserxactmtagtransactionnotsuspended)
      - [2.2.4.8 CONNTYPE_XAUSER_XACT_MIGRATE2](#2248-conntypexauserxactmigrate2)
        - [2.2.4.8.1 XAUSER_XACT_MTAG_RESUME_DONE](#22481-xauserxactmtagresumedone)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 Common Details](#31-common-details)
    ...
    - [3.1.6 Processing Events and Sequencing Rules](#316-processing-events-and-sequencing-rules)
    - [3.1.7 Timer Events](#317-timer-events)
    - [3.1.8 Other Local Events](#318-other-local-events)
      - [3.1.8.1 Disconnect Connection](#3181-disconnect-connection)
      - [3.1.8.2 Connection Disconnected](#3182-connection-disconnected)
  - [3.2 XA Subordinate Transaction Manager Facet Details](#32-xa-subordinate-transaction-manager-facet-details)
    - [3.2.1 Abstract Data Model](#321-abstract-data-model)
      - [3.2.1.1 Versioning](#3211-versioning)
      - [3.2.1.2 CONNTYPE_XAUSER_CONTROL Acceptor States](#3212-conntypexausercontrol-acceptor-states)
        - [3.2.1.2.1 Idle](#32121-idle)
        - [3.2.1.2.2 Processing Create Request](#32122-processing-create-request)
        - [3.2.1.2.3 Active](#32123-active)
        - [3.2.1.2.4 Ended](#32124-ended)
        - [3.2.1.2.5 State Diagram](#32125-state-diagram)
      - [3.2.1.3 CONNTYPE_XAUSER_XACT_START Acceptor States](#3213-conntypexauserxactstart-acceptor-states)
        - [3.2.1.3.1 Idle](#32131-idle)
        - [3.2.1.3.2 Processing Start Request](#32132-processing-start-request)
        - [3.2.1.3.3 Active](#32133-active)
        - [3.2.1.3.4 Ended](#32134-ended)
        - [3.2.1.3.5 State Diagram](#32135-state-diagram)
      - [3.2.1.4 CONNTYPE_XAUSER_XACT_OPEN Acceptor States](#3214-conntypexauserxactopen-acceptor-states)
        - [3.2.1.4.1 Idle](#32141-idle)
        - [3.2.1.4.2 Processing Open Request](#32142-processing-open-request)
        - [3.2.1.4.3 Active](#32143-active)
        - [3.2.1.4.4 Ended](#32144-ended)
        - [3.2.1.4.5 State Diagram](#32145-state-diagram)
      - [3.2.1.5 CONNTYPE_XAUSER_XACT_MIGRATE Acceptor States](#3215-conntypexauserxactmigrate-acceptor-states)
        - [3.2.1.5.1 Idle](#32151-idle)
        - [3.2.1.5.2 Processing Migrate Request](#32152-processing-migrate-request)
        - [3.2.1.5.3 Ended](#32153-ended)
        - [3.2.1.5.4 State Diagram](#32154-state-diagram)
      - [3.2.1.6 CONNTYPE_XAUSER_XACT_BRANCH_START Acceptor States](#3216-conntypexauserxactbranchstart-acceptor-states)
        - [3.2.1.6.1 Idle](#32161-idle)
        - [3.2.1.6.2 Processing Start Request](#32162-processing-start-request)
        - [3.2.1.6.3 Active](#32163-active)
        - [3.2.1.6.4 Ended](#32164-ended)
        - [3.2.1.6.5 State Diagram](#32165-state-diagram)
      - [3.2.1.7 CONNTYPE_XAUSER_XACT_BRANCH_OPEN Acceptor States](#3217-conntypexauserxactbranchopen-acceptor-states)
        - [3.2.1.7.1 Idle](#32171-idle)
        - [3.2.1.7.2 Processing Open Request](#32172-processing-open-request)
        - [3.2.1.7.3 Active](#32173-active)
        - [3.2.1.7.4 Ended](#32174-ended)
        - [3.2.1.7.5 State Diagram](#32175-state-diagram)
      - [3.2.1.8 CONNTYPE_XAUSER_XACT_MIGRATE2 Acceptor States](#3218-conntypexauserxactmigrate2-acceptor-states)
        - [3.2.1.8.1 Idle](#32181-idle)
        - [3.2.1.8.2 Processing Migrate2 Request](#32182-processing-migrate2-request)
        - [3.2.1.8.3 Ended](#32183-ended)
        - [3.2.1.8.4 State Diagram](#32184-state-diagram)
      - [3.2.1.9 XA Superior Enlistment State Diagram](#3219-xa-superior-enlistment-state-diagram)
    - [3.2.2 Timers](#322-timers)
    - [3.2.3 Initialization](#323-initialization)
    - [3.2.4 Higher-Layer Triggered Events](#324-higher-layer-triggered-events)
    - [3.2.5 Processing Events and Sequencing Rules](#325-processing-events-and-sequencing-rules)
      - [3.2.5.1 CONNTYPE_XAUSER_CONTROL as Acceptor](#3251-conntypexausercontrol-as-acceptor)
        - [3.2.5.1.1 Receiving an XAUSER_CONTROL_MTAG_CREATE Message](#32511-receiving-an-xausercontrolmtagcreate-message)
        - [3.2.5.1.2 Receiving an XAUSER_CONTROL_MTAG_RECOVER Message](#32512-receiving-an-xausercontrolmtagrecover-message)
        - [3.2.5.1.3 Connection Disconnected](#32513-connection-disconnected)
      - [3.2.5.2 CONNTYPE_XAUSER_XACT_START as Acceptor](#3252-conntypexauserxactstart-as-acceptor)
        - [3.2.5.2.1 Receiving an XAUSER_XACT_MTAG_START Message](#32521-receiving-an-xauserxactmtagstart-message)
        - [3.2.5.2.2 Connection Disconnected](#32522-connection-disconnected)
      - [3.2.5.3 CONNTYPE_XAUSER_XACT_OPEN as Acceptor](#3253-conntypexauserxactopen-as-acceptor)
        - [3.2.5.3.1 Receiving an XAUSER_XACT_MTAG_OPEN Message](#32531-receiving-an-xauserxactmtagopen-message)
        - [3.2.5.3.2 Receiving an XAUSER_XACT_MTAG_PREPARE Message](#32532-receiving-an-xauserxactmtagprepare-message)
        - [3.2.5.3.3 Receiving an XAUSER_XACT_MTAG_COMMIT Message](#32533-receiving-an-xauserxactmtagcommit-message)
        - [3.2.5.3.4 Receiving an XAUSER_XACT_MTAG_ABORT Message](#32534-receiving-an-xauserxactmtagabort-message)
        - [3.2.5.3.5 Connection Disconnected](#32535-connection-disconnected)
      - [3.2.5.4 CONNTYPE_XAUSER_XACT_MIGRATE as Acceptor](#3254-conntypexauserxactmigrate-as-acceptor)
        - [3.2.5.4.1 Receiving an XAUSER_XACT_MTAG_SUSPEND_WITH_MIGRATE Message](#32541-receiving-an-xauserxactmtagsuspendwithmigrate-message)
        - [3.2.5.4.2 Receiving an XAUSER_XACT_MTAG_RESUME Message](#32542-receiving-an-xauserxactmtagresume-message)
      - [3.2.5.5 CONNTYPE_XAUSER_XACT_BRANCH_START as Acceptor](#3255-conntypexauserxactbranchstart-as-acceptor)
        - [3.2.5.5.1 Receiving an XAUSER_XACT_MTAG_START Message](#32551-receiving-an-xauserxactmtagstart-message)
        - [3.2.5.5.2 Connection Disconnected](#32552-connection-disconnected)
      - [3.2.5.6 CONNTYPE_XAUSER_XACT_BRANCH_OPEN as Acceptor](#3256-conntypexauserxactbranchopen-as-acceptor)
        - [3.2.5.6.1 Receiving an XAUSER_XACT_MTAG_OPEN Message](#32561-receiving-an-xauserxactmtagopen-message)
        - [3.2.5.6.2 Receiving an XAUSER_XACT_MTAG_PREPARE Message](#32562-receiving-an-xauserxactmtagprepare-message)
        - [3.2.5.6.3 Receiving an XAUSER_XACT_MTAG_COMMIT Message](#32563-receiving-an-xauserxactmtagcommit-message)
        - [3.2.5.6.4 Receiving an XAUSER_XACT_MTAG_ABORT Message](#32564-receiving-an-xauserxactmtagabort-message)
        - [3.2.5.6.5 Connection Disconnected](#32565-connection-disconnected)
      - [3.2.5.7 CONNTYPE_XAUSER_XACT_MIGRATE2 as Acceptor](#3257-conntypexauserxactmigrate2-as-acceptor)
        - [3.2.5.7.1 Receiving an XAUSER_XACT_MTAG_SUSPEND_WITH_MIGRATE Message](#32571-receiving-an-xauserxactmtagsuspendwithmigrate-message)
        - [3.2.5.7.2 Receiving an XAUSER_XACT_MTAG_RESUME Message](#32572-receiving-an-xauserxactmtagresume-message)
    - [3.2.6 Timer Events](#326-timer-events)
    - [3.2.7 Other Local Events](#327-other-local-events)
      - [3.2.7.1 Commit Complete](#3271-commit-complete)
      - [3.2.7.2 Create Superior Enlistment Success](#3272-create-superior-enlistment-success)
      - [3.2.7.3 Create Superior Enlistment Failure](#3273-create-superior-enlistment-failure)
      - [3.2.7.4 Phase Zero Complete](#3274-phase-zero-complete)
      - [3.2.7.5 Phase One Complete](#3275-phase-one-complete)
      - [3.2.7.6 Recover In Doubt Transaction](#3276-recover-in-doubt-transaction)
      - [3.2.7.7 Rollback Complete](#3277-rollback-complete)
      - [3.2.7.8 Unilaterally Aborted](#3278-unilaterally-aborted)
  - [3.3 XA Superior Transaction Manager Details](#33-xa-superior-transaction-manager-details)
    - [3.3.1 Abstract Data Model](#331-abstract-data-model)
      - [3.3.1.1 Versioning](#3311-versioning)
      - [3.3.1.2 TM_NOTHREADAFFINITY Flag](#3312-tmnothreadaffinity-flag)
      - [3.3.1.3 CONNTYPE_XAUSER_CONTROL Initiator States](#3313-conntypexausercontrol-initiator-states)
        - [3.3.1.3.1 Idle](#33131-idle)
        - [3.3.1.3.2 Awaiting Creation Response](#33132-awaiting-creation-response)
        - [3.3.1.3.3 Active](#33133-active)
        - [3.3.1.3.4 Awaiting Recovery Response](#33134-awaiting-recovery-response)
        - [3.3.1.3.5 Ended](#33135-ended)
        - [3.3.1.3.6 State Diagram](#33136-state-diagram)
      - [3.3.1.4 CONNTYPE_XAUSER_XACT_START Initiator States](#3314-conntypexauserxactstart-initiator-states)
        - [3.3.1.4.1 Idle](#33141-idle)
        - [3.3.1.4.2 Awaiting Start Response](#33142-awaiting-start-response)
        - [3.3.1.4.3 Active](#33143-active)
        - [3.3.1.4.4 Ended](#33144-ended)
        - [3.3.1.4.5 State Diagram](#33145-state-diagram)
      - [3.3.1.5 CONNTYPE_XAUSER_XACT_OPEN Initiator States](#3315-conntypexauserxactopen-initiator-states)
        - [3.3.1.5.1 Idle](#33151-idle)
        - [3.3.1.5.2 Awaiting Open Response](#33152-awaiting-open-response)
        - [3.3.1.5.3 Processing Opened Response](#33153-processing-opened-response)
        - [3.3.1.5.4 Awaiting Prepare Response](#33154-awaiting-prepare-response)
        - [3.3.1.5.5 Awaiting Abort Response](#33155-awaiting-abort-response)
        - [3.3.1.5.6 Awaiting Commit Response](#33156-awaiting-commit-response)
        - [3.3.1.5.7 Ended](#33157-ended)
        - [3.3.1.5.8 State Diagram](#33158-state-diagram)
      - [3.3.1.6 CONNTYPE_XAUSER_XACT_MIGRATE Initiator States](#3316-conntypexauserxactmigrate-initiator-states)
        - [3.3.1.6.1 Idle](#33161-idle)
        - [3.3.1.6.2 Awaiting Suspension Response](#33162-awaiting-suspension-response)
        - [3.3.1.6.3 Awaiting Resumption Response](#33163-awaiting-resumption-response)
        - [3.3.1.6.4 Ended](#33164-ended)
        - [3.3.1.6.5 State Diagram](#33165-state-diagram)
      - [3.3.1.7 CONNTYPE_XAUSER_XACT_BRANCH_START Initiator States](#3317-conntypexauserxactbranchstart-initiator-states)
        - [3.3.1.7.1 Idle](#33171-idle)
        - [3.3.1.7.2 Awaiting Start Response](#33172-awaiting-start-response)
        - [3.3.1.7.3 Active](#33173-active)
        - [3.3.1.7.4 Ended](#33174-ended)
        - [3.3.1.7.5 State Diagram](#33175-state-diagram)
      - [3.3.1.8 CONNTYPE_XAUSER_XACT_BRANCH_OPEN Initiator States](#3318-conntypexauserxactbranchopen-initiator-states)
        - [3.3.1.8.1 Idle](#33181-idle)
        - [3.3.1.8.2 Awaiting Open Response](#33182-awaiting-open-response)
        - [3.3.1.8.3 Processing Opened Response](#33183-processing-opened-response)
        - [3.3.1.8.4 Awaiting Prepare Response](#33184-awaiting-prepare-response)
        - [3.3.1.8.5 Awaiting Abort Response](#33185-awaiting-abort-response)
        - [3.3.1.8.6 Awaiting Commit Response](#33186-awaiting-commit-response)
        - [3.3.1.8.7 Ended](#33187-ended)
        - [3.3.1.8.8 State Diagram](#33188-state-diagram)
      - [3.3.1.9 CONNTYPE_XAUSER_XACT_MIGRATE2 Initiator States](#3319-conntypexauserxactmigrate2-initiator-states)
        - [3.3.1.9.1 Idle](#33191-idle)
        - [3.3.1.9.2 Awaiting Suspension Response](#33192-awaiting-suspension-response)
        - [3.3.1.9.3 Awaiting Resumption Response](#33193-awaiting-resumption-response)
        - [3.3.1.9.4 Ended](#33194-ended)
        - [3.3.1.9.5 State Diagram](#33195-state-diagram)
    - [3.3.2 Timers](#332-timers)
    - [3.3.3 Initialization](#333-initialization)
    - [3.3.4 Higher-Layer Triggered Events](#334-higher-layer-triggered-events)
      - [3.3.4.1 XA Lookup](#3341-xa-lookup)
      - [3.3.4.2 Xa_close](#3342-xaclose)
      - [3.3.4.3 Xa_commit](#3343-xacommit)
      - [3.3.4.4 Xa_complete](#3344-xacomplete)
      - [3.3.4.5 Xa_end](#3345-xaend)
      - [3.3.4.6 Xa_forget](#3346-xaforget)
      - [3.3.4.7 Xa_open](#3347-xaopen)
      - [3.3.4.8 Xa_prepare](#3348-xaprepare)
      - [3.3.4.9 Xa_recover](#3349-xarecover)
      - [3.3.4.10 Xa_rollback](#33410-xarollback)
      - [3.3.4.11 Xa_start](#33411-xastart)
    - [3.3.5 Processing Events and Sequencing Rules](#335-processing-events-and-sequencing-rules)
      - [3.3.5.1 CONNTYPE_XAUSER_CONTROL Initiator](#3351-conntypexausercontrol-initiator)
        - [3.3.5.1.1 Receiving an XAUSER_CONTROL_MTAG_CREATE_NO_MEM Message](#33511-receiving-an-xausercontrolmtagcreatenomem-message)
        - [3.3.5.1.2 Receiving an XAUSER_CONTROL_MTAG_CREATED Message](#33512-receiving-an-xausercontrolmtagcreated-message)
        - [3.3.5.1.3 Receiving an XAUSER_CONTROL_MTAG_RECOVER_NO_MEM Message](#33513-receiving-an-xausercontrolmtagrecovernomem-message)
        - [3.3.5.1.4 Receiving an XAUSER_CONTROL_MTAG_RECOVER_REPLY Message](#33514-receiving-an-xausercontrolmtagrecoverreply-message)
        - [3.3.5.1.5 Connection Disconnected](#33515-connection-disconnected)
      - [3.3.5.2 CONNTYPE_XAUSER_XACT_START Initiator](#3352-conntypexauserxactstart-initiator)
        - [3.3.5.2.1 Receiving an XAUSER_XACT_MTAG_STARTED Message](#33521-receiving-an-xauserxactmtagstarted-message)
        - [3.3.5.2.2 Receiving an XAUSER_XACT_MTAG_START_NO_MEM Message](#33522-receiving-an-xauserxactmtagstartnomem-message)
        - [3.3.5.2.3 Receiving an XAUSER_XACT_MTAG_START_LOG_FULL Message](#33523-receiving-an-xauserxactmtagstartlogfull-message)
        - [3.3.5.2.4 Receiving an XAUSER_XACT_MTAG_START_DUPLICATE Message](#33524-receiving-an-xauserxactmtagstartduplicate-message)
        - [3.3.5.2.5 Connection Disconnected](#33525-connection-disconnected)
      - [3.3.5.3 CONNTYPE_XAUSER_XACT_OPEN Initiator](#3353-conntypexauserxactopen-initiator)
        - [3.3.5.3.1 Receiving an XAUSER_XACT_MTAG_OPENED Message](#33531-receiving-an-xauserxactmtagopened-message)
        - [3.3.5.3.2 Receiving an XAUSER_XACT_MTAG_OPEN_NOT_FOUND Message](#33532-receiving-an-xauserxactmtagopennotfound-message)
        - [3.3.5.3.3 Receiving an XAUSER_XACT_MTAG_REQUEST_COMPLETED Message](#33533-receiving-an-xauserxactmtagrequestcompleted-message)
        - [3.3.5.3.4 Receiving an XAUSER_XACT_MTAG_PREPARE_ABORT Message](#33534-receiving-an-xauserxactmtagprepareabort-message)
        - [3.3.5.3.5 Receiving an XAUSER_XACT_MTAG_PREPARE_SINGLEPHASE_INDOUBT](#33535-receiving-an-xauserxactmtagpreparesinglephaseindoubt)
        - [3.3.5.3.6 Receiving an XAUSER_XACT_MTAG_REQUEST_FAILED_BAD_PROTOCOL](#33536-receiving-an-xauserxactmtagrequestfailedbadprotocol)
        - [3.3.5.3.7 Connection Disconnected](#33537-connection-disconnected)
      - [3.3.5.4 CONNTYPE_XAUSER_XACT_MIGRATE Initiator](#3354-conntypexauserxactmigrate-initiator)
        - [3.3.5.4.1 Receiving an XAUSER_XACT_MTAG_SUSPEND_WITH_MIGRATE_DONE](#33541-receiving-an-xauserxactmtagsuspendwithmigratedone)
        - [3.3.5.4.2 Receiving an XAUSER_XACT_MTAG_RESUME_DONE Message](#33542-receiving-an-xauserxactmtagresumedone-message)
        - [3.3.5.4.3 Receiving an XAUSER_XACT_MTAG_TRANSACTION_NOT_SUSPENDED](#33543-receiving-an-xauserxactmtagtransactionnotsuspended)
        - [3.3.5.4.4 Receiving an XAUSER_XACT_MTAG_OPEN_NOT_FOUND Message](#33544-receiving-an-xauserxactmtagopennotfound-message)
        - [3.3.5.4.5 Receiving an XAUSER_XACT_MTAG_START_NO_MEM Message](#33545-receiving-an-xauserxactmtagstartnomem-message)
        - [3.3.5.4.6 Connection Disconnected](#33546-connection-disconnected)
      - [3.3.5.5 CONNTYPE_XAUSER_XACT_BRANCH_START Initiator](#3355-conntypexauserxactbranchstart-initiator)
        - [3.3.5.5.1 Receiving an XAUSER_XACT_MTAG_STARTED Message](#33551-receiving-an-xauserxactmtagstarted-message)
        - [3.3.5.5.2 Receiving an XAUSER_XACT_MTAG_START_NO_MEM Message](#33552-receiving-an-xauserxactmtagstartnomem-message)
        - [3.3.5.5.3 Receiving an XAUSER_XACT_MTAG_START_LOG_FULL Message](#33553-receiving-an-xauserxactmtagstartlogfull-message)
        - [3.3.5.5.4 Receiving an XAUSER_XACT_MTAG_START_DUPLICATE Message](#33554-receiving-an-xauserxactmtagstartduplicate-message)
        - [3.3.5.5.5 Connection Disconnected](#33555-connection-disconnected)
      - [3.3.5.6 CONNTYPE_XAUSER_XACT_BRANCH_OPEN Initiator](#3356-conntypexauserxactbranchopen-initiator)
        - [3.3.5.6.1 Receiving an XAUSER_XACT_MTAG_OPENED Message](#33561-receiving-an-xauserxactmtagopened-message)
        - [3.3.5.6.2 Receiving an XAUSER_XACT_MTAG_OPEN_NOT_FOUND Message](#33562-receiving-an-xauserxactmtagopennotfound-message)
        - [3.3.5.6.3 Receiving an XAUSER_XACT_MTAG_REQUEST_COMPLETED Message](#33563-receiving-an-xauserxactmtagrequestcompleted-message)
        - [3.3.5.6.4 Receiving an XAUSER_XACT_MTAG_PREPARE_ABORT Message](#33564-receiving-an-xauserxactmtagprepareabort-message)
        - [3.3.5.6.5 Receiving an XAUSER_XACT_MTAG_PREPARE_SINGLEPHASE_INDOUBT](#33565-receiving-an-xauserxactmtagpreparesinglephaseindoubt)
        - [3.3.5.6.6 Receiving an XAUSER_XACT_MTAG_REQUEST_FAILED_BAD_PROTOCOL](#33566-receiving-an-xauserxactmtagrequestfailedbadprotocol)
        - [3.3.5.6.7 Receiving an XAUSER_XACT_MTAG_READONLY Message](#33567-receiving-an-xauserxactmtagreadonly-message)
        - [3.3.5.6.8 Connection Disconnected](#33568-connection-disconnected)
      - [3.3.5.7 CONNTYPE_XAUSER_XACT_MIGRATE2 Initiator](#3357-conntypexauserxactmigrate2-initiator)
        - [3.3.5.7.1 Receiving an XAUSER_XACT_MTAG_SUSPEND_WITH_MIGRATE_DONE](#33571-receiving-an-xauserxactmtagsuspendwithmigratedone)
        - [3.3.5.7.2 Receiving an XAUSER_XACT_MTAG_RESUME_DONE Message](#33572-receiving-an-xauserxactmtagresumedone-message)
        - [3.3.5.7.3 Receiving an XAUSER_XACT_MTAG_TRANSACTION_NOT_SUSPENDED](#33573-receiving-an-xauserxactmtagtransactionnotsuspended)
        - [3.3.5.7.4 Connection Disconnected](#33574-connection-disconnected)
        - [3.3.5.7.5 Receiving an XAUSER_XACT_MTAG_START_NO_MEM Message](#33575-receiving-an-xauserxactmtagstartnomem-message)
        - [3.3.5.7.6 Receiving an MTAG_CONNECTION_REQ_DENIED Message](#33576-receiving-an-mtagconnectionreqdenied-message)
        - [3.3.5.7.7 Receiving an XAUSER_XACT_MTAG_OPEN_NOT_FOUND Message](#33577-receiving-an-xauserxactmtagopennotfound-message)
    - [3.3.6 Timer Events](#336-timer-events)
    - [3.3.7 Other Local Events](#337-other-local-events)
  - [3.4 XA Resource Manager Bridge Facet Details](#34-xa-resource-manager-bridge-facet-details)
    - [3.4.1 Abstract Data Model](#341-abstract-data-model)
      - [3.4.1.1 CONNTYPE_XATM_OPEN Acceptor States](#3411-conntypexatmopen-acceptor-states)
        - [3.4.1.1.1 Idle](#34111-idle)
        - [3.4.1.1.2 Processing Open Request](#34112-processing-open-request)
        - [3.4.1.1.3 Active](#34113-active)
        - [3.4.1.1.4 Ended](#34114-ended)
        - [3.4.1.1.5 State Diagram](#34115-state-diagram)
      - [3.4.1.2 CONNTYPE_XATM_OPENONEPIPE Acceptor States](#3412-conntypexatmopenonepipe-acceptor-states)
        - [3.4.1.2.1 Idle](#34121-idle)
        - [3.4.1.2.2 Processing Open Request](#34122-processing-open-request)
        - [3.4.1.2.3 Active](#34123-active)
        - [3.4.1.2.4 Processing Close Request](#34124-processing-close-request)
        - [3.4.1.2.5 Ended](#34125-ended)
        - [3.4.1.2.6 State Diagram](#34126-state-diagram)
      - [3.4.1.3 CONNTYPE_XATM_ENLIST Acceptor States](#3413-conntypexatmenlist-acceptor-states)
        - [3.4.1.3.1 Idle](#34131-idle)
        - [3.4.1.3.2 Processing Enlist Request](#34132-processing-enlist-request)
        - [3.4.1.3.3 Ended](#34133-ended)
        - [3.4.1.3.4 State Diagram](#34134-state-diagram)
    - [3.4.2 Timers](#342-timers)
      - [3.4.2.1 Recovery Interval Timer](#3421-recovery-interval-timer)
    - [3.4.3 Initialization](#343-initialization)
      - [3.4.3.1 XA Resource Manager Bridge Facet Initialization](#3431-xa-resource-manager-bridge-facet-initialization)
    - [3.4.4 Higher-Layer Triggered Events](#344-higher-layer-triggered-events)
      - [3.4.4.1 Recovery Event](#3441-recovery-event)
    - [3.4.5 Processing Events and Sequencing Rules](#345-processing-events-and-sequencing-rules)
      - [3.4.5.1 CONNTYPE_XATM_OPEN as Acceptor](#3451-conntypexatmopen-as-acceptor)
        - [3.4.5.1.1 Receiving an XATMUSER_MTAG_RMOPEN Message](#34511-receiving-an-xatmusermtagrmopen-message)
        - [3.4.5.1.2 Connection Disconnected](#34512-connection-disconnected)
      - [3.4.5.2 CONNTYPE_XATM_OPENONEPIPE as Acceptor](#3452-conntypexatmopenonepipe-as-acceptor)
        - [3.4.5.2.1 Receiving an XATMUSER_MTAG_RMOPEN Message](#34521-receiving-an-xatmusermtagrmopen-message)
        - [3.4.5.2.2 Receiving an XATMUSER_MTAG_RMCLOSE Message](#34522-receiving-an-xatmusermtagrmclose-message)
        - [3.4.5.2.3 Connection Disconnected](#34523-connection-disconnected)
      - [3.4.5.3 CONNTYPE_XATM_ENLIST as Acceptor](#3453-conntypexatmenlist-as-acceptor)
        - [3.4.5.3.1 Receiving an XATMUSER_MTAG_ENLIST Message](#34531-receiving-an-xatmusermtagenlist-message)
    - [3.4.6 Timer Events](#346-timer-events)
      - [3.4.6.1 Recovery Interval Timer](#3461-recovery-interval-timer)
    - [3.4.7 Other Local Events](#347-other-local-events)
      - [3.4.7.1 Begin Commit](#3471-begin-commit)
      - [3.4.7.2 Begin Phase One](#3472-begin-phase-one)
      - [3.4.7.3 Begin Rollback](#3473-begin-rollback)
      - [3.4.7.4 Create Subordinate Enlistment Failure](#3474-create-subordinate-enlistment-failure)
      - [3.4.7.5 Create Subordinate Enlistment Success](#3475-create-subordinate-enlistment-success)
      - [3.4.7.6 Recover XA Resource Manager](#3476-recover-xa-resource-manager)
  - [3.5 XA Resource Manager Bridge Details](#35-xa-resource-manager-bridge-details)
    - [3.5.1 Abstract Data Model](#351-abstract-data-model)
      - [3.5.1.1 CONNTYPE_XATM_OPEN Initiator States](#3511-conntypexatmopen-initiator-states)
        - [3.5.1.1.1 Idle](#35111-idle)
        - [3.5.1.1.2 Awaiting Open Response](#35112-awaiting-open-response)
        - [3.5.1.1.3 Active](#35113-active)
        - [3.5.1.1.4 Ended](#35114-ended)
        - [3.5.1.1.5 State Diagram](#35115-state-diagram)
      - [3.5.1.2 CONNTYPE_XATM_OPENONEPIPE Initiator States](#3512-conntypexatmopenonepipe-initiator-states)
        - [3.5.1.2.1 Idle](#35121-idle)
        - [3.5.1.2.2 Awaiting Open Response](#35122-awaiting-open-response)
        - [3.5.1.2.3 Active](#35123-active)
        - [3.5.1.2.4 Awaiting Close Response](#35124-awaiting-close-response)
        - [3.5.1.2.5 Ended](#35125-ended)
        - [3.5.1.2.6 State Diagram](#35126-state-diagram)
      - [3.5.1.3 CONNTYPE_XATM_ENLIST Initiator States](#3513-conntypexatmenlist-initiator-states)
        - [3.5.1.3.1 Idle](#35131-idle)
        - [3.5.1.3.2 Awaiting Enlist Response](#35132-awaiting-enlist-response)
        - [3.5.1.3.3 Ended](#35133-ended)
        - [3.5.1.3.4 State Diagram](#35134-state-diagram)
    ...
    - [3.5.4 Higher-Layer Triggered Events](#354-higher-layer-triggered-events)
      - [3.5.4.1 Register Two-Pipe XA Resource Manager](#3541-register-two-pipe-xa-resource-manager)
      - [3.5.4.2 Unregister Two-Pipe XA Resource Manager](#3542-unregister-two-pipe-xa-resource-manager)
      - [3.5.4.3 Enlist Two-Pipe XA Resource Manager](#3543-enlist-two-pipe-xa-resource-manager)
      - [3.5.4.4 Register One-Pipe XA Resource Manager](#3544-register-one-pipe-xa-resource-manager)
      - [3.5.4.5 Unregister One-Pipe XA Resource Manager](#3545-unregister-one-pipe-xa-resource-manager)
      - [3.5.4.6 Enlist One-Pipe XA Resource Manager](#3546-enlist-one-pipe-xa-resource-manager)
      - [3.5.4.7 Create XID](#3547-create-xid)
    - [3.5.5 Processing Events and Sequencing Rules](#355-processing-events-and-sequencing-rules)
      - [3.5.5.1 CONNTYPE_XATM_OPEN as Initiator](#3551-conntypexatmopen-as-initiator)
        - [3.5.5.1.1 Receiving an XATMUSER_MTAG_RMOPENOK Message](#35511-receiving-an-xatmusermtagrmopenok-message)
        - [3.5.5.1.2 Receiving Other XATMUSER_MTAG_RMOPEN Messages](#35512-receiving-other-xatmusermtagrmopen-messages)
        - [3.5.5.1.3 Connection Disconnected](#35513-connection-disconnected)
      - [3.5.5.2 CONNTYPE_XATM_OPENONEPIPE as Initiator](#3552-conntypexatmopenonepipe-as-initiator)
        - [3.5.5.2.1 Receiving an XATMUSER_MTAG_RMOPENOK Message](#35521-receiving-an-xatmusermtagrmopenok-message)
        - [3.5.5.2.2 Receiving Other XATMUSER_MTAG_RMOPEN Messages](#35522-receiving-other-xatmusermtagrmopen-messages)
        - [3.5.5.2.3 Receiving an XATMUSER_MTAG_RMCLOSEOK Message](#35523-receiving-an-xatmusermtagrmcloseok-message)
        - [3.5.5.2.4 Receiving Other XATMUSER_MTAG_RMCLOSE Messages](#35524-receiving-other-xatmusermtagrmclose-messages)
        - [3.5.5.2.5 Connection Disconnected](#35525-connection-disconnected)
      - [3.5.5.3 CONNTYPE_XATM_ENLIST as Initiator](#3553-conntypexatmenlist-as-initiator)
        - [3.5.5.3.1 Receiving an XATMUSER_MTAG_ENLISTMENTOK or an](#35531-receiving-an-xatmusermtagenlistmentok-or-an)
        - [3.5.5.3.2 Receiving Other XATMUSER_MTAG_RMENLIST Messages](#35532-receiving-other-xatmusermtagrmenlist-messages)
        - [3.5.5.3.3 Connection Disconnected](#35533-connection-disconnected)
    - [3.5.6 Timer Events](#356-timer-events)
    - [3.5.7 Other Local Events](#357-other-local-events)
- [4 Protocol Examples](#4-protocol-examples)
  - [4.1 XA Superior Scenarios](#41-xa-superior-scenarios)
    - [4.1.1 Opening an XA Superior Connection with an XA Subordinate Transaction](#411-opening-an-xa-superior-connection-with-an-xa-subordinate-transaction)
    - [4.1.2 Starting an XA Superior Transaction with an XA Subordinate Transaction](#412-starting-an-xa-superior-transaction-with-an-xa-subordinate-transaction)
    - [4.1.3 XA Superior Two-Phase Commit Scenario](#413-xa-superior-two-phase-commit-scenario)
      - [4.1.3.1 Preparing an XA Superior Transaction with an XA Subordinate Transaction](#4131-preparing-an-xa-superior-transaction-with-an-xa-subordinate-transaction)
      - [4.1.3.2 Committing an XA Superior Transaction with an XA Subordinate Transaction](#4132-committing-an-xa-superior-transaction-with-an-xa-subordinate-transaction)
    - [4.1.4 XA Superior Recovery Scenario](#414-xa-superior-recovery-scenario)
      - [4.1.4.1 Obtaining a List of XA Superior Transactions to Recover with an XA](#4141-obtaining-a-list-of-xa-superior-transactions-to-recover-with-an-xa)
  - [4.2 XA Resource Manager Bridge Facet Scenarios](#42-xa-resource-manager-bridge-facet-scenarios)
    - [4.2.1 Two-Pipe Model](#421-two-pipe-model)
      - [4.2.1.1 Registering a Two-Pipe XA Resource Manager](#4211-registering-a-two-pipe-xa-resource-manager)
      - [4.2.1.2 Enlisting a Two-Pipe XA Resource Manager in an OleTx Transaction](#4212-enlisting-a-two-pipe-xa-resource-manager-in-an-oletx-transaction)
    - [4.2.2 One-Pipe Model](#422-one-pipe-model)
      - [4.2.2.1 Registering a One-Pipe XA Resource Manager](#4221-registering-a-one-pipe-xa-resource-manager)
      - [4.2.2.2 Unregistering a One-Pipe XA Resource Manager](#4222-unregistering-a-one-pipe-xa-resource-manager)
