...
- [2 Messages](#2-messages)
  - [2.1 Transport](#21-transport)
    - [2.1.1 Connection-Oriented RPC Transports](#211-connection-oriented-rpc-transports)
      - [2.1.1.1 TCP/IP (NCACN_IP_TCP)](#2111-tcpip-ncacniptcp)
      - [2.1.1.2 SMB (NCACN_NP)](#2112-smb-ncacnnp)
      - [2.1.1.3 SPX (NCACN_SPX)](#2113-spx-ncacnspx)
      - [2.1.1.4 NetBIOS over IPX (NCACN_NB_IPX)](#2114-netbios-over-ipx-ncacnnbipx)
      - [2.1.1.5 NetBIOS over TCP (NCACN_NB_TCP)](#2115-netbios-over-tcp-ncacnnbtcp)
      - [2.1.1.6 NetBIOS over NetBEUI (NCACN_NB_NB)](#2116-netbios-over-netbeui-ncacnnbnb)
      - [2.1.1.7 AppleTalk (NCACN_AT_DSP)](#2117-appletalk-ncacnatdsp)
      - [2.1.1.8 RPC over HTTP (ncacn_http)](#2118-rpc-over-http-ncacnhttp)
    - [2.1.2 Connectionless RPC Transports](#212-connectionless-rpc-transports)
      - [2.1.2.1 UDP (NCADG_IP_UDP)](#2121-udp-ncadgipudp)
      - [2.1.2.2 Internetwork Packet Exchange (IPX) (NCADG_IPX)](#2122-internetwork-packet-exchange-ipx-ncadgipx)
  - [2.2 Message Syntax](#22-message-syntax)
    - [2.2.1 Connection-Oriented and Connectionless RPC Messages](#221-connection-oriented-and-connectionless-rpc-messages)
      - [2.2.1.1 Common Types and Constants](#2211-common-types-and-constants)
        - [2.2.1.1.1 RPC_IF_ID Type](#22111-rpcifid-type)
        - [2.2.1.1.2 Extended Error Information Signature Value](#22112-extended-error-information-signature-value)
        - [2.2.1.1.3 UUID Format](#22113-uuid-format)
        - [2.2.1.1.4 Mapping of a Context Handle](#22114-mapping-of-a-context-handle)
        - [2.2.1.1.5 version_t](#22115-versiont)
        - [2.2.1.1.6 p_rt_versions_supported_t](#22116-prtversionssupportedt)
        - [2.2.1.1.7 Security Providers](#22117-security-providers)
        - [2.2.1.1.8 Authentication Levels](#22118-authentication-levels)
        - [2.2.1.1.9 Impersonation Level](#22119-impersonation-level)
        - [2.2.1.1.10 Transport-Layer Impersonation Level](#221110-transport-layer-impersonation-level)
      - [2.2.1.2 Endpoint Mapper Interface Extensions](#2212-endpoint-mapper-interface-extensions)
        - [2.2.1.2.1 EPT_S_CANT_PERFORM_OP](#22121-eptscantperformop)
        - [2.2.1.2.2 twr_t Type](#22122-twrt-type)
        - [2.2.1.2.3 error_status Type](#22123-errorstatus-type)
        - [2.2.1.2.4 ept_lookup Method](#22124-eptlookup-method)
        - [2.2.1.2.5 ept_map Method](#22125-eptmap-method)
        - [2.2.1.2.6 ept_insert Method](#22126-eptinsert-method)
        - [2.2.1.2.7 ept_delete Method](#22127-eptdelete-method)
        - [2.2.1.2.8 ept_lookup_handle_free Method](#22128-eptlookuphandlefree-method)
        - [2.2.1.2.9 ept_inq_object Method](#22129-eptinqobject-method)
        - [2.2.1.2.10 ept_mgmt_delete Method](#221210-eptmgmtdelete-method)
        - [2.2.1.2.11 ept_lookup_handle_t Type](#221211-eptlookuphandlet-type)
      - [2.2.1.3 Management Interface Extensions](#2213-management-interface-extensions)
        - [2.2.1.3.1 rpc_if_id_vector_p_t Type](#22131-rpcifidvectorpt-type)
        - [2.2.1.3.2 StatisticsCount Type](#22132-statisticscount-type)
        - [2.2.1.3.3 rpc_mgmt_inq_stats Method](#22133-rpcmgmtinqstats-method)
        - [2.2.1.3.4 rpc_mgmt_inq_princ_name Method](#22134-rpcmgmtinqprincname-method)
    - [2.2.2 Connection-Oriented RPC Messages](#222-connection-oriented-rpc-messages)
      - [2.2.2.1 PDU Segments](#2221-pdu-segments)
      - [2.2.2.2 PFC_MAYBE Flag](#2222-pfcmaybe-flag)
      - [2.2.2.3 PFC_SUPPORT_HEADER_SIGN Flag](#2223-pfcsupportheadersign-flag)
      - [2.2.2.4 negotiate_ack Member of p_cont_def_result_t Enumerator](#2224-negotiateack-member-of-pcontdefresultt-enumerator)
      - [2.2.2.5 New Reasons for Bind Rejection](#2225-new-reasons-for-bind-rejection)
      - [2.2.2.6 alloc_hint Interpretation](#2226-allochint-interpretation)
      - [2.2.2.7 RPC_SYNTAX_IDENTIFIER](#2227-rpcsyntaxidentifier)
      - [2.2.2.8 rpc_fault Packet](#2228-rpcfault-packet)
      - [2.2.2.9 bind_nak Packet](#2229-bindnak-packet)
      - [2.2.2.10 rpc_auth_3 PDU](#22210-rpcauth3-pdu)
      - [2.2.2.11 sec_trailer Structure](#22211-sectrailer-structure)
      - [2.2.2.12 Authentication Tokens](#22212-authentication-tokens)
      - [2.2.2.13 Verification Trailer](#22213-verification-trailer)
        - [2.2.2.13.1 rpc_sec_verification_trailer](#222131-rpcsecverificationtrailer)
        - [2.2.2.13.2 rpc_sec_vt_bitmask](#222132-rpcsecvtbitmask)
        - [2.2.2.13.3 rpc_sec_vt_header2](#222133-rpcsecvtheader2)
        - [2.2.2.13.4 rpc_sec_vt_pcontext](#222134-rpcsecvtpcontext)
      - [2.2.2.14 BindTimeFeatureNegotiationBitmask](#22214-bindtimefeaturenegotiationbitmask)
      - [2.2.2.15 BindTimeFeatureNegotiationResponseBitmask](#22215-bindtimefeaturenegotiationresponsebitmask)
    - [2.2.3 Connectionless RPC Messages](#223-connectionless-rpc-messages)
      - [2.2.3.1 PDU Segments](#2231-pdu-segments)
      - [2.2.3.2 Fault Packet](#2232-fault-packet)
      - [2.2.3.3 PF2_UNRELATED Flag](#2233-pf2unrelated-flag)
      - [2.2.3.4 sec_trailer_cl Structure](#2234-sectrailercl-structure)
      - [2.2.3.5 Authentication Tokens](#2235-authentication-tokens)
      - [2.2.3.6 fack Packet](#2236-fack-packet)
    - [2.2.4 IDL Syntax Extensions](#224-idl-syntax-extensions)
      - [2.2.4.1 New Primitive Types](#2241-new-primitive-types)
        - [2.2.4.1.1 wchar_t](#22411-wchart)
        - [2.2.4.1.2 __int3264](#22412-int3264)
        - [2.2.4.1.3 __int8, __int16, __int32, __int64](#22413-int8-int16-int32-int64)
        - [2.2.4.1.4 int](#22414-int)
      - [2.2.4.2 Callback](#2242-callback)
      - [2.2.4.3 Array of Context Handles](#2243-array-of-context-handles)
      - [2.2.4.4 Array of Strings](#2244-array-of-strings)
      - [2.2.4.5 ms_union](#2245-msunion)
      - [2.2.4.6 v1_enum](#2246-v1enum)
      - [2.2.4.7 Expression in Conformant, Varying, and Union Description](#2247-expression-in-conformant-varying-and-union-description)
      - [2.2.4.8 Unencapsulated Union](#2248-unencapsulated-union)
      - [2.2.4.9 pointer_default](#2249-pointerdefault)
      - [2.2.4.10 Pointer Attributes](#22410-pointer-attributes)
      - [2.2.4.11 Extension to Enumerated Type](#22411-extension-to-enumerated-type)
      - [2.2.4.12 NDR Transfer Syntax Identifier](#22412-ndr-transfer-syntax-identifier)
      - [2.2.4.13 byte_count](#22413-bytecount)
      - [2.2.4.14 range](#22414-range)
        - [2.2.4.14.1 range Attribute to Limit the Scope of Integral Values and the Number of](#224141-range-attribute-to-limit-the-scope-of-integral-values-and-the-number-of)
        - [2.2.4.14.2 range Attribute to Limit the Range of Maximum Count of Conformant](#224142-range-attribute-to-limit-the-range-of-maximum-count-of-conformant)
      - [2.2.4.15 strict_context_handle](#22415-strictcontexthandle)
      - [2.2.4.16 type_strict_context_handle](#22416-typestrictcontexthandle)
      - [2.2.4.17 disable_consistency_check](#22417-disableconsistencycheck)
      - [2.2.4.18 Identifier Length](#22418-identifier-length)
    - [2.2.5 64-Bit Network Data Representation](#225-64-bit-network-data-representation)
      - [2.2.5.1 NDR64 Transfer Syntax Identifier](#2251-ndr64-transfer-syntax-identifier)
      - [2.2.5.2 NDR64 Simple Data Types](#2252-ndr64-simple-data-types)
      - [2.2.5.3 NDR64 Constructed Data Types](#2253-ndr64-constructed-data-types)
        - [2.2.5.3.1 Representation Conventions](#22531-representation-conventions)
        - [2.2.5.3.2 Arrays](#22532-arrays)
          - [2.2.5.3.2.1 Conformant Arrays](#225321-conformant-arrays)
          - [2.2.5.3.2.2 Varying Arrays](#225322-varying-arrays)
          - [2.2.5.3.2.3 Conformant Varying Arrays](#225323-conformant-varying-arrays)
          - [2.2.5.3.2.4 Multidimensional Arrays](#225324-multidimensional-arrays)
        - [2.2.5.3.3 Strings](#22533-strings)
          - [2.2.5.3.3.1 Varying Strings](#225331-varying-strings)
          - [2.2.5.3.3.2 Conformant Varying Strings](#225332-conformant-varying-strings)
        - [2.2.5.3.4 Structures](#22534-structures)
          - [2.2.5.3.4.1 Structure with Trailing Gap](#225341-structure-with-trailing-gap)
          - [2.2.5.3.4.2 Structure Containing a Conformant Array](#225342-structure-containing-a-conformant-array)
          - [2.2.5.3.4.3 Structure Containing a Conformant Varying Array](#225343-structure-containing-a-conformant-varying-array)
          - [2.2.5.3.4.4 Unions](#225344-unions)
          - [2.2.5.3.4.5 Pipes](#225345-pipes)
        - [2.2.5.3.5 Pointers](#22535-pointers)
          - [2.2.5.3.5.1 Embedded Reference Pointers](#225351-embedded-reference-pointers)
    - [2.2.6 Type Serialization Version 1](#226-type-serialization-version-1)
      - [2.2.6.1 Common Type Header for the Serialization Stream](#2261-common-type-header-for-the-serialization-stream)
      - [2.2.6.2 Private Header for Constructed Type](#2262-private-header-for-constructed-type)
      - [2.2.6.3 Primitive Type Serialization](#2263-primitive-type-serialization)
    - [2.2.7 Type Serialization Version 2](#227-type-serialization-version-2)
      - [2.2.7.1 Common Type Header](#2271-common-type-header)
      - [2.2.7.2 Private Header](#2272-private-header)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 Connectionless and Connection-Oriented RPC Protocol Details](#31-connectionless-and-connection-oriented-rpc-protocol-details)
    - [3.1.1 Common Details](#311-common-details)
      - [3.1.1.1 Abstract Data Model](#3111-abstract-data-model)
        - [3.1.1.1.1 Security Context Handle](#31111-security-context-handle)
        - [3.1.1.1.2 Client Credential Handle](#31112-client-credential-handle)
        - [3.1.1.1.3 Authorization Policy](#31113-authorization-policy)
      ...
      - [3.1.1.4 Higher-Layer Triggered Events](#3114-higher-layer-triggered-events)
        - [3.1.1.4.1 Causal Ordering](#31141-causal-ordering)
        - [3.1.1.4.2 Impersonate Client](#31142-impersonate-client)
      - [3.1.1.5 Message Processing Events and Sequencing Rules](#3115-message-processing-events-and-sequencing-rules)
        - [3.1.1.5.1 Processing Extensions Details](#31151-processing-extensions-details)
          - [3.1.1.5.1.1 Extension in NDR Transfer Syntax](#311511-extension-in-ndr-transfer-syntax)
            - [3.1.1.5.1.1.1 __int3264](#3115111-int3264)
            - [3.1.1.5.1.1.2 Binding Handle Extension](#3115112-binding-handle-extension)
        - [3.1.1.5.2 Indicating Octet Stream as Invalid](#31152-indicating-octet-stream-as-invalid)
        - [3.1.1.5.3 Strict NDR/NDR64 Data Consistency Check](#31153-strict-ndrndr64-data-consistency-check)
          - [3.1.1.5.3.1 Correlation Validation](#311531-correlation-validation)
          - [3.1.1.5.3.2 Target Level 5.0](#311532-target-level-50)
            - [3.1.1.5.3.2.1 Correlation Validation Checks](#3115321-correlation-validation-checks)
              - [3.1.1.5.3.2.1.1 Maximum Count of a Conformant Array or Conformant Varying](#31153211-maximum-count-of-a-conformant-array-or-conformant-varying)
              - [3.1.1.5.3.2.1.2 Maximum Count of a Conformant Structure or Conformant Varying](#31153212-maximum-count-of-a-conformant-structure-or-conformant-varying)
              - [3.1.1.5.3.2.1.3 Maximum Count of a Conformant Array or Conformant Varying](#31153213-maximum-count-of-a-conformant-array-or-conformant-varying)
              - [3.1.1.5.3.2.1.4 Maximum Count of a Conformant Structure or Conformant Varying](#31153214-maximum-count-of-a-conformant-structure-or-conformant-varying)
              - [3.1.1.5.3.2.1.5 first_is of a Varying Array or Conformant Varying Array Is](#31153215-firstis-of-a-varying-array-or-conformant-varying-array-is)
              - [3.1.1.5.3.2.1.6 first_is of a Conformant Varying Structure Is Specified by a Field](#31153216-firstis-of-a-conformant-varying-structure-is-specified-by-a-field)
              - [3.1.1.5.3.2.1.7 first_is of a Varying Array, Conformant Varying Array, or](#31153217-firstis-of-a-varying-array-conformant-varying-array-or)
              - [3.1.1.5.3.2.1.8 Actual Count of a Varying Array or Conformant Varying Array Is](#31153218-actual-count-of-a-varying-array-or-conformant-varying-array-is)
              - [3.1.1.5.3.2.1.9 Actual Count of a Conformant Varying Structure Is Dictated by a](#31153219-actual-count-of-a-conformant-varying-structure-is-dictated-by-a)
              - [3.1.1.5.3.2.1.10 Maximum Count of a Conformant and Varying String Is Dictated](#311532110-maximum-count-of-a-conformant-and-varying-string-is-dictated)
              - [3.1.1.5.3.2.1.11 Union Validation](#311532111-union-validation)
              - [3.1.1.5.3.2.1.12 General Conformant Varying Validation](#311532112-general-conformant-varying-validation)
            - [3.1.1.5.3.2.2 Additional Limitations](#3115322-additional-limitations)
              - [3.1.1.5.3.2.2.1 Limiting Maximum Count and Octet Stream Length](#31153221-limiting-maximum-count-and-octet-stream-length)
              - [3.1.1.5.3.2.2.2 strict_context_handle](#31153222-strictcontexthandle)
              - [3.1.1.5.3.2.2.3 Rejecting Insufficient Octet Stream](#31153223-rejecting-insufficient-octet-stream)
              - [3.1.1.5.3.2.2.4 range Attribute to Limit the Scope of Integral Values and the](#31153224-range-attribute-to-limit-the-scope-of-integral-values-and-the)
              - [3.1.1.5.3.2.2.5 auto_handle Deprecation](#31153225-autohandle-deprecation)
              - [3.1.1.5.3.2.2.6 Ignoring Alignment Gap](#31153226-ignoring-alignment-gap)
          - [3.1.1.5.3.3 Target Level 6.0](#311533-target-level-60)
            - [3.1.1.5.3.3.1 Additional Limitations](#3115331-additional-limitations)
              - [3.1.1.5.3.3.1.1 type_strict_context_handle](#31153311-typestrictcontexthandle)
              - [3.1.1.5.3.3.1.2 Unique or Full Pointer to Conformant Array Consistency Check](#31153312-unique-or-full-pointer-to-conformant-array-consistency-check)
              - [3.1.1.5.3.3.1.3 range Attribute to Limit the Range of Maximum Count of](#31153313-range-attribute-to-limit-the-range-of-maximum-count-of)
        - [3.1.1.5.4 Restriction on Remote Anonymous Calls](#31154-restriction-on-remote-anonymous-calls)
        - [3.1.1.5.5 Returning Win32 Error Values](#31155-returning-win32-error-values)
      - [3.1.1.6 Timer Events](#3116-timer-events)
      - [3.1.1.7 Other Local Events](#3117-other-local-events)
    - [3.1.2 Client Details](#312-client-details)
      - [3.1.2.1 Abstract Data Model](#3121-abstract-data-model)
        - [3.1.2.1.1 Server Binding Handle](#31211-server-binding-handle)
      ...
      - [3.1.2.4 Higher-Layer Triggered Events](#3124-higher-layer-triggered-events)
        - [3.1.2.4.1 Set Server Binding Handle Client Credentials](#31241-set-server-binding-handle-client-credentials)
      - [3.1.2.5 Message Processing Events and Sequencing Rules](#3125-message-processing-events-and-sequencing-rules)
        - [3.1.2.5.1 Indicating Invalid Octet Stream on Client](#31251-indicating-invalid-octet-stream-on-client)
      - [3.1.2.6 Timer Events](#3126-timer-events)
      - [3.1.2.7 Other Local Events](#3127-other-local-events)
        - [3.1.2.7.1 Client Conformant Validation Processing for Response Data](#31271-client-conformant-validation-processing-for-response-data)
          - [3.1.2.7.1.1 Maximum Count of a Conformant Array Is Dictated by Another Parameter](#312711-maximum-count-of-a-conformant-array-is-dictated-by-another-parameter)
          - [3.1.2.7.1.2 Offset and/or Actual Count of a Conformant Array Is Dictated by Another](#312712-offset-andor-actual-count-of-a-conformant-array-is-dictated-by-another)
          - [3.1.2.7.1.3 Maximum Count of a Conformant and Varying String Is Dictated by](#312713-maximum-count-of-a-conformant-and-varying-string-is-dictated-by)
          - [3.1.2.7.1.4 Maximum Count of Conformant Varying String Is Not Dictated by Other](#312714-maximum-count-of-conformant-varying-string-is-not-dictated-by-other)
          - [3.1.2.7.1.5 Conformant Structure](#312715-conformant-structure)
          - [3.1.2.7.1.6 Conformant Varying Structure](#312716-conformant-varying-structure)
    - [3.1.3 Server Details](#313-server-details)
      - [3.1.3.1 Abstract Data Model](#3131-abstract-data-model)
        - [3.1.3.1.1 Table of Security Providers](#31311-table-of-security-providers)
      - [3.1.3.2 Timers](#3132-timers)
      - [3.1.3.3 Initialization](#3133-initialization)
        - [3.1.3.3.1 Delay Use of Protocol Sequences on the Endpoint Mapper](#31331-delay-use-of-protocol-sequences-on-the-endpoint-mapper)
      - [3.1.3.4 Higher-Layer Triggered Events](#3134-higher-layer-triggered-events)
        - [3.1.3.4.1 Retrieve Protocol Sequence](#31341-retrieve-protocol-sequence)
        - [3.1.3.4.2 Adding Elements to the Table of Security Providers](#31342-adding-elements-to-the-table-of-security-providers)
      - [3.1.3.5 Message Processing Events and Sequencing Rules](#3135-message-processing-events-and-sequencing-rules)
        - [3.1.3.5.1 Server Stub Memory Allocation Limit](#31351-server-stub-memory-allocation-limit)
        - [3.1.3.5.2 Indicating Invalid Octet Stream in Server](#31352-indicating-invalid-octet-stream-in-server)
        - [3.1.3.5.3 Interpretation of Tower Encodings](#31353-interpretation-of-tower-encodings)
      - [3.1.3.6 Timer Events](#3136-timer-events)
      - [3.1.3.7 Other Local Events](#3137-other-local-events)
  - [3.2 Connectionless RPC Protocol Details](#32-connectionless-rpc-protocol-details)
    - [3.2.1 Common Details](#321-common-details)
      - [3.2.1.1 Abstract Data Model](#3211-abstract-data-model)
        - [3.2.1.1.1 State Machines](#32111-state-machines)
        - [3.2.1.1.2 Send Window (Call)](#32112-send-window-call)
        - [3.2.1.1.3 Receive Window (Call)](#32113-receive-window-call)
      ...
      - [3.2.1.4 Higher-Layer Triggered Events](#3214-higher-layer-triggered-events)
        - [3.2.1.4.1 Building and Using a Security Context](#32141-building-and-using-a-security-context)
          - [3.2.1.4.1.1 Using a Security Context](#321411-using-a-security-context)
        - [3.2.1.4.2 Callbacks](#32142-callbacks)
      - [3.2.1.5 Message Processing Events and Sequencing Rules](#3215-message-processing-events-and-sequencing-rules)
        - [3.2.1.5.1 Authentication](#32151-authentication)
        - [3.2.1.5.2 Overlapped Calls](#32152-overlapped-calls)
        - [3.2.1.5.3 Sliding Window Algorithm](#32153-sliding-window-algorithm)
      - [3.2.1.6 Timer Events](#3216-timer-events)
      - [3.2.1.7 Other Local Events](#3217-other-local-events)
    - [3.2.2 Client Details](#322-client-details)
      - [3.2.2.1 Abstract Data Model](#3221-abstract-data-model)
        - [3.2.2.1.1 Supports PF2_Unrelated Flag](#32211-supports-pf2unrelated-flag)
        - [3.2.2.1.2 Security Provider Identifier](#32212-security-provider-identifier)
        - [3.2.2.1.3 Authentication Level](#32213-authentication-level)
        - [3.2.2.1.4 Activity](#32214-activity)
        - [3.2.2.1.5 Collection of Activities](#32215-collection-of-activities)
        - [3.2.2.1.6 Collection of Inactive Activities](#32216-collection-of-inactive-activities)
        - [3.2.2.1.7 Client Address Space](#32217-client-address-space)
        - [3.2.2.1.8 Table of CASs](#32218-table-of-cass)
        - [3.2.2.1.9 Causal Ordering Flag](#32219-causal-ordering-flag)
        - [3.2.2.1.10 Call](#322110-call)
        - [3.2.2.2.1 for a description of the timer.](#32221-for-a-description-of-the-timer)
        - [3.2.2.2.2 Cancel Time-Out Timer](#32222-cancel-time-out-timer)
        - [3.2.2.2.3 Delayed-Ack Timer](#32223-delayed-ack-timer)
        - [3.2.2.2.4 Context-Handle Keep-Alive Timer](#32224-context-handle-keep-alive-timer)
        - [3.2.2.2.5 Inactive Activity Timer](#32225-inactive-activity-timer)
      - [3.2.2.3 Initialization](#3223-initialization)
        - [3.2.2.3.1 Create a Binding Handle](#32231-create-a-binding-handle)
        - [3.2.2.3.2 Specify Security Settings](#32232-specify-security-settings)
      - [3.2.2.4 Higher-Layer Triggered Events](#3224-higher-layer-triggered-events)
        - [3.2.2.4.1 Make an RPC Method Call](#32241-make-an-rpc-method-call)
          - [3.2.2.4.1.1 Find a CAS](#322411-find-a-cas)
          - [3.2.2.4.1.2 Find an Activity](#322412-find-an-activity)
          - [3.2.2.4.1.3 Find or Create a Security Context](#322413-find-or-create-a-security-context)
          - [3.2.2.4.1.4 Create a Call](#322414-create-a-call)
          - [3.2.2.4.1.5 Queuing Multiple Calls](#322415-queuing-multiple-calls)
        - [3.2.2.4.2 Cancel Requested](#32242-cancel-requested)
      - [3.2.2.5 Message Processing Events and Sequencing Rules](#3225-message-processing-events-and-sequencing-rules)
        - [3.2.2.5.1 REQUEST](#32251-request)
        - [3.2.2.5.2 PING](#32252-ping)
        - [3.2.2.5.3 RESPONSE](#32253-response)
        - [3.2.2.5.4 FAULT](#32254-fault)
        - [3.2.2.5.5 WORKING](#32255-working)
        - [3.2.2.5.6 NOCALL](#32256-nocall)
        - [3.2.2.5.7 REJECT](#32257-reject)
        - [3.2.2.5.8 ACK](#32258-ack)
        - [3.2.2.5.9 QUIT](#32259-quit)
        - [3.2.2.5.10 FACK](#322510-fack)
        - [3.2.2.5.11 QUACK](#322511-quack)
      - [3.2.2.6 Timer Events](#3226-timer-events)
        - [3.2.2.6.1 Inactive Activity Timer](#32261-inactive-activity-timer)
        - [3.2.2.6.2 Context-Handle Keep-Alive Timer](#32262-context-handle-keep-alive-timer)
        - [3.2.2.6.3 Delayed-Ack Timer](#32263-delayed-ack-timer)
      - [3.2.2.7 Other Local Events](#3227-other-local-events)
    - [3.2.3 Server Details](#323-server-details)
      - [3.2.3.1 Abstract Data Model](#3231-abstract-data-model)
        - [3.2.3.1.1 Lowest-Allowed-Sequence Counter](#32311-lowest-allowed-sequence-counter)
        - [3.2.3.1.2 CAS UUID](#32312-cas-uuid)
        - [3.2.3.1.3 Lowest-Unused-Sequence Counter](#32313-lowest-unused-sequence-counter)
        - [3.2.3.1.4 Table of Security Contexts](#32314-table-of-security-contexts)
        - [3.2.3.1.5 Table of Activity IDs](#32315-table-of-activity-ids)
        - [3.2.3.1.6 Table of Client Address Spaces](#32316-table-of-client-address-spaces)
        - [3.2.3.1.7 Table of Active Calls per Activity](#32317-table-of-active-calls-per-activity)
        - [3.2.3.1.8 Call](#32318-call)
        - [3.2.3.1.9 CAS Context Handle List](#32319-cas-context-handle-list)
        - [3.2.3.1.10 Callback State](#323110-callback-state)
      - [3.2.3.2 Timers](#3232-timers)
        - [3.2.3.2.1 Call Fragment Retransmission Timer](#32321-call-fragment-retransmission-timer)
        - [3.2.3.2.2 Idle Scavenger Timer](#32322-idle-scavenger-timer)
      - [3.2.3.3 Initialization](#3233-initialization)
      - [3.2.3.4 Higher-Layer Triggered Events](#3234-higher-layer-triggered-events)
        - [3.2.3.4.1 Failure Semantics](#32341-failure-semantics)
        - [3.2.3.4.2 Retrieving Client Identity](#32342-retrieving-client-identity)
        - [3.2.3.4.3 Context Handle Generation](#32343-context-handle-generation)
      - [3.2.3.5 Message Processing Events and Sequencing Rules](#3235-message-processing-events-and-sequencing-rules)
        - [3.2.3.5.1 Failure Semantics](#32351-failure-semantics)
        - [3.2.3.5.2 Sequencing in Case of Errors](#32352-sequencing-in-case-of-errors)
        - [3.2.3.5.3 Packet Processing](#32353-packet-processing)
        - [3.2.3.5.4 REQUEST](#32354-request)
          - [3.2.3.5.4.1 STATE_INIT](#323541-stateinit)
          - [3.2.3.5.4.2 STATE_RECEIVE_FRAGS](#323542-statereceivefrags)
          - [3.2.3.5.4.3 STATE_WORKING](#323543-stateworking)
          - [3.2.3.5.4.4 STATE_SEND_FRAGS](#323544-statesendfrags)
        - [3.2.3.5.5 PING](#32355-ping)
          - [3.2.3.5.5.1 STATE_INIT](#323551-stateinit)
          - [3.2.3.5.5.2 STATE_RECEIVE_FRAGS](#323552-statereceivefrags)
          - [3.2.3.5.5.3 STATE_WORKING](#323553-stateworking)
          - [3.2.3.5.5.4 STATE_SEND_FRAGS](#323554-statesendfrags)
        - [3.2.3.5.6 FACK](#32356-fack)
        - [3.2.3.5.7 QUIT](#32357-quit)
        - [3.2.3.5.8 ACK](#32358-ack)
      - [3.2.3.6 Timer Events](#3236-timer-events)
        - [3.2.3.6.1 Idle Scavenger Timer Expiry](#32361-idle-scavenger-timer-expiry)
      - [3.2.3.7 Other Local Events](#3237-other-local-events)
  - [3.3 Connection-Oriented RPC Protocol Details](#33-connection-oriented-rpc-protocol-details)
    - [3.3.1 Common Details](#331-common-details)
      - [3.3.1.1 Abstract Data Model](#3311-abstract-data-model)
        - [3.3.1.1.1 Association](#33111-association)
        - [3.3.1.1.2 Connection](#33112-connection)
        - [3.3.1.1.3 Connection Multiplex Flag](#33113-connection-multiplex-flag)
        - [3.3.1.1.4 List of Connections](#33114-list-of-connections)
        - [3.3.1.1.5 Table of Associations](#33115-table-of-associations)
        - [3.3.1.1.6 Table of Security Provider Info](#33116-table-of-security-provider-info)
      ...
      - [3.3.1.4 Higher-Layer Triggered Events](#3314-higher-layer-triggered-events)
        - [3.3.1.4.1 Context Handle Scope](#33141-context-handle-scope)
      - [3.3.1.5 Message Processing Events and Sequencing Rules](#3315-message-processing-events-and-sequencing-rules)
        - [3.3.1.5.1 Protocol Version Number](#33151-protocol-version-number)
        - [3.3.1.5.2 Building and Using a Security Context](#33152-building-and-using-a-security-context)
          - [3.3.1.5.2.1 Building a Security Context](#331521-building-a-security-context)
          - [3.3.1.5.2.2 Using a Security Context](#331522-using-a-security-context)
        - [3.3.1.5.3 Bind Time Feature Negotiation](#33153-bind-time-feature-negotiation)
        - [3.3.1.5.4 Security Context Multiplexing](#33154-security-context-multiplexing)
        - [3.3.1.5.5 Primary and Secondary Endpoint Address](#33155-primary-and-secondary-endpoint-address)
        - [3.3.1.5.6 Presentation Context and Transfer Syntax Negotiation](#33156-presentation-context-and-transfer-syntax-negotiation)
        - [3.3.1.5.7 Adding a New RPC Transport Connection to an Association](#33157-adding-a-new-rpc-transport-connection-to-an-association)
        - [3.3.1.5.8 Multiplexed Connections](#33158-multiplexed-connections)
        - [3.3.1.5.9 Handling of Callbacks](#33159-handling-of-callbacks)
        - [3.3.1.5.10 Keeping Connections Open After Client Sends an Orphaned PDU](#331510-keeping-connections-open-after-client-sends-an-orphaned-pdu)
      - [3.3.1.6 Timer Events](#3316-timer-events)
      - [3.3.1.7 Other Local Events](#3317-other-local-events)
    - [3.3.2 Client Details](#332-client-details)
      - [3.3.2.1 Abstract Data Model](#3321-abstract-data-model)
        - [3.3.2.1.1 Idle Connection Cleanup Enabled](#33211-idle-connection-cleanup-enabled)
        - [3.3.2.1.2 Association Active Context Handle Count](#33212-association-active-context-handle-count)
        - [3.3.2.1.3 Client Call](#33213-client-call)
        - [3.3.2.1.4 Client Connection](#33214-client-connection)
        - [3.3.2.1.5 Server Binding Handle](#33215-server-binding-handle)
      - [3.3.2.2 Timers](#3322-timers)
        - [3.3.2.2.1 Connection Time-Out Timer](#33221-connection-time-out-timer)
        - [3.3.2.2.2 Communication Time-Out Timer](#33222-communication-time-out-timer)
        - [3.3.2.2.3 Idle Connection Cleanup Timer](#33223-idle-connection-cleanup-timer)
      - [3.3.2.3 Initialization](#3323-initialization)
        - [3.3.2.3.1 Create a Binding Handle](#33231-create-a-binding-handle)
        - [3.3.2.3.2 Specify Security Settings](#33232-specify-security-settings)
      - [3.3.2.4 Higher-Layer Triggered Events](#3324-higher-layer-triggered-events)
        - [3.3.2.4.1 Make a Remote Procedure Method Call](#33241-make-a-remote-procedure-method-call)
          - [3.3.2.4.1.1 Resolve the Binding Handle](#332411-resolve-the-binding-handle)
          - [3.3.2.4.1.2 Find an Association and a Connection](#332412-find-an-association-and-a-connection)
          - [3.3.2.4.1.3 Build Security/Presentation Context](#332413-build-securitypresentation-context)
          - [3.3.2.4.1.4 Enable Idle Connection Timeout](#332414-enable-idle-connection-timeout)
        - [3.3.2.4.2 Release Context Handle](#33242-release-context-handle)
      - [3.3.2.5 Message Processing Events and Sequencing Rules](#3325-message-processing-events-and-sequencing-rules)
        - [3.3.2.5.1 rpc_fault PDU Processing Rules](#33251-rpcfault-pdu-processing-rules)
        - [3.3.2.5.2 Handling Responses](#33252-handling-responses)
      - [3.3.2.6 Timer Events](#3326-timer-events)
        - [3.3.2.6.1 Communication Time-Out Timer](#33261-communication-time-out-timer)
        - [3.3.2.6.2 Idle Connection Cleanup Timer Expiry](#33262-idle-connection-cleanup-timer-expiry)
        - [3.3.2.6.3 Endpoint Mapper Requests Security Information](#33263-endpoint-mapper-requests-security-information)
      - [3.3.2.7 Other Local Events](#3327-other-local-events)
        - [3.3.2.7.1 Transport Connection Time-Out](#33271-transport-connection-time-out)
    - [3.3.3 Server Details](#333-server-details)
      - [3.3.3.1 Abstract Data Model](#3331-abstract-data-model)
        - [3.3.3.1.1 Server Connection](#33311-server-connection)
        - [3.3.3.1.2 Number of Registered Interfaces](#33312-number-of-registered-interfaces)
        - [3.3.3.1.3 Preferred Transfer Syntax](#33313-preferred-transfer-syntax)
        - [3.3.3.1.4 Supported Transfer Syntaxes](#33314-supported-transfer-syntaxes)
        - [3.3.3.1.5 Server Call](#33315-server-call)
      - [3.3.3.2 Timers](#3332-timers)
        - [3.3.3.2.1 Connection Time-Out](#33321-connection-time-out)
      - [3.3.3.3 Initialization](#3333-initialization)
        - [3.3.3.3.1 Server-Side Initialization](#33331-server-side-initialization)
          - [3.3.3.3.1.1 Registering a Protocol Sequence by a Higher-Level Protocol](#333311-registering-a-protocol-sequence-by-a-higher-level-protocol)
          - [3.3.3.3.1.2 Registering an Interface by a Higher-Level Protocol](#333312-registering-an-interface-by-a-higher-level-protocol)
          - [3.3.3.3.1.3 Registering a Security Provider by a Higher-Level Protocol](#333313-registering-a-security-provider-by-a-higher-level-protocol)
          - [3.3.3.3.1.4 Registering a Dynamic Endpoint with Endpoint Mapper](#333314-registering-a-dynamic-endpoint-with-endpoint-mapper)
          - [3.3.3.3.1.5 Start Listening](#333315-start-listening)
      - [3.3.3.4 Higher-Layer Triggered Events](#3334-higher-layer-triggered-events)
        - [3.3.3.4.1 Failure Semantics](#33341-failure-semantics)
        - [3.3.3.4.2 shutdown PDUs](#33342-shutdown-pdus)
        - [3.3.3.4.3 Retrieve the Client Identity and Authorization Information](#33343-retrieve-the-client-identity-and-authorization-information)
          - [3.3.3.4.3.1 Abstract Interface GetRpcImpersonationAccessToken](#333431-abstract-interface-getrpcimpersonationaccesstoken)
          - [3.3.3.4.3.2 Abstract Interface RpcImpersonateClient](#333432-abstract-interface-rpcimpersonateclient)
          - [3.3.3.4.3.3 Abstract Interface RpcRevertToSelf](#333433-abstract-interface-rpcreverttoself)
      - [3.3.3.5 Message Processing Events and Sequencing Rules](#3335-message-processing-events-and-sequencing-rules)
        - [3.3.3.5.1 Failure Semantics](#33351-failure-semantics)
        - [3.3.3.5.2 call_id Field Must Increase Monotonically](#33352-callid-field-must-increase-monotonically)
        - [3.3.3.5.3 Unknown Security Provider](#33353-unknown-security-provider)
        - [3.3.3.5.4 Maximum Server Input Data Size](#33354-maximum-server-input-data-size)
        - [3.3.3.5.5 Limits of Presentation Contexts Negotiated](#33355-limits-of-presentation-contexts-negotiated)
        - [3.3.3.5.6 Dropping Packets for Old Calls](#33356-dropping-packets-for-old-calls)
        - [3.3.3.5.7 Handling Protocol Errors](#33357-handling-protocol-errors)
        - [3.3.3.5.8 Sequencing in Case of Errors](#33358-sequencing-in-case-of-errors)
      - [3.3.3.6 Timer Events](#3336-timer-events)
      - [3.3.3.7 Other Local Events](#3337-other-local-events)
        - [3.3.3.7.1 Transport Connection Shutdown](#33371-transport-connection-shutdown)
        - [3.3.3.7.2 Initialize Server Call Object Reference](#33372-initialize-server-call-object-reference)
- [4 Protocol Examples](#4-protocol-examples)
  - [4.1 Packet Sequence for Secure, Connection-Oriented RPC Using Kerberos as](#41-packet-sequence-for-secure-connection-oriented-rpc-using-kerberos-as)
  - [4.2 Packet Sequence for Secure, Connection-Oriented RPC Using NTLM as Security](#42-packet-sequence-for-secure-connection-oriented-rpc-using-ntlm-as-security)
  - [4.3 Packet Sequence of the First Non-Idempotent RPCs of a Connectionless Activity](#43-packet-sequence-of-the-first-non-idempotent-rpcs-of-a-connectionless-activity)
  - [4.4 Connectionless RPCs With and Without a Delayed ACK](#44-connectionless-rpcs-with-and-without-a-delayed-ack)
  - [4.5 Connectionless Client Communicating with a Dynamic Server Endpoint](#45-connectionless-client-communicating-with-a-dynamic-server-endpoint)
  - [4.6 Correlation Example](#46-correlation-example)
  - [4.7 UNICODE_STRING Representation](#47-unicodestring-representation)
  - [4.8 Example of Structure with Trailing Gap in NDR64](#48-example-of-structure-with-trailing-gap-in-ndr64)
- [5 Security](#5-security)
  - [5.1 Security Considerations for Implementers](#51-security-considerations-for-implementers)
    - [5.1.1 Authentication Levels](#511-authentication-levels)
    - [5.1.2 Preferred Security Providers](#512-preferred-security-providers)
    - [5.1.3 Impersonation Levels](#513-impersonation-levels)
  - [5.2 Index of Security Parameters](#52-index-of-security-parameters)
- [6 Appendix A: Full Remote Procedure Call Extensions IDL](#6-appendix-a-full-remote-procedure-call-extensions-idl)
- [7 Appendix B: Product Behavior](#7-appendix-b-product-behavior)
- [8 Appendix C: RPC Extensions Conformance to [C706] Requirements](#8-appendix-c-rpc-extensions-conformance-to-c706-requirements)
  - [8.1 Local Interfaces](#81-local-interfaces)
  - [8.2 Implicit and NULL Binding Handles](#82-implicit-and-null-binding-handles)
...
###### 2.2.4.14.1 range Attribute to Limit the Scope of Integral Values and the Number of
...
###### 2.2.4.14.2 range Attribute to Limit the Range of Maximum Count of Conformant
...
###### 3.1.1.5.3.2.1.1 Maximum Count of a Conformant Array or Conformant Varying
...
###### 3.1.1.5.3.2.1.2 Maximum Count of a Conformant Structure or Conformant Varying
...
###### 3.1.1.5.3.2.1.3 Maximum Count of a Conformant Array or Conformant Varying
...
###### 3.1.1.5.3.2.1.4 Maximum Count of a Conformant Structure or Conformant Varying
...
###### 3.1.1.5.3.2.1.5 first_is of a Varying Array or Conformant Varying Array Is
...
###### 3.1.1.5.3.2.1.6 first_is of a Conformant Varying Structure Is Specified by a Field
...
###### 3.1.1.5.3.2.1.7 first_is of a Varying Array, Conformant Varying Array, or
...
###### 3.1.1.5.3.2.1.8 Actual Count of a Varying Array or Conformant Varying Array Is
...
###### 3.1.1.5.3.2.1.9 Actual Count of a Conformant Varying Structure Is Dictated by a
...
###### 3.1.1.5.3.2.2.2 strict_context_handle
...
###### 3.1.1.5.3.2.2.4 range Attribute to Limit the Scope of Integral Values and the
...
###### 3.1.1.5.3.2.2.5 auto_handle Deprecation
...
###### 3.1.1.5.3.3.1.1 type_strict_context_handle
...
###### 3.1.1.5.3.3.1.3 range Attribute to Limit the Range of Maximum Count of
