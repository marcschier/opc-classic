...
![Extracted image 1 from page 1](OPC-DX-1.00.images/page001-img01.png)
<!-- /Extracted images from page 1 -->
...
![Extracted image 1 from page 2](OPC-DX-1.00.images/page002-img01.png)
<!-- /Extracted images from page 2 -->
...
![Extracted image 1 from page 3](OPC-DX-1.00.images/page003-img01.png)
<!-- /Extracted images from page 3 -->
...
![Extracted image 1 from page 4](OPC-DX-1.00.images/page004-img01.png)
<!-- /Extracted images from page 4 -->
...
![Extracted image 1 from page 5](OPC-DX-1.00.images/page005-img01.png)
<!-- /Extracted images from page 5 -->
...
- [3. Architectural Overview](#3-architectural-overview)
  ...
  - [3.2 Server Model](#32-server-model)
  - [3.3 OPC Data eXchange Server Security](#33-opc-data-exchange-server-security)
- [4. DX Database](#4-dx-database)
  - [4.1 DX Database Root](#41-dx-database-root)
  - [4.2 ServerStatus](#42-serverstatus)
    - [4.2.1 ConfigurationVersion](#421-configurationversion)
    - [4.2.2 ServerState](#422-serverstate)
    - [4.2.3 DXConnectionCount](#423-dxconnectioncount)
    - [4.2.4 MaxDXConnections](#424-maxdxconnections)
    - [4.2.5 DirtyFlag](#425-dirtyflag)
    - [4.2.6 ErrorID](#426-errorid)
    - [4.2.7 ErrorDiagnostic](#427-errordiagnostic)
    - [4.2.8 SourceServerTypes](#428-sourceservertypes)
    - [4.2.9 MaxQueueSize](#429-maxqueuesize)
  - [4.3 DXConnectionsRoot](#43-dxconnectionsroot)
    - [4.3.1 <Branch>](#431-branch)
      - [4.3.1.1 Status](#4311-status)
        - [4.3.1.1.1 Overridden](#43111-overridden)
        - [4.3.1.1.2 SourceItemConnected](#43112-sourceitemconnected)
        - [4.3.1.1.3 TargetItemConnected](#43113-targetitemconnected)
    - [4.3.2 DXConnection](#432-dxconnection)
      - [4.3.2.1 Version](#4321-version)
      - [4.3.2.2 Description](#4322-description)
      - [4.3.2.3 Keyword](#4323-keyword)
      - [4.3.2.4 DefaultSourceItemConnected](#4324-defaultsourceitemconnected)
      - [4.3.2.5 DefaultTargetItemConnected](#4325-defaulttargetitemconnected)
      - [4.3.2.6 DefaultOverridden](#4326-defaultoverridden)
      - [4.3.2.7 DefaultOverrideValue](#4327-defaultoverridevalue)
      - [4.3.2.8 SubstituteValue](#4328-substitutevalue)
      - [4.3.2.9 EnableSubstituteValue](#4329-enablesubstitutevalue)
      - [4.3.2.10 TargetItemPath](#43210-targetitempath)
      - [4.3.2.11 TargetItemName](#43211-targetitemname)
      - [4.3.2.12 SourceServerName](#43212-sourceservername)
      - [4.3.2.13 SourceItemPath](#43213-sourceitempath)
      - [4.3.2.14 SourceItemName](#43214-sourceitemname)
      - [4.3.2.15 QueueSize](#43215-queuesize)
      - [4.3.2.16 UpdateRate](#43216-updaterate)
      - [4.3.2.17 Deadband](#43217-deadband)
      - [4.3.2.18 VendorData](#43218-vendordata)
      - [4.3.2.19 Status](#43219-status)
        - [4.3.2.19.1 DXConnectionState](#432191-dxconnectionstate)
        - [4.3.2.19.2 WriteValue](#432192-writevalue)
        - [4.3.2.19.3 WriteTimestamp](#432193-writetimestamp)
        - [4.3.2.19.4 WriteQuality](#432194-writequality)
        - [4.3.2.19.5 WriteErrorID](#432195-writeerrorid)
        - [4.3.2.19.6 WriteErrorDiagnostic](#432196-writeerrordiagnostic)
        - [4.3.2.19.7 SourceValue](#432197-sourcevalue)
        - [4.3.2.19.8 SourceTimestamp](#432198-sourcetimestamp)
        - [4.3.2.19.9 SourceQuality](#432199-sourcequality)
        - [4.3.2.19.10 SourceErrorID](#4321910-sourceerrorid)
        - [4.3.2.19.11 SourceErrorDiagnostic](#4321911-sourceerrordiagnostic)
        - [4.3.2.19.12 ActualUpdateRate](#4321912-actualupdaterate)
        - [4.3.2.19.13 QueueHighWaterMark](#4321913-queuehighwatermark)
        - [4.3.2.19.14 QueueFlushCount](#4321914-queueflushcount)
        - [4.3.2.19.15 SourceItemConnected](#4321915-sourceitemconnected)
        - [4.3.2.19.16 TargetItemConnected](#4321916-targetitemconnected)
        - [4.3.2.19.17 Overridden](#4321917-overridden)
        - [4.3.2.19.18 OverrideValue](#4321918-overridevalue)
  - [4.4 Version: 1.0](#44-version-10)
    - [4.4.1 SourceServer](#441-sourceserver)
      - [4.4.1.1 Version](#4411-version)
      - [4.4.1.2 Description](#4412-description)
      - [4.4.1.3 ServerType](#4413-servertype)
      - [4.4.1.4 ServerURL](#4414-serverurl)
      - [4.4.1.5 DefaultSourceServerConnected](#4415-defaultsourceserverconnected)
      - [4.4.1.6 Status](#4416-status)
        - [4.4.1.6.1 ConnectStatus](#44161-connectstatus)
        - [4.4.1.6.2 ErrorID](#44162-errorid)
        - [4.4.1.6.3 ErrorDiagnostic](#44163-errordiagnostic)
        - [4.4.1.6.4 LastConnectTimestamp](#44164-lastconnecttimestamp)
        - [4.4.1.6.5 LastConnectFailTimestamp](#44165-lastconnectfailtimestamp)
        - [4.4.1.6.6 ConnectFailCount](#44166-connectfailcount)
        - [4.4.1.6.7 PingTime](#44167-pingtime)
        - [4.4.1.6.8 LastDataChangeTimestamp](#44168-lastdatachangetimestamp)
        - [4.4.1.6.9 SourceServerConnected](#44169-sourceserverconnected)
- [5. OPC DX Configuration Services](#5-opc-dx-configuration-services)
  - [5.1 Parameter Definitions](#51-parameter-definitions)
    - [5.1.1 BrowsePath](#511-browsepath)
    - [5.1.2 DXConnection](#512-dxconnection)
    - [5.1.3 DXGeneralResponse](#513-dxgeneralresponse)
    - [5.1.4 IdentifiedResult](#514-identifiedresult)
    - [5.1.5 ItemIdentifier](#515-itemidentifier)
    - [5.1.6 NodeName](#516-nodename)
    - [5.1.7 ResultCode](#517-resultcode)
    - [5.1.8 Source Server](#518-source-server)
  - [5.2 OPC DX Services](#52-opc-dx-services)
    - [5.2.1 Source Server Services](#521-source-server-services)
      - [5.2.1.1 GetServers](#5211-getservers)
        - [5.2.1.1.1 GetServers Request](#52111-getservers-request)
        - [5.2.1.1.2 GetServers Response](#52112-getservers-response)
      - [5.2.1.2 AddServers](#5212-addservers)
        - [5.2.1.2.1 AddServers Request](#52121-addservers-request)
        - [5.2.1.2.2 AddServers Response](#52122-addservers-response)
      - [5.2.1.3 ModifyServers](#5213-modifyservers)
        - [5.2.1.3.1 ModifyServers Request](#52131-modifyservers-request)
        - [5.2.1.3.2 ModifyServers Response](#52132-modifyservers-response)
      - [5.2.1.4 DeleteServers](#5214-deleteservers)
        - [5.2.1.4.1 DeleteServers Request](#52141-deleteservers-request)
        - [5.2.1.4.2 DeleteServers Response](#52142-deleteservers-response)
      - [5.2.1.5 CopyDefaultServerAttributes](#5215-copydefaultserverattributes)
        - [5.2.1.5.1 CopyDefaultServerAttributes Request](#52151-copydefaultserverattributes-request)
        - [5.2.1.5.2 CopyDefaultServerAttributes Response](#52152-copydefaultserverattributes-response)
    - [5.2.2 DXConnection Services](#522-dxconnection-services)
      - [5.2.2.1 QueryDXConnections](#5221-querydxconnections)
        - [5.2.2.1.1 QueryDXConnections Request](#52211-querydxconnections-request)
        - [5.2.2.1.2 QueryDXConnections Response](#52212-querydxconnections-response)
      - [5.2.2.2 AddDXConnections](#5222-adddxconnections)
        - [5.2.2.2.1 AddDXConnections Request](#52221-adddxconnections-request)
        - [5.2.2.2.2 AddDXConnections Response](#52222-adddxconnections-response)
      - [5.2.2.3 UpdateDXConnections](#5223-updatedxconnections)
        - [5.2.2.3.1 UpdateDXConnections Request](#52231-updatedxconnections-request)
        - [5.2.2.3.2 UpdateDXConnections Response](#52232-updatedxconnections-response)
      - [5.2.2.4 ModifyDXConnections](#5224-modifydxconnections)
        - [5.2.2.4.1 ModifyDXConnections Request](#52241-modifydxconnections-request)
        - [5.2.2.4.2 ModifyDXConnections Response](#52242-modifydxconnections-response)
      - [5.2.2.5 DeleteDXConnections](#5225-deletedxconnections)
        - [5.2.2.5.1 DeleteDXConnections Request](#52251-deletedxconnections-request)
        - [5.2.2.5.2 DeleteDXConnections Response](#52252-deletedxconnections-response)
      - [5.2.2.6 CopyDefaultDXConnectionAttributes](#5226-copydefaultdxconnectionattributes)
        - [5.2.2.6.1 CopyDefaultDXConnectionAttributes Request](#52261-copydefaultdxconnectionattributes-request)
        - [5.2.2.6.2 CopyDefaultDXConnectionAttributes Response](#52262-copydefaultdxconnectionattributes-response)
    - [5.2.3 ResetConfiguration](#523-resetconfiguration)
      - [5.2.3.1 ResetConfiguration Request](#5231-resetconfiguration-request)
      - [5.2.3.2 ResetConfiguration Response](#5232-resetconfiguration-response)
  - [5.3 Persistence](#53-persistence)
- [6. OPC DX Runtime Model](#6-opc-dx-runtime-model)
  - [6.1 DX Startup](#61-dx-startup)
  - [6.2 Establishing and Maintaining Connections to Source Servers](#62-establishing-and-maintaining-connections-to-source-servers)
    - [6.2.1 Opening a Connection to a Source Server](#621-opening-a-connection-to-a-source-server)
      - [6.2.1.1 Security](#6211-security)
    - [6.2.2 Modifying a Connection to a Server](#622-modifying-a-connection-to-a-server)
    - [6.2.3 Recovering Connections to Source Servers](#623-recovering-connections-to-source-servers)
    - [6.2.4 Closing Connections to Source Servers](#624-closing-connections-to-source-servers)
  - [6.3 Transferring Data on DXConnections](#63-transferring-data-on-dxconnections)
    - [6.3.1 Maintaining DXConnections](#631-maintaining-dxconnections)
      - [6.3.1.1 Managing Subscriptions](#6311-managing-subscriptions)
        - [6.3.1.1.1 Creating Subscriptions](#63111-creating-subscriptions)
        - [6.3.1.1.2 Activating and Deactivating DXConnections Within a Subscription](#63112-activating-and-deactivating-dxconnections-within-a-subscription)
        - [6.3.1.1.3 Handling Subscription Errors](#63113-handling-subscription-errors)
      - [6.3.1.2 Adding DXConnections](#6312-adding-dxconnections)
      - [6.3.1.3 Modifying DXConnections](#6313-modifying-dxconnections)
      - [6.3.1.4 Deleting DXConnections](#6314-deleting-dxconnections)
    - [6.3.2 Runtime Controls](#632-runtime-controls)
    - [6.3.3 Queueing Source Data](#633-queueing-source-data)
    - [6.3.4 Data Conversion](#634-data-conversion)
    - [6.3.5 Updating Target Values](#635-updating-target-values)
      - [6.3.5.1 Target Update Truth Table](#6351-target-update-truth-table)
      - [6.3.5.2 Relationship to DXConnection States](#6352-relationship-to-dxconnection-states)
      - [6.3.5.3 TargetErrorID Runtime Behavior](#6353-targeterrorid-runtime-behavior)
  - [6.4 Status and Monitoring](#64-status-and-monitoring)
  - [6.5 DX Shutdown](#65-dx-shutdown)
- [Appendix A Web Services Implementation](#appendix-a-web-services-implementation)
  - [A.1 Implementation Guidelines](#a1-implementation-guidelines)
    - [A.1.1 Error Handling](#a11-error-handling)
    - [A.1.2 Locale Ids and Verbose Errors](#a12-locale-ids-and-verbose-errors)
  - [A.2 Mapping of Parameters and Services](#a2-mapping-of-parameters-and-services)
    - [A.2.1 Parameter Definitions](#a21-parameter-definitions)
      - [A.2.1.1 DXConnection](#a211-dxconnection)
      - [A.2.1.2 DXGeneralResponse](#a212-dxgeneralresponse)
      - [A.2.1.3 IdentifiedResult](#a213-identifiedresult)
      - [A.2.1.4 ItemIdentifier](#a214-itemidentifier)
      - [A.2.1.5 SourceServer](#a215-sourceserver)
    - [A.2.2 OPC DX Services](#a22-opc-dx-services)
      - [A.2.2.1 Server Services](#a221-server-services)
        - [A.2.2.1.1 GetServers](#a2211-getservers)
        - [A.2.2.1.2 AddServers](#a2212-addservers)
        - [A.2.2.1.3 ModifyServers](#a2213-modifyservers)
        - [A.2.2.1.4 DeleteServers](#a2214-deleteservers)
        - [A.2.2.1.5 CopyDefaultServerAttributes](#a2215-copydefaultserverattributes)
      - [A.2.2.2 DXConnection Services](#a222-dxconnection-services)
        - [A.2.2.2.1 QueryDXConnections](#a2221-querydxconnections)
        - [A.2.2.2.2 AddDXConnections](#a2222-adddxconnections)
        - [A.2.2.2.3 UpdateDXConnections](#a2223-updatedxconnections)
        - [A.2.2.2.4 ModifyDXConnections](#a2224-modifydxconnections)
        - [A.2.2.2.5 DeleteDXConnections](#a2225-deletedxconnections)
        - [A.2.2.2.6 CopyDefaultDXConnectionsAttributes](#a2226-copydefaultdxconnectionsattributes)
      - [A.2.2.3 ResetConfiguration](#a223-resetconfiguration)
  - [B.1 Implementation Guidelines](#b1-implementation-guidelines)
    - [B.1.1 Error Handling](#b11-error-handling)
    - [B.1.2 Locale Ids and Verbose Errors](#b12-locale-ids-and-verbose-errors)
    - [B.1.3 Masks in Structures](#b13-masks-in-structures)
    - [B.1.4 IDL](#b14-idl)
...
![Extracted image 1 from page 10](OPC-DX-1.00.images/page010-img01.png)
<!-- /Extracted images from page 10 -->
...
![Extracted image 1 from page 11](OPC-DX-1.00.images/page011-img01.png)
<!-- /Extracted images from page 11 -->
...
![Extracted image 1 from page 12](OPC-DX-1.00.images/page012-img01.png)
<!-- /Extracted images from page 12 -->
...
![Extracted image 1 from page 13](OPC-DX-1.00.images/page013-img01.png)
<!-- /Extracted images from page 13 -->
...
![Extracted image 1 from page 14](OPC-DX-1.00.images/page014-img01.png)
<!-- /Extracted images from page 14 -->
...
![Extracted image 1 from page 15](OPC-DX-1.00.images/page015-img01.png)
<!-- /Extracted images from page 15 -->
...
![Extracted image 1 from page 16](OPC-DX-1.00.images/page016-img01.png)
<!-- /Extracted images from page 16 -->
...
![Extracted image 1 from page 17](OPC-DX-1.00.images/page017-img01.png)
<!-- /Extracted images from page 17 -->
...
![Extracted image 1 from page 18](OPC-DX-1.00.images/page018-img01.png)
<!-- /Extracted images from page 18 -->
...
![Extracted image 1 from page 19](OPC-DX-1.00.images/page019-img01.png)
<!-- /Extracted images from page 19 -->
...
![Extracted image 1 from page 20](OPC-DX-1.00.images/page020-img01.png)
<!-- /Extracted images from page 20 -->
...
![Extracted image 1 from page 21](OPC-DX-1.00.images/page021-img01.png)
<!-- /Extracted images from page 21 -->
...
![Extracted image 1 from page 22](OPC-DX-1.00.images/page022-img01.png)
<!-- /Extracted images from page 22 -->
...
![Extracted image 1 from page 23](OPC-DX-1.00.images/page023-img01.png)
<!-- /Extracted images from page 23 -->
...
![Extracted image 1 from page 24](OPC-DX-1.00.images/page024-img01.png)
<!-- /Extracted images from page 24 -->
...
![Extracted image 1 from page 25](OPC-DX-1.00.images/page025-img01.png)
<!-- /Extracted images from page 25 -->
...
![Extracted image 1 from page 26](OPC-DX-1.00.images/page026-img01.png)
<!-- /Extracted images from page 26 -->
...
![Extracted image 1 from page 27](OPC-DX-1.00.images/page027-img01.png)
<!-- /Extracted images from page 27 -->
...
![Extracted image 1 from page 28](OPC-DX-1.00.images/page028-img01.png)
<!-- /Extracted images from page 28 -->
...
![Extracted image 1 from page 29](OPC-DX-1.00.images/page029-img01.png)
<!-- /Extracted images from page 29 -->
...
![Extracted image 1 from page 30](OPC-DX-1.00.images/page030-img01.png)
<!-- /Extracted images from page 30 -->
...
![Extracted image 1 from page 31](OPC-DX-1.00.images/page031-img01.png)
<!-- /Extracted images from page 31 -->
...
![Extracted image 1 from page 32](OPC-DX-1.00.images/page032-img01.png)
<!-- /Extracted images from page 32 -->
...
![Extracted image 1 from page 33](OPC-DX-1.00.images/page033-img01.png)
<!-- /Extracted images from page 33 -->
...
![Extracted image 1 from page 34](OPC-DX-1.00.images/page034-img01.png)
<!-- /Extracted images from page 34 -->
...
![Extracted image 1 from page 35](OPC-DX-1.00.images/page035-img01.png)
<!-- /Extracted images from page 35 -->
...
![Extracted image 1 from page 36](OPC-DX-1.00.images/page036-img01.png)
<!-- /Extracted images from page 36 -->
...
![Extracted image 1 from page 37](OPC-DX-1.00.images/page037-img01.png)
<!-- /Extracted images from page 37 -->
...
![Extracted image 1 from page 38](OPC-DX-1.00.images/page038-img01.png)
<!-- /Extracted images from page 38 -->
...
![Extracted image 1 from page 39](OPC-DX-1.00.images/page039-img01.png)
<!-- /Extracted images from page 39 -->
...
![Extracted image 1 from page 40](OPC-DX-1.00.images/page040-img01.png)
<!-- /Extracted images from page 40 -->
...
![Extracted image 1 from page 41](OPC-DX-1.00.images/page041-img01.png)
<!-- /Extracted images from page 41 -->
...
![Extracted image 1 from page 42](OPC-DX-1.00.images/page042-img01.png)
<!-- /Extracted images from page 42 -->
...
![Extracted image 1 from page 43](OPC-DX-1.00.images/page043-img01.png)
<!-- /Extracted images from page 43 -->
...
![Extracted image 1 from page 44](OPC-DX-1.00.images/page044-img01.png)
<!-- /Extracted images from page 44 -->
...
![Extracted image 1 from page 45](OPC-DX-1.00.images/page045-img01.png)
<!-- /Extracted images from page 45 -->
...
![Extracted image 1 from page 46](OPC-DX-1.00.images/page046-img01.png)
<!-- /Extracted images from page 46 -->
...
![Extracted image 1 from page 47](OPC-DX-1.00.images/page047-img01.png)
<!-- /Extracted images from page 47 -->
...
![Extracted image 1 from page 48](OPC-DX-1.00.images/page048-img01.png)
<!-- /Extracted images from page 48 -->
...
![Extracted image 1 from page 49](OPC-DX-1.00.images/page049-img01.png)
<!-- /Extracted images from page 49 -->
...
![Extracted image 1 from page 50](OPC-DX-1.00.images/page050-img01.png)
<!-- /Extracted images from page 50 -->
...
![Extracted image 1 from page 51](OPC-DX-1.00.images/page051-img01.png)
<!-- /Extracted images from page 51 -->
...
![Extracted image 1 from page 52](OPC-DX-1.00.images/page052-img01.png)
<!-- /Extracted images from page 52 -->
...
![Extracted image 1 from page 53](OPC-DX-1.00.images/page053-img01.png)
<!-- /Extracted images from page 53 -->
...
![Extracted image 1 from page 54](OPC-DX-1.00.images/page054-img01.png)
<!-- /Extracted images from page 54 -->
...
![Extracted image 1 from page 55](OPC-DX-1.00.images/page055-img01.png)
<!-- /Extracted images from page 55 -->
...
![Extracted image 1 from page 56](OPC-DX-1.00.images/page056-img01.png)
<!-- /Extracted images from page 56 -->
...
![Extracted image 1 from page 57](OPC-DX-1.00.images/page057-img01.png)
<!-- /Extracted images from page 57 -->
...
![Extracted image 1 from page 58](OPC-DX-1.00.images/page058-img01.png)
<!-- /Extracted images from page 58 -->
...
![Extracted image 1 from page 59](OPC-DX-1.00.images/page059-img01.png)
<!-- /Extracted images from page 59 -->
...
![Extracted image 1 from page 60](OPC-DX-1.00.images/page060-img01.png)
<!-- /Extracted images from page 60 -->
...
![Extracted image 1 from page 61](OPC-DX-1.00.images/page061-img01.png)
<!-- /Extracted images from page 61 -->
...
![Extracted image 1 from page 62](OPC-DX-1.00.images/page062-img01.png)
<!-- /Extracted images from page 62 -->
...
![Extracted image 1 from page 63](OPC-DX-1.00.images/page063-img01.png)
<!-- /Extracted images from page 63 -->
...
![Extracted image 1 from page 64](OPC-DX-1.00.images/page064-img01.png)
<!-- /Extracted images from page 64 -->
...
![Extracted image 1 from page 65](OPC-DX-1.00.images/page065-img01.png)
<!-- /Extracted images from page 65 -->
...
![Extracted image 1 from page 66](OPC-DX-1.00.images/page066-img01.png)
<!-- /Extracted images from page 66 -->
...
![Extracted image 1 from page 67](OPC-DX-1.00.images/page067-img01.png)
<!-- /Extracted images from page 67 -->
...
![Extracted image 1 from page 68](OPC-DX-1.00.images/page068-img01.png)
<!-- /Extracted images from page 68 -->
...
![Extracted image 1 from page 69](OPC-DX-1.00.images/page069-img01.png)
<!-- /Extracted images from page 69 -->
...
![Extracted image 1 from page 70](OPC-DX-1.00.images/page070-img01.png)
<!-- /Extracted images from page 70 -->
...
![Extracted image 1 from page 71](OPC-DX-1.00.images/page071-img01.png)
<!-- /Extracted images from page 71 -->
...
![Extracted image 1 from page 72](OPC-DX-1.00.images/page072-img01.png)
<!-- /Extracted images from page 72 -->
...
![Extracted image 1 from page 73](OPC-DX-1.00.images/page073-img01.png)
<!-- /Extracted images from page 73 -->
...
![Extracted image 1 from page 74](OPC-DX-1.00.images/page074-img01.png)
<!-- /Extracted images from page 74 -->
...
![Extracted image 1 from page 75](OPC-DX-1.00.images/page075-img01.png)
<!-- /Extracted images from page 75 -->
...
![Extracted image 1 from page 76](OPC-DX-1.00.images/page076-img01.png)
<!-- /Extracted images from page 76 -->
...
![Extracted image 1 from page 77](OPC-DX-1.00.images/page077-img01.png)
<!-- /Extracted images from page 77 -->
...
![Extracted image 1 from page 78](OPC-DX-1.00.images/page078-img01.png)
<!-- /Extracted images from page 78 -->
...
![Extracted image 1 from page 79](OPC-DX-1.00.images/page079-img01.png)
<!-- /Extracted images from page 79 -->
...
![Extracted image 1 from page 80](OPC-DX-1.00.images/page080-img01.png)
<!-- /Extracted images from page 80 -->
...
![Extracted image 1 from page 81](OPC-DX-1.00.images/page081-img01.png)
<!-- /Extracted images from page 81 -->
...
![Extracted image 1 from page 82](OPC-DX-1.00.images/page082-img01.png)
<!-- /Extracted images from page 82 -->
...
![Extracted image 1 from page 83](OPC-DX-1.00.images/page083-img01.png)
<!-- /Extracted images from page 83 -->
...
![Extracted image 1 from page 84](OPC-DX-1.00.images/page084-img01.png)
<!-- /Extracted images from page 84 -->
...
![Extracted image 1 from page 85](OPC-DX-1.00.images/page085-img01.png)
<!-- /Extracted images from page 85 -->
...
![Extracted image 1 from page 86](OPC-DX-1.00.images/page086-img01.png)
<!-- /Extracted images from page 86 -->
...
![Extracted image 1 from page 87](OPC-DX-1.00.images/page087-img01.png)
<!-- /Extracted images from page 87 -->
...
![Extracted image 1 from page 88](OPC-DX-1.00.images/page088-img01.png)
<!-- /Extracted images from page 88 -->
...
![Extracted image 1 from page 89](OPC-DX-1.00.images/page089-img01.png)
<!-- /Extracted images from page 89 -->
...
![Extracted image 1 from page 90](OPC-DX-1.00.images/page090-img01.png)
<!-- /Extracted images from page 90 -->
...
![Extracted image 1 from page 91](OPC-DX-1.00.images/page091-img01.png)
<!-- /Extracted images from page 91 -->
...
![Extracted image 1 from page 92](OPC-DX-1.00.images/page092-img01.png)
<!-- /Extracted images from page 92 -->
...
![Extracted image 1 from page 93](OPC-DX-1.00.images/page093-img01.png)
<!-- /Extracted images from page 93 -->
...
![Extracted image 1 from page 94](OPC-DX-1.00.images/page094-img01.png)
<!-- /Extracted images from page 94 -->
...
![Extracted image 1 from page 95](OPC-DX-1.00.images/page095-img01.png)
<!-- /Extracted images from page 95 -->
...
![Extracted image 1 from page 96](OPC-DX-1.00.images/page096-img01.png)
<!-- /Extracted images from page 96 -->
...
![Extracted image 1 from page 97](OPC-DX-1.00.images/page097-img01.png)
<!-- /Extracted images from page 97 -->
...
![Extracted image 1 from page 98](OPC-DX-1.00.images/page098-img01.png)
<!-- /Extracted images from page 98 -->
...
![Extracted image 1 from page 99](OPC-DX-1.00.images/page099-img01.png)
<!-- /Extracted images from page 99 -->
...
![Extracted image 1 from page 100](OPC-DX-1.00.images/page100-img01.png)
<!-- /Extracted images from page 100 -->
...
![Extracted image 1 from page 101](OPC-DX-1.00.images/page101-img01.png)
<!-- /Extracted images from page 101 -->
...
![Extracted image 1 from page 102](OPC-DX-1.00.images/page102-img01.png)
<!-- /Extracted images from page 102 -->
...
![Extracted image 1 from page 103](OPC-DX-1.00.images/page103-img01.png)
<!-- /Extracted images from page 103 -->
...
![Extracted image 1 from page 104](OPC-DX-1.00.images/page104-img01.png)
<!-- /Extracted images from page 104 -->
...
![Extracted image 1 from page 105](OPC-DX-1.00.images/page105-img01.png)
<!-- /Extracted images from page 105 -->
...
![Extracted image 1 from page 106](OPC-DX-1.00.images/page106-img01.png)
<!-- /Extracted images from page 106 -->
...
![Extracted image 1 from page 107](OPC-DX-1.00.images/page107-img01.png)
<!-- /Extracted images from page 107 -->
...
![Extracted image 1 from page 108](OPC-DX-1.00.images/page108-img01.png)
<!-- /Extracted images from page 108 -->
...
![Extracted image 1 from page 109](OPC-DX-1.00.images/page109-img01.png)
<!-- /Extracted images from page 109 -->
...
![Extracted image 1 from page 110](OPC-DX-1.00.images/page110-img01.png)
<!-- /Extracted images from page 110 -->
...
![Extracted image 1 from page 111](OPC-DX-1.00.images/page111-img01.png)
<!-- /Extracted images from page 111 -->
...
![Extracted image 1 from page 112](OPC-DX-1.00.images/page112-img01.png)
<!-- /Extracted images from page 112 -->
...
![Extracted image 1 from page 113](OPC-DX-1.00.images/page113-img01.png)
<!-- /Extracted images from page 113 -->
...
![Extracted image 1 from page 114](OPC-DX-1.00.images/page114-img01.png)
<!-- /Extracted images from page 114 -->
...
![Extracted image 1 from page 115](OPC-DX-1.00.images/page115-img01.png)
<!-- /Extracted images from page 115 -->
...
![Extracted image 1 from page 116](OPC-DX-1.00.images/page116-img01.png)
<!-- /Extracted images from page 116 -->
...
![Extracted image 1 from page 117](OPC-DX-1.00.images/page117-img01.png)
<!-- /Extracted images from page 117 -->
...
![Extracted image 1 from page 118](OPC-DX-1.00.images/page118-img01.png)
<!-- /Extracted images from page 118 -->
...
![Extracted image 1 from page 119](OPC-DX-1.00.images/page119-img01.png)
<!-- /Extracted images from page 119 -->
...
![Extracted image 1 from page 120](OPC-DX-1.00.images/page120-img01.png)
<!-- /Extracted images from page 120 -->
...
![Extracted image 1 from page 121](OPC-DX-1.00.images/page121-img01.png)
<!-- /Extracted images from page 121 -->
...
![Extracted image 1 from page 122](OPC-DX-1.00.images/page122-img01.png)
<!-- /Extracted images from page 122 -->
