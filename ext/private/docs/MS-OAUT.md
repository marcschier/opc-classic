...
- [2 Messages](#2-messages)
  ...
  - [2.2 Common Data Types](#22-common-data-types)
    - [2.2.1 BYTE](#221-byte)
    - [2.2.2 IID](#222-iid)
    - [2.2.3 LPOLESTR](#223-lpolestr)
    - [2.2.4 REFIID](#224-refiid)
    - [2.2.5 REFGUID](#225-refguid)
    - [2.2.6 PSAFEARRAY, LPSAFEARRAY](#226-psafearray-lpsafearray)
    - [2.2.7 VARIANT Type Constants](#227-variant-type-constants)
    - [2.2.8 SAFEARRAY Feature Constants](#228-safearray-feature-constants)
    - [2.2.9 ADVFEATUREFLAGS Advanced Feature Flags](#229-advfeatureflags-advanced-feature-flags)
    - [2.2.10 CALLCONV Calling Convention Constants](#2210-callconv-calling-convention-constants)
    - [2.2.11 FUNCFLAGS Function Feature Constants](#2211-funcflags-function-feature-constants)
    - [2.2.12 FUNCKIND Function Access Constants](#2212-funckind-function-access-constants)
    - [2.2.13 IMPLTYPEFLAGS Feature Constants](#2213-impltypeflags-feature-constants)
    - [2.2.14 INVOKEKIND Function Invocation Constants](#2214-invokekind-function-invocation-constants)
    - [2.2.15 PARAMFLAGS Parameter Feature Constants](#2215-paramflags-parameter-feature-constants)
    - [2.2.16 TYPEFLAGS Type Feature Constants](#2216-typeflags-type-feature-constants)
    - [2.2.17 TYPEKIND Type Kind Constants](#2217-typekind-type-kind-constants)
    - [2.2.18 VARFLAGS Variable Feature Constants](#2218-varflags-variable-feature-constants)
    - [2.2.19 VARKIND Variable Kind Constants](#2219-varkind-variable-kind-constants)
    - [2.2.20 LIBFLAGS Type Library Feature Constants](#2220-libflags-type-library-feature-constants)
    - [2.2.21 SYSKIND System Pointer Size Constants](#2221-syskind-system-pointer-size-constants)
    - [2.2.22 DESCKIND Name Description Constants](#2222-desckind-name-description-constants)
    - [2.2.23 BSTR](#2223-bstr)
      - [2.2.23.1 FLAGGED_WORD_BLOB](#22231-flaggedwordblob)
      - [2.2.23.2 BSTR Type Definition](#22232-bstr-type-definition)
      - [2.2.23.3 Mapping Between Presented and Transmitted BSTRs](#22233-mapping-between-presented-and-transmitted-bstrs)
    - [2.2.24 CURRENCY](#2224-currency)
    - [2.2.25 DATE](#2225-date)
    - [2.2.26 DECIMAL](#2226-decimal)
    - [2.2.27 VARIANT_BOOL](#2227-variantbool)
    - [2.2.28 User-Defined Data Types and BRECORD](#2228-user-defined-data-types-and-brecord)
      - [2.2.28.1 User-Defined Data Types](#22281-user-defined-data-types)
      - [2.2.28.2 BRECORD](#22282-brecord)
        - [2.2.28.2.1 _wireBRECORD](#222821-wirebrecord)
        - [2.2.28.2.2 BRECORD](#222822-brecord)
    - [2.2.29 VARIANT](#2229-variant)
      - [2.2.29.1 _wireVARIANT](#22291-wirevariant)
      - [2.2.29.2 VARIANT](#22292-variant)
    - [2.2.30 SAFEARRAY](#2230-safearray)
      - [2.2.30.1 SAFEARRAYBOUND](#22301-safearraybound)
      - [2.2.30.2 SAFEARR_BSTR](#22302-safearrbstr)
      - [2.2.30.3 SAFEARR_UNKNOWN](#22303-safearrunknown)
      - [2.2.30.4 SAFEARR_DISPATCH](#22304-safearrdispatch)
      - [2.2.30.5 SAFEARR_VARIANT](#22305-safearrvariant)
      - [2.2.30.6 SAFEARR_BRECORD](#22306-safearrbrecord)
      - [2.2.30.7 SAFEARR_HAVEIID](#22307-safearrhaveiid)
      - [2.2.30.8 Scalar-Sized Arrays](#22308-scalar-sized-arrays)
        - [2.2.30.8.1 BYTE_SIZEDARR](#223081-bytesizedarr)
        - [2.2.30.8.2 WORD_SIZEDARR](#223082-wordsizedarr)
        - [2.2.30.8.3 DWORD_SIZEDARR](#223083-dwordsizedarr)
        - [2.2.30.8.4 HYPER_SIZEDARR](#223084-hypersizedarr)
      - [2.2.30.9 SAFEARRAYUNION](#22309-safearrayunion)
      - [2.2.30.10 SAFEARRAY](#223010-safearray)
    - [2.2.31 RecordInfoData](#2231-recordinfodata)
    - [2.2.32 DISPID](#2232-dispid)
      - [2.2.32.1 Reserved DISPIDs](#22321-reserved-dispids)
    - [2.2.33 DISPPARAMS](#2233-dispparams)
    - [2.2.34 EXCEPINFO](#2234-excepinfo)
    - [2.2.35 MEMBERID](#2235-memberid)
      - [2.2.35.1 Reserved MEMBERIDs](#22351-reserved-memberids)
    - [2.2.36 HREFTYPE](#2236-hreftype)
    - [2.2.37 TYPEDESC](#2237-typedesc)
    - [2.2.38 ARRAYDESC](#2238-arraydesc)
    - [2.2.39 PARAMDESCEX](#2239-paramdescex)
    - [2.2.40 PARAMDESC](#2240-paramdesc)
    - [2.2.41 ELEMDESC](#2241-elemdesc)
    - [2.2.42 FUNCDESC](#2242-funcdesc)
    - [2.2.43 VARDESC](#2243-vardesc)
    - [2.2.44 TYPEATTR](#2244-typeattr)
    - [2.2.45 TLIBATTR](#2245-tlibattr)
    - [2.2.46 CUSTDATAITEM](#2246-custdataitem)
    - [2.2.47 CUSTDATA](#2247-custdata)
    - [2.2.48 SCODE](#2248-scode)
    - [2.2.49 IDL Syntax Extensions](#2249-idl-syntax-extensions)
      - [2.2.49.1 COM Server Categories](#22491-com-server-categories)
        - [2.2.49.1.1 Aggregatable Servers](#224911-aggregatable-servers)
        - [2.2.49.1.2 Connectable Servers](#224912-connectable-servers)
        - [2.2.49.1.3 Bindable Servers](#224913-bindable-servers)
      - [2.2.49.2 IDL Automation Scope](#22492-idl-automation-scope)
      - [2.2.49.3 Automation-Compatible Types](#22493-automation-compatible-types)
      - [2.2.49.4 Automation Interfaces](#22494-automation-interfaces)
        - [2.2.49.4.1 Automation-Compatible Interfaces](#224941-automation-compatible-interfaces)
        - [2.2.49.4.2 Dual Interfaces](#224942-dual-interfaces)
        - [2.2.49.4.3 Dispinterface Interfaces](#224943-dispinterface-interfaces)
      - [2.2.49.5 Automation Members](#22495-automation-members)
        - [2.2.49.5.1 Interfaces Automation Members](#224951-interfaces-automation-members)
        - [2.2.49.5.2 Bindable Properties](#224952-bindable-properties)
        - [2.2.49.5.3 Dispinterfaces Automation Members](#224953-dispinterfaces-automation-members)
      - [2.2.49.6 Automation Parameters](#22496-automation-parameters)
      - [2.2.49.7 AIDL Interfaces and ODL Dispinterfaces](#22497-aidl-interfaces-and-odl-dispinterfaces)
        - [2.2.49.7.1 Property Equivalence](#224971-property-equivalence)
        - [2.2.49.7.2 Method Equivalence](#224972-method-equivalence)
      - [2.2.49.8 Coclass Specifications](#22498-coclass-specifications)
      - [2.2.49.9 Module Specifications](#22499-module-specifications)
      - [2.2.49.10 Referencing External Types](#224910-referencing-external-types)
    - [2.2.50 String Handling](#2250-string-handling)
      - [2.2.50.1 String Equivalence](#22501-string-equivalence)
      - [2.2.50.2 Globalization](#22502-globalization)
    - [2.2.51 Automation Hash Values](#2251-automation-hash-values)
      - [2.2.51.1 ComputeHash Method](#22511-computehash-method)
      - [2.2.51.2 ComputeHashDBCS Method](#22512-computehashdbcs-method)
      - [2.2.51.3 MapDBChar Method](#22513-mapdbchar-method)
      - [2.2.51.4 Locale Names](#22514-locale-names)
      - [2.2.51.5 Primary Lookup Tables](#22515-primary-lookup-tables)
      - [2.2.51.6 DBCS Substitution Tables](#22516-dbcs-substitution-tables)
- [3 Protocol Details](#3-protocol-details)
  - [3.1 Automation Server Details](#31-automation-server-details)
    - [3.1.1 Abstract Data Model](#311-abstract-data-model)
    - [3.1.2 Timers](#312-timers)
    - [3.1.3 Initialization](#313-initialization)
    - [3.1.4 Message Processing Events and Sequencing Rules](#314-message-processing-events-and-sequencing-rules)
      - [3.1.4.1 IDispatch::GetTypeInfoCount (Opnum 3)](#3141-idispatchgettypeinfocount-opnum-3)
      - [3.1.4.2 IDispatch::GetTypeInfo (Opnum 4)](#3142-idispatchgettypeinfo-opnum-4)
      - [3.1.4.3 IDispatch::GetIDsOfNames (Opnum 5)](#3143-idispatchgetidsofnames-opnum-5)
      - [3.1.4.4 IDispatch::Invoke (Opnum 6)](#3144-idispatchinvoke-opnum-6)
        - [3.1.4.4.1 Invoke Consistency Checks](#31441-invoke-consistency-checks)
        - [3.1.4.4.2 Invoke Argument-Parameter Mapping](#31442-invoke-argument-parameter-mapping)
        - [3.1.4.4.3 Handling Default Value and Optional Arguments](#31443-handling-default-value-and-optional-arguments)
        - [3.1.4.4.4 Argument Coercion](#31444-argument-coercion)
    - [3.1.5 Timer Events](#315-timer-events)
    - [3.1.6 Other Local Events](#316-other-local-events)
  - [3.2 Automation Client Details](#32-automation-client-details)
  ...
  - [3.3 IEnumVARIANT Server Details](#33-ienumvariant-server-details)
    - [3.3.1 Abstract Data Model](#331-abstract-data-model)
    - [3.3.2 Timers](#332-timers)
    - [3.3.3 Initialization](#333-initialization)
    - [3.3.4 Message Processing and Sequencing Rules](#334-message-processing-and-sequencing-rules)
      - [3.3.4.1 IEnumVARIANT::Next (Opnum 3)](#3341-ienumvariantnext-opnum-3)
      - [3.3.4.2 IEnumVARIANT::Skip (Opnum 4)](#3342-ienumvariantskip-opnum-4)
      - [3.3.4.3 IEnumVARIANT::Reset (Opnum 5)](#3343-ienumvariantreset-opnum-5)
      - [3.3.4.4 IEnumVARIANT::Clone (Opnum 6)](#3344-ienumvariantclone-opnum-6)
    - [3.3.5 Timer Events](#335-timer-events)
    - [3.3.6 Other Local Events](#336-other-local-events)
  - [3.4 IEnumVARIANT Client Details](#34-ienumvariant-client-details)
    - [3.4.1 Abstract Data Model](#341-abstract-data-model)
    - [3.4.2 Timers](#342-timers)
    - [3.4.3 Initialization](#343-initialization)
    - [3.4.4 Message Processing and Sequencing Rules](#344-message-processing-and-sequencing-rules)
    - [3.4.5 Timer Events](#345-timer-events)
    - [3.4.6 Other Local Events](#346-other-local-events)
  - [3.5 ITypeComp Server Details](#35-itypecomp-server-details)
    ...
    - [3.5.4 Message Processing Events and Sequencing Rules](#354-message-processing-events-and-sequencing-rules)
      - [3.5.4.1 ITypeComp::Bind (Opnum 3)](#3541-itypecompbind-opnum-3)
        - [3.5.4.1.1 Binding Context](#35411-binding-context)
          - [3.5.4.1.1.1 Automation Type Library Binding Context](#354111-automation-type-library-binding-context)
          - [3.5.4.1.1.2 Automation Type Description Binding Context](#354112-automation-type-description-binding-context)
        - [3.5.4.1.2 Types Returned with Bound Elements](#35412-types-returned-with-bound-elements)
          - [3.5.4.1.2.1 Types Returned with ITypeLib Members](#354121-types-returned-with-itypelib-members)
          - [3.5.4.1.2.2 Types Returned with ITypeInfo Members](#354122-types-returned-with-itypeinfo-members)
      - [3.5.4.2 ITypeComp::BindType (Opnum 4)](#3542-itypecompbindtype-opnum-4)
    - [3.5.5 Timer Events](#355-timer-events)
    - [3.5.6 Other Local Events](#356-other-local-events)
  - [3.6 ITypeComp Client Details](#36-itypecomp-client-details)
  ...
  - [3.7 ITypeInfo Server Details](#37-itypeinfo-server-details)
    - [3.7.1 Abstract Data Model](#371-abstract-data-model)
      - [3.7.1.1 Common Automation Type Description Elements](#3711-common-automation-type-description-elements)
      - [3.7.1.2 TYPEKIND Dependent Automation Type Description Elements](#3712-typekind-dependent-automation-type-description-elements)
    ...
    - [3.7.4 Message Processing Events and Sequencing Rules](#374-message-processing-events-and-sequencing-rules)
      - [3.7.4.1 ITypeInfo::GetTypeAttr (Opnum 3)](#3741-itypeinfogettypeattr-opnum-3)
      - [3.7.4.2 ITypeInfo::GetTypeComp (Opnum 4)](#3742-itypeinfogettypecomp-opnum-4)
      - [3.7.4.3 ITypeInfo::GetFuncDesc (Opnum 5)](#3743-itypeinfogetfuncdesc-opnum-5)
      - [3.7.4.4 ITypeInfo::GetVarDesc (Opnum 6)](#3744-itypeinfogetvardesc-opnum-6)
      - [3.7.4.5 ITypeInfo::GetNames (Opnum 7)](#3745-itypeinfogetnames-opnum-7)
      - [3.7.4.6 ITypeInfo::GetRefTypeOfImplType (Opnum 8)](#3746-itypeinfogetreftypeofimpltype-opnum-8)
      - [3.7.4.7 ITypeInfo::GetImplTypeFlags (Opnum 9)](#3747-itypeinfogetimpltypeflags-opnum-9)
      - [3.7.4.8 ITypeInfo::GetDocumentation (Opnum 12)](#3748-itypeinfogetdocumentation-opnum-12)
      - [3.7.4.9 ITypeInfo::GetDllEntry (Opnum 13)](#3749-itypeinfogetdllentry-opnum-13)
      - [3.7.4.10 ITypeInfo::GetRefTypeInfo (Opnum 14)](#37410-itypeinfogetreftypeinfo-opnum-14)
      - [3.7.4.11 ITypeInfo::CreateInstance (Opnum 16)](#37411-itypeinfocreateinstance-opnum-16)
      - [3.7.4.12 ITypeInfo::GetMops (Opnum 17)](#37412-itypeinfogetmops-opnum-17)
      - [3.7.4.13 ITypeInfo::GetContainingTypeLib (Opnum 18)](#37413-itypeinfogetcontainingtypelib-opnum-18)
    - [3.7.5 Timer Events](#375-timer-events)
    - [3.7.6 Other Local Events](#376-other-local-events)
  - [3.8 ITypeInfo Client Details](#38-itypeinfo-client-details)
  ...
  - [3.9 ITypeInfo2 Server Details](#39-itypeinfo2-server-details)
    ...
    - [3.9.4 Message Processing Events and Sequencing Rules](#394-message-processing-events-and-sequencing-rules)
      - [3.9.4.1 ITypeInfo2::GetTypeKind (Opnum 22)](#3941-itypeinfo2gettypekind-opnum-22)
      - [3.9.4.2 ITypeInfo2::GetTypeFlags (Opnum 23)](#3942-itypeinfo2gettypeflags-opnum-23)
      - [3.9.4.3 ITypeInfo2::GetFuncIndexOfMemId (Opnum 24)](#3943-itypeinfo2getfuncindexofmemid-opnum-24)
      - [3.9.4.4 ITypeInfo2::GetVarIndexOfMemId (Opnum 25)](#3944-itypeinfo2getvarindexofmemid-opnum-25)
      - [3.9.4.5 ITypeInfo2::GetCustData (Opnum 26)](#3945-itypeinfo2getcustdata-opnum-26)
      - [3.9.4.6 ITypeInfo2::GetFuncCustData (Opnum 27)](#3946-itypeinfo2getfunccustdata-opnum-27)
      - [3.9.4.7 ITypeInfo2::GetParamCustData (Opnum 28)](#3947-itypeinfo2getparamcustdata-opnum-28)
      - [3.9.4.8 ITypeInfo2::GetVarCustData (Opnum 29)](#3948-itypeinfo2getvarcustdata-opnum-29)
      - [3.9.4.9 ITypeInfo2::GetImplTypeCustData (Opnum 30)](#3949-itypeinfo2getimpltypecustdata-opnum-30)
      - [3.9.4.10 ITypeInfo2::GetDocumentation2 (Opnum 31)](#39410-itypeinfo2getdocumentation2-opnum-31)
      - [3.9.4.11 ITypeInfo2::GetAllCustData (Opnum 32)](#39411-itypeinfo2getallcustdata-opnum-32)
      - [3.9.4.12 ITypeInfo2::GetAllFuncCustData (Opnum 33)](#39412-itypeinfo2getallfunccustdata-opnum-33)
      - [3.9.4.13 ITypeInfo2::GetAllParamCustData (Opnum 34)](#39413-itypeinfo2getallparamcustdata-opnum-34)
      - [3.9.4.14 ITypeInfo2::GetAllVarCustData (Opnum 35)](#39414-itypeinfo2getallvarcustdata-opnum-35)
      - [3.9.4.15 ITypeInfo2::GetAllImplTypeCustData (Opnum 36)](#39415-itypeinfo2getallimpltypecustdata-opnum-36)
    - [3.9.5 Timer Events](#395-timer-events)
    - [3.9.6 Other Local Events](#396-other-local-events)
  - [3.10 ITypeInfo2 Client Details](#310-itypeinfo2-client-details)
  ...
  - [3.11 ITypeLib Server Details](#311-itypelib-server-details)
    ...
    - [3.11.4 Message Processing Events and Sequencing Rules](#3114-message-processing-events-and-sequencing-rules)
      - [3.11.4.1 ITypeLib::GetTypeInfoCount (Opnum 3)](#31141-itypelibgettypeinfocount-opnum-3)
      - [3.11.4.2 ITypeLib::GetTypeInfo (Opnum 4)](#31142-itypelibgettypeinfo-opnum-4)
      - [3.11.4.3 ITypeLib::GetTypeInfoType (Opnum 5)](#31143-itypelibgettypeinfotype-opnum-5)
      - [3.11.4.4 ITypeLib::GetTypeInfoOfGuid (Opnum 6)](#31144-itypelibgettypeinfoofguid-opnum-6)
      - [3.11.4.5 ITypeLib::GetLibAttr (Opnum 7)](#31145-itypelibgetlibattr-opnum-7)
      - [3.11.4.6 ITypeLib::GetTypeComp (Opnum 8)](#31146-itypelibgettypecomp-opnum-8)
      - [3.11.4.7 ITypeLib::GetDocumentation (Opnum 9)](#31147-itypelibgetdocumentation-opnum-9)
      - [3.11.4.8 ITypeLib::IsName (Opnum 10)](#31148-itypelibisname-opnum-10)
      - [3.11.4.9 ITypeLib::FindName (Opnum 11)](#31149-itypelibfindname-opnum-11)
    - [3.11.5 Timer Events](#3115-timer-events)
    - [3.11.6 Other Local Events](#3116-other-local-events)
  - [3.12 ITypeLib Client Details](#312-itypelib-client-details)
  ...
  - [3.13 ITypeLib2 Server Details](#313-itypelib2-server-details)
    ...
    - [3.13.4 Message Processing Events and Sequencing Rules](#3134-message-processing-events-and-sequencing-rules)
      - [3.13.4.1 ITypeLib2::GetCustData (Opnum 13)](#31341-itypelib2getcustdata-opnum-13)
      - [3.13.4.2 ITypeLib2::GetLibStatistics (Opnum 14)](#31342-itypelib2getlibstatistics-opnum-14)
      - [3.13.4.3 ITypeLib2::GetDocumentation2 (Opnum 15)](#31343-itypelib2getdocumentation2-opnum-15)
      - [3.13.4.4 ITypeLib2::GetAllCustData (Opnum 16)](#31344-itypelib2getallcustdata-opnum-16)
    - [3.13.5 Timer Events](#3135-timer-events)
    - [3.13.6 Other Local Events](#3136-other-local-events)
  - [3.14 ITypeLib2 Client Details](#314-itypelib2-client-details)
...
- [4 Protocol Examples](#4-protocol-examples)
  - [4.1 AIDL-ODL Property Equivalence](#41-aidl-odl-property-equivalence)
  - [4.2 AIDL-ODL Method Equivalence](#42-aidl-odl-method-equivalence)
  - [4.3 Invoke Argument Parameter Mapping](#43-invoke-argument-parameter-mapping)
  - [4.4 Getting the Value of a Property](#44-getting-the-value-of-a-property)
  - [4.5 Setting the Value of a Property](#45-setting-the-value-of-a-property)
  - [4.6 Calling a Method with Byref and Optional Arguments](#46-calling-a-method-with-byref-and-optional-arguments)
  - [4.7 IEnumVARIANT Example](#47-ienumvariant-example)
    - [4.7.1 IEnumVARIANT Next() Example](#471-ienumvariant-next-example)
    - [4.7.2 IEnumVARIANT Skip() Example](#472-ienumvariant-skip-example)
    - [4.7.3 IEnumVARIANT Reset() Example](#473-ienumvariant-reset-example)
    - [4.7.4 IEnumVARIANT Clone() Example](#474-ienumvariant-clone-example)
  - [4.8 Reading Type Information](#48-reading-type-information)
    - [4.8.1 Getting ITypeLib Implementations from Automation Server](#481-getting-itypelib-implementations-from-automation-server)
    - [4.8.2 Enumerating on All Types in a Type Library](#482-enumerating-on-all-types-in-a-type-library)
    - [4.8.3 Enumerating on All Enumerations in a Type Library](#483-enumerating-on-all-enumerations-in-a-type-library)
    - [4.8.4 Enumerating All Nonsource Interfaces in a Coclass](#484-enumerating-all-nonsource-interfaces-in-a-coclass)
    - [4.8.5 Enumerating All Methods in an Interface](#485-enumerating-all-methods-in-an-interface)
    - [4.8.6 Retrieving Type Information](#486-retrieving-type-information)
    - [4.8.7 Binding to a Member of a Default Nonsource Interface of an Appobject Coclass](#487-binding-to-a-member-of-a-default-nonsource-interface-of-an-appobject-coclass)
    - [4.8.8 Binding to a Member of a Partner Interface](#488-binding-to-a-member-of-a-partner-interface)
- [5 Security](#5-security)
  - [5.1 Security Considerations for Implementer](#51-security-considerations-for-implementer)
  - [5.2 Index of Security Parameters](#52-index-of-security-parameters)
- [6 Appendix A: Full IDL](#6-appendix-a-full-idl)
- [7 Appendix B: Product Behavior](#7-appendix-b-product-behavior)
- [8 Appendix C: Full ABNF](#8-appendix-c-full-abnf)
