...
- **License headers**: every new source file outside `interop/` carries a single-line copyright header `// Copyright (c) 2026 Opc.Classic Contributors. Licensed under the MIT License.` (no `SPDX-License-Identifier` line).
