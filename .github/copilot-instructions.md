...
`external/` retains its upstream notices and is used for conformance validation. Project source is MIT licensed.
...
- **Conformance**: All code must conform strictly to the specifications in `external/private/docs`.
